...
class BgpIPv6EvpnVXLANVpws(Base):
	...
	def BroadcastDomainV6VxlanVpws(self):
		"""Returns the one and only one BroadcastDomainV6VxlanVpws object from the server.
		...
		return self._read(BroadcastDomainV6VxlanVpws(self), None)
	...
	def remove(self):
		"""Deletes a child instance of BgpIPv6EvpnVXLANVpws on the server.
	...
	def RestartDown(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpIPv6EvpnVXLANVpws object references
