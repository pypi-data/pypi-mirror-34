...
def credentialsFromFile(creds_file, scopes, auth_through_service_account=False):
    credentials = None;
...
def credentialsFromString(creds_string, scopes, auth_through_service_account=False):
    credentials = None;
...
def credentialsFromDict(creds_dict, scopes, auth_through_service_account=False):
    credentials = None;
