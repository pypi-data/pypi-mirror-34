...
from ServiceException import ServiceException, ServiceStatusCode, ServiceConnectionException
...
class Connection:
    ...
    def get(self, methodurl, headers: {}, payload=None):
        ...
        response = self._session.get(self.hosturl + methodurl, verify=False, params=payload, headers={})
