...
class mcthread(threading.Thread):
    ...
    def __init__(self,q,I,E,Bounds=[],Nsph=[],Maxiter=[],Rpfactor=1.5/3,Nreps=100,\
                                  qlims=[0,inf],Histbins=50,Histscale='lin',\
                                  drhosqr=1,Convcrit=1.,StartFromMin=False,Maxntry=5,feedback=None,endf=None):
        ...
        self.Nsph=Nsph
        self.Maxiter=[]
        self.Rpfactor=Rpfactor
        self.Nreps=Nreps
        self.qlims=qlims
        self.Histbins=Histbins
        self.Histscale=Histscale
        self.drhosqr=drhosqr
        self.Convcrit=Convcrit
        self.StartFromMin=StartFromMin
        self.Maxntry=Maxntry
        self.endf=endf
        
    def run(self):
        self.A=self.run_Analyze_1D(self.q,self.I,self.E,self.Bounds,\
                            self.Nsph,self.Maxiter,self.Rpfactor,self.Nreps,\
                            self.qlims,self.Histbins,self.Histscale,self.drhosqr,self.Convcrit,\
                            self.StartFromMin,self.Maxntry)
    ...
    def run_Analyze_1D(self,q,I,E,Bounds=[],Nsph=[],Maxiter=[],Rpfactor=1.5/3,Nreps=100,qlims=[0,inf],Histbins=50,Histscale='lin',drhosqr=1,Convcrit=1.,StartFromMin=False,Maxntry=5):
        '''
