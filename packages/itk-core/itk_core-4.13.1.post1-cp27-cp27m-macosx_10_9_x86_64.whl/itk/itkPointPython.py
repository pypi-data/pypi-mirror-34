...
class itkPointD2(itkFixedArrayPython.itkFixedArrayD2):
    ...
    def Get_vnl_vector(self, *args):
        """
        Get_vnl_vector(itkPointD2 self) -> vnl_vector_refD
        Get_vnl_vector(itkPointD2 self) -> vnl_vectorD
        """
...
class itkPointD3(itkFixedArrayPython.itkFixedArrayD3):
    ...
    def Get_vnl_vector(self, *args):
        """
        Get_vnl_vector(itkPointD3 self) -> vnl_vector_refD
        Get_vnl_vector(itkPointD3 self) -> vnl_vectorD
        """
...
class itkPointD4(itkFixedArrayPython.itkFixedArrayD4):
    ...
    def Get_vnl_vector(self, *args):
        """
        Get_vnl_vector(itkPointD4 self) -> vnl_vector_refD
        Get_vnl_vector(itkPointD4 self) -> vnl_vectorD
        """
        return _itkPointPython.itkPointD4_Get_vnl_vector(self, *args)
...
itkPointD4.Get_vnl_vector = new_instancemethod(_itkPointPython.itkPointD4_Get_vnl_vector, None, itkPointD4)
...
def itkPointD4_GetPointDimension():
    """itkPointD4_GetPointDimension() -> unsigned int"""
    return _itkPointPython.itkPointD4_GetPointDimension()

def itkPointD4___len__():
...
class itkPointF2(itkFixedArrayPython.itkFixedArrayF2):
    ...
    def Get_vnl_vector(self, *args):
        """
        Get_vnl_vector(itkPointF2 self) -> vnl_vector_refF
        Get_vnl_vector(itkPointF2 self) -> vnl_vectorF
        """
...
class itkPointF3(itkFixedArrayPython.itkFixedArrayF3):
    ...
    def Get_vnl_vector(self, *args):
        """
        Get_vnl_vector(itkPointF3 self) -> vnl_vector_refF
        Get_vnl_vector(itkPointF3 self) -> vnl_vectorF
        """
...
class itkPointF4(itkFixedArrayPython.itkFixedArrayF4):
    ...
    def Get_vnl_vector(self, *args):
        """
        Get_vnl_vector(itkPointF4 self) -> vnl_vector_refF
        Get_vnl_vector(itkPointF4 self) -> vnl_vectorF
        """
        return _itkPointPython.itkPointF4_Get_vnl_vector(self, *args)
...
itkPointF4.Get_vnl_vector = new_instancemethod(_itkPointPython.itkPointF4_Get_vnl_vector, None, itkPointF4)
...
def itkPointF4_GetPointDimension():
    """itkPointF4_GetPointDimension() -> unsigned int"""
    return _itkPointPython.itkPointF4_GetPointDimension()

def itkPointF4___len__():
