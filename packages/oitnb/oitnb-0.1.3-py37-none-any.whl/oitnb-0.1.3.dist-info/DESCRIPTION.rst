...
.. image:: https://badge.fury.io/py//oitnb.svg
...
The above approach: *check out both old revision trees, code format
them and run a diff*, is generic. ``meld`` and ``mercurial`` are just
