...
class IsisDceSimRouter(Base):
	...
	def DceSimulatedMCastIpv4GroupList(self):
		"""Returns the one and only one DceSimulatedMCastIpv4GroupList object from the server.
		...
		return self._read(DceSimulatedMCastIpv4GroupList(self), None)

	@property
	def DceSimulatedMCastIpv6GroupList(self):
		"""Returns the one and only one DceSimulatedMCastIpv6GroupList object from the server.
		...
		return self._read(DceSimulatedMCastIpv6GroupList(self), None)

	@property
	def DceSimulatedMCastMacGroupList(self):
		"""Returns the one and only one DceSimulatedMCastMacGroupList object from the server.
		...
		return self._read(DceSimulatedMCastMacGroupList(self), None)
	...
	def remove(self):
		"""Deletes a child instance of IsisDceSimRouter on the server.
