...
class IsisSpbMacCloudConfig(Base):
	...
	def remove(self):
		"""Deletes a child instance of IsisSpbMacCloudConfig on the server.
	...
	def Start(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./isisSpbMacCloudConfig object references
