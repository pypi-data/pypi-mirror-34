...
Available events: 'change'"""
    @_explicitize_args
    def __init__(self, id=None, marks=None, value=None, className=None, disabled=None, dots=None, included=None, min=None, max=None, step=None, vertical=None, updatemode="Unparsable-JS-Object", **kwargs):
