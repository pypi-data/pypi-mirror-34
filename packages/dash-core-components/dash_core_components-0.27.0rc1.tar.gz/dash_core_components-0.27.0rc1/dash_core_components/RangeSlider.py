...
Available events: 'change'"""
    @_explicitize_args
    def __init__(self, id=None, marks=None, value=None, allowCross=None, className=None, count=None, disabled=None, dots=None, included=None, min=None, max=None, pushable=None, step=None, vertical=None, updatemode="Unparsable-JS-Object", **kwargs):
