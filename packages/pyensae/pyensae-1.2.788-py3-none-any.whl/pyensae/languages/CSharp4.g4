...
primary_expression_start
  ...
  | this_access
  | base_access
  | NEW ( any_type ( object_creation_expression2
...
primary_no_array_creation_expression 
	...
	;
new_expression
  : NEW ( any_type ( OPEN_BRACKET expression_list CLOSE_BRACKET rank_specifiers? array_initializer? array_creation_tail
...
/*
object_creation_expression 
	: NEW any_type OPEN_PARENS argument_list? CLOSE_PARENS object_or_collection_initializer?
	| NEW any_type object_or_collection_initializer
	;
*/
/** NEW any_type (OPEN_PARENS ... | OPEN_BRACE ...) */
object_creation_expression 
  : NEW any_type ( OPEN_PARENS argument_list? CLOSE_PARENS object_or_collection_initializer?
             | object_or_collection_initializer
             )
...
unchecked_expression 
	...
	;
default_value_expression 
	: DEFAULT OPEN_PARENS any_type CLOSE_PARENS
	;
/*
unary_expression 
	: primary_expression
...
scan_for_cast_generic_precedence
  : OPEN_PARENS any_type CLOSE_PARENS cast_disambiguation_token
  ;
...
pre_decrement_expression 
	...
	;
cast_expression 
	: OPEN_PARENS any_type CLOSE_PARENS unary_expression
	;
...
scan_for_shift_generic_precedence
  : identifier LT any_type (COMMA any_type)* GT shift_disambiguation_token
  ;
...
explicit_anonymous_function_parameter 
	: anonymous_function_parameter_modifier? any_type identifier
	;
...
query_expression 
	...
	;
from_clause 
	: from_contextual_keyword any_type? identifier IN expression
	;
/*
query_body 
...
where_clause 
	...
	;
join_clause 
	: join_contextual_keyword any_type? identifier IN expression on_contextual_keyword expression equals_contextual_keyword expression
	;
join_into_clause 
	: join_contextual_keyword any_type? identifier IN expression on_contextual_keyword expression equals_contextual_keyword expression into_contextual_keyword identifier
	;
// added by chw
combined_join_clause
  : join_contextual_keyword any_type? identifier IN expression on_contextual_keyword expression equals_contextual_keyword expression (into_contextual_keyword identifier)?
...
labeled_statement 
	...
	;
/** starts with any_type, VAR, or CONST */
declaration_statement 
...
local_constant_declaration 
	: CONST any_type constant_declarators
	;
expression_statement
...
/*
constant_declaration 
	: attributes? constant_modifiers? CONST any_type constant_declarators SEMICOLON
	;
constant_modifiers 
	: constant_modifier+
	;
...
/* not used anymore;
field_declaration 
	: attributes? field_modifiers? any_type variable_declarators SEMICOLON
	;
field_modifiers 
...
/*
fixed_parameter 
  : attributes? parameter_modifier? any_type identifier default_argument?
  ;
*/
...
parameter_array 
	...
	;
property_declaration 
	: attributes? property_modifiers? any_type member_name OPEN_BRACE accessor_declarations CLOSE_BRACE
	;
property_modifiers 
	: property_modifier+
	;
...
/*
event_declaration 
	: attributes? event_modifiers? EVENT any_type variable_declarators SEMICOLON
	| attributes? event_modifiers? EVENT any_type member_name OPEN_BRACE event_accessor_declarations CLOSE_BRACE
	;
*/
event_declaration 
  : attributes? event_modifiers? EVENT any_type
...
/*
indexer_declarator 
	: any_type THIS OPEN_BRACKET formal_parameter_list CLOSE_BRACKET
	| any_type interface_type DOT THIS OPEN_BRACKET formal_parameter_list CLOSE_BRACKET
	;
*/
indexer_declarator 
  : any_type (interface_type DOT)? THIS OPEN_BRACKET formal_parameter_list CLOSE_BRACKET
...
operator_declarator 
  ...
  ;
unary_operator_declarator 
	: any_type OPERATOR overloadable_unary_operator OPEN_PARENS any_type identifier CLOSE_PARENS
	;
overloadable_unary_operator 
	...
	;
binary_operator_declarator 
	: any_type OPERATOR overloadable_binary_operator OPEN_PARENS any_type identifier COMMA any_type identifier CLOSE_PARENS
	;
...
conversion_operator_declarator
	: IMPLICIT OPERATOR any_type OPEN_PARENS any_type identifier CLOSE_PARENS
	| EXPLICIT OPERATOR any_type OPEN_PARENS any_type identifier CLOSE_PARENS
	;
operator_body 
	: block
	| SEMICOLON
...
interface_member_declaration 
  : attributes? NEW?
    ...
    | EVENT any_type identifier SEMICOLON
    )
  ;
interface_method_declaration 
	...
	;
interface_property_declaration 
	: attributes? NEW? any_type identifier OPEN_BRACE interface_accessors CLOSE_BRACE
	;
/*
interface_accessors 
...
interface_accessors 
  ...
  ;
interface_event_declaration 
	: attributes? NEW? EVENT any_type identifier SEMICOLON
	;
interface_indexer_declaration 
	: attributes? NEW? any_type THIS OPEN_BRACKET formal_parameter_list CLOSE_BRACKET OPEN_BRACE interface_accessors CLOSE_BRACE
	;
...
property_declaration2
  ...
  ;
constant_declaration2
  : CONST any_type constant_declarators SEMICOLON
  ;
indexer_declaration2
...
// added by chw to allow detection of any_type parameters for methods
method_member_name
  : method_member_name2
  ;
method_member_name2
  ...
  ;
operator_declaration2
  : OPERATOR overloadable_operator OPEN_PARENS any_type identifier
         (COMMA any_type identifier)? CLOSE_PARENS operator_body
  ;
