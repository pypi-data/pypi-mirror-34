...
class DataService:
    ...
    def __init__(self, username=None, password_hashed=None):
        ...
        self.api_stream_url = "https://api-stream-interface-soccerwatch.azure"\
                              "websites.net/intern/rest/v1/streamInterface"
    ...
    def add_event(self, match_id, event_id, timestamp):
        ...
        return self.post(url, eventType=event_id, timestamp=timestamp)
    ...
    def pull_labels(self, match,
        ...
        if pos_unsorted is not None and len(pos_unsorted) > 0:
            ...
            if highest_timestamp + 1 > label.positions.shape[0]:
                label.postions = label.positions.resize((highest_timestamp + 1,
                                                         7), refcheck=False)
