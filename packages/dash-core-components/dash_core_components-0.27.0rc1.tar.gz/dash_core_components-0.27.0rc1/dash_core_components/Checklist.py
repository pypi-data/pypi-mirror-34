...
Available events: 'change'"""
    @_explicitize_args
    def __init__(self, id=None, options="Unparsable-JS-Object", values=None, className=None, style=None, inputStyle={}, inputClassName='', labelStyle={}, labelClassName='', **kwargs):
