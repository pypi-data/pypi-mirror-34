...
class DslPools(Base):
	...
	def remove(self):
		"""Deletes a child instance of DslPools on the server.
	...
	def SendPortDown(self, Arg1):
		"""Executes the sendPortDown operation on the server.

		Send Port Down event from selected Access Loop items.

		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./dslPools object references
	...
	def SendPortDown(self, Arg1, SessionIndices):
		"""Executes the sendPortDown operation on the server.
	...
	def SendPortUp(self, Arg1, SessionIndices):
		"""Executes the sendPortUp operation on the server.
	...
	def Start(self, Targets):
		...
		Args:
			Targets (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./dslPools object references
