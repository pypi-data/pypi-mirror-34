...
from lbsnstructure.external import timestamp_pb2 as lbsnstructure_dot_external_dot_timestamp__pb2
...
_LBSNUSERGROUP.fields_by_name['usergroup_createdate'].message_type = lbsnstructure_dot_external_dot_timestamp__pb2._TIMESTAMP
