...
from mali_commands.legit.gcp_services import GooglePackagesMissing
from mali_commands.legit.path_utils import makedir
...
@click.option('--outputFormat', '-o', type=Choice2(['tables', 'json', 'csv', 'json-lines']), default='tables', required=False)
...
if __name__ == "__main__":
    try:
        ...
        click.echo('you to run "pip install mali[gcp]" in order to run this command', err=True)
