...
#define SBK_QTPOSITIONING_QLIST_QGEOAREAMONITORINFO_IDX              4 // QList<QGeoAreaMonitorInfo >
#define SBK_QTPOSITIONING_QLIST_QGEOSATELLITEINFO_IDX                5 // const QList<QGeoSatelliteInfo > &
