...
class Connect:
    ...
    def __init__(self, apiServerIp=None, serverIpPort=None, serverOs='windows', connectToLinuxChassisIp=None,
                 ...
                 apiKey=None, generateLogFile=True, robotFrameworkStdout=False, proxies=None):
        """
        Description
