...
// Converter indices
#define SBK_QCHAR_IDX                                                0
#define SBK_QMODELINDEXLIST_IDX                                      1
#define SBK_QPTRDIFF_IDX                                             2
#define SBK_QVARIANT_IDX                                             3
#define SBK_QUINTPTR_IDX                                             4
#define SBK_QSTRINGREF_IDX                                           5
#define SBK_HWND_IDX                                                 6
#define SBK_QSTRING_IDX                                              7
#define SBK_QSTRINGLIST_IDX                                          8
#define SBK_QINTPTR_IDX                                              9
#define SBK_QVARIANT_TYPE_IDX                                        10
#define SBK_BOOL_IDX                                                 11
#define SBK_QJSONOBJECT_IDX                                          12
...
#define SBK_QTCORE_QLIST_QABSTRACTANIMATIONPTR_IDX                   38 // QList<QAbstractAnimation* >
#define SBK_QTCORE_QLIST_QABSTRACTSTATEPTR_IDX                       39 // const QList<QAbstractState* > &
#define SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                          40 // const QHash<int,QByteArray > &
#define SBK_QTCORE_QMAP_INT_QVARIANT_IDX                             41 // QMap<int,QVariant >
#define SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX                   42 // const QList<QPersistentModelIndex > &
#define SBK_QTCORE_QLIST_QABSTRACTEVENTDISPATCHER_TIMERINFO_IDX      43 // QList<QAbstractEventDispatcher::TimerInfo >
#define SBK_QTCORE_QPAIR_QREAL_QVARIANT_IDX                          44 // QPair<qreal,QVariant >
#define SBK_QTCORE_QVECTOR_QPAIR_QREAL_QVARIANT_IDX                  45 // QVector<QPair< qreal,QVariant > >
