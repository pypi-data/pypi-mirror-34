...
def createNewComputeExecutions(registry, taskHandlerNames, site, projectcode):
    ...
    for computeexecution in registry["computeexecutions"]:
        ...
        if "execution" not in computeexecution or computeexecution["execution"] is None:
            ...
            if "schedule" not in computeexecution["execution"] or computeexecution["execution"]["schedule"] is None or computeexecution["execution"]["schedule"]=="":
        ...
        if "managed" not in computeexecution or computeexecution["managed"] is None:
            ...
            if "type" not in computeexecution["managed"] or computeexecution["managed"]["type"] is None or computeexecution["managed"]["type"]=="":
                computeexecution["managed"]["type"] = "STANDBY"
            if "serviceName" not in computeexecution["managed"] or computeexecution["managed"]["serviceName"] is None or computeexecution["managed"]["serviceName"]=="":
