...
/*For DIM data sizes go to http://dim.web.cern.ch/dim/dimCformat.html*/

#define _DIM_INT 0
#define _DIM_INT_LEN 4

#define _DIM_FLOAT 1
#define _DIM_FLOAT_LEN SIZEOF_FLOAT

#define _DIM_DOUBLE 2
#define _DIM_DOUBLE_LEN SIZEOF_DOUBLE

#define _DIM_XTRA 3
#define _DIM_XTRA_LEN 8

#define _DIM_STRING 4
#define _DIM_CHAR_LEN SIZEOF_CHAR

#define _DIM_SHORT 5
#define _DIM_SHORT_LEN SIZEOF_SHORT

#define _DIM_LONG 6
#define _DIM_LONG_LEN SIZEOF_LONG
