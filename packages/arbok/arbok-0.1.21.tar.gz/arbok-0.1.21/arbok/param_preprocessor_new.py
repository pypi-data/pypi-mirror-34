...
class ParamPreprocessor(BaseEstimator, TransformerMixin):
    def __init__(self, types="detect", names=None, optimize_for_catboost=False):
        ...
        self.names = names
        self.optimize_for_catboost = optimize_for_catboost
    ...
    def transform(self, X, y=None):
        ...
        if not self.optimize_for_catboost:
