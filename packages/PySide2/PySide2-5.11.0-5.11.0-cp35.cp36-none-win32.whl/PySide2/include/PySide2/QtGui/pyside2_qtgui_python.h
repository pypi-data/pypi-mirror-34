...
#define SBK_QTGUI_QLIST_QTOUCHEVENT_TOUCHPOINT_IDX                   33 // const QList<QTouchEvent::TouchPoint > &
...
#define SBK_QTGUI_QVECTOR_UNSIGNEDLONGLONG_IDX                       39 // QVector<unsigned long long >
#define SBK_QTGUI_QLIST_QSCREENPTR_IDX                               40 // QList<QScreen* >
#define SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                            41 // QList<QTextFrame* >
#define SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                               42 // QList<QTextBlock >
#define SBK_QTGUI_QVECTOR_INT_IDX                                    43 // const QVector<int > &
#define SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                           44 // const QHash<int,QByteArray > &
#define SBK_QTGUI_QLIST_QPERSISTENTMODELINDEX_IDX                    45 // const QList<QPersistentModelIndex > &
#define SBK_QTGUI_QLIST_QOPENGLCONTEXTPTR_IDX                        46 // QList<QOpenGLContext* >
#define SBK_QTGUI_QLIST_QOPENGLDEBUGMESSAGE_IDX                      47 // QList<QOpenGLDebugMessage >
#define SBK_QTGUI_QSET_QBYTEARRAY_IDX                                48 // QSet<QByteArray >
#define SBK_QTGUI_QLIST_QWINDOWPTR_IDX                               49 // QList<QWindow* >
#define SBK_QTGUI_QVECTOR_FLOAT_IDX                                  50 // QVector<float >
#define SBK_QTGUI_QLIST_QOPENGLSHADERPTR_IDX                         51 // QList<QOpenGLShader* >
