...
class itkLandweberDeconvolutionImageFilterIUS2IUS2(itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS2IUS2):
    ...
    def GetPointer(self) -> "itkLandweberDeconvolutionImageFilterIUS2IUS2 *":
        """GetPointer(itkLandweberDeconvolutionImageFilterIUS2IUS2 self) -> itkLandweberDeconvolutionImageFilterIUS2IUS2"""
        return _itkLandweberDeconvolutionImageFilterPython.itkLandweberDeconvolutionImageFilterIUS2IUS2_GetPointer(self)
...
itkLandweberDeconvolutionImageFilterIUS2IUS2.GetPointer = new_instancemethod(_itkLandweberDeconvolutionImageFilterPython.itkLandweberDeconvolutionImageFilterIUS2IUS2_GetPointer, None, itkLandweberDeconvolutionImageFilterIUS2IUS2)
...
class itkLandweberDeconvolutionImageFilterIUS3IUS3(itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS3IUS3):
    ...
    def GetPointer(self) -> "itkLandweberDeconvolutionImageFilterIUS3IUS3 *":
        """GetPointer(itkLandweberDeconvolutionImageFilterIUS3IUS3 self) -> itkLandweberDeconvolutionImageFilterIUS3IUS3"""
        return _itkLandweberDeconvolutionImageFilterPython.itkLandweberDeconvolutionImageFilterIUS3IUS3_GetPointer(self)
...
itkLandweberDeconvolutionImageFilterIUS3IUS3.GetPointer = new_instancemethod(_itkLandweberDeconvolutionImageFilterPython.itkLandweberDeconvolutionImageFilterIUS3IUS3_GetPointer, None, itkLandweberDeconvolutionImageFilterIUS3IUS3)
