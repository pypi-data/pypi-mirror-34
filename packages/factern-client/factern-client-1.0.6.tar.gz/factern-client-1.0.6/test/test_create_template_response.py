...
from factern_client.com.factern.model.create_template_response import CreateTemplateResponse  # noqa: E501
...
class TestCreateTemplateResponse(unittest.TestCase):
    ...
    def testCreateTemplateResponse(self):
        ...
        # model = factern_client.models.create_template_response.CreateTemplateResponse()  # noqa: E501
        pass
