...
class itkMapContainerULQEMPF2GQEULULBBT(ITKCommonBasePython.itkObject):
    ...
    def GetPointer(self) -> "itkMapContainerULQEMPF2GQEULULBBT *":
        """GetPointer(itkMapContainerULQEMPF2GQEULULBBT self) -> itkMapContainerULQEMPF2GQEULULBBT"""
        return _itkQuadEdgeCellTraitsInfoPython.itkMapContainerULQEMPF2GQEULULBBT_GetPointer(self)
...
itkMapContainerULQEMPF2GQEULULBBT.GetPointer = new_instancemethod(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULQEMPF2GQEULULBBT_GetPointer, None, itkMapContainerULQEMPF2GQEULULBBT)
...
class itkMapContainerULQEMPF3GQEULULBBT(ITKCommonBasePython.itkObject):
    ...
    def GetPointer(self) -> "itkMapContainerULQEMPF3GQEULULBBT *":
        """GetPointer(itkMapContainerULQEMPF3GQEULULBBT self) -> itkMapContainerULQEMPF3GQEULULBBT"""
        return _itkQuadEdgeCellTraitsInfoPython.itkMapContainerULQEMPF3GQEULULBBT_GetPointer(self)
...
itkMapContainerULQEMPF3GQEULULBBT.GetPointer = new_instancemethod(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULQEMPF3GQEULULBBT_GetPointer, None, itkMapContainerULQEMPF3GQEULULBBT)
