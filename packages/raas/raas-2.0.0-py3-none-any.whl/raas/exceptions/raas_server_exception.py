...
"""
    raas.models.raas_server_exception

    This file was automatically generated for Tango Card, Inc. by APIMATIC v2.0 ( https://apimatic.io )
"""
from ..api_helper import APIHelper
import raas.exceptions.api_exception
import raas.models.raas_server_error_model

class RaasServerException(raas.exceptions.api_exception.APIException):
    def __init__(self, reason, context):
        """Constructor for the RaasServerException class
        ...
        """
        super(RaasServerException, self).__init__(reason, context)
