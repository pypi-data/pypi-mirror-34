...
def range_date(start, end=None, days=None, day_step=1, include_end=True):
...
def test():
    print(range_date('2018-07-02', days=5, day_step=1))

    print(range_date('2018-07-02', end='2018-08-24', day_step=1))

    print(range_date('2018-07-02', end='2018-08-23', day_step=3))
    print(range_date('2018-07-02', end='2018-08-24', day_step=3))
    print(range_date('2018-07-02', end='2018-08-25', day_step=3))
