...
class Server(object):
    ...
    def __init__(self, id_, project_id, owner_id, name, type_, machine_type,
                 milli_cpus, memory_mb, created_at, status, services):
        self.id_ = id_
    ...
    def __repr__(self):
        ...
        return template.format(
            ...
            self.name, self.type_, self.machine_type, self.milli_cpus,
            self.memory_mb, self.created_at, self.status, self.services
        )
...
class Galleon(sml.client.SherlockMLService):
    ...
    def create_server(self, project_id, type_, machine_type='custom',
                      milli_cpus=None, memory_mb=None,
                      name=None, type_version=None, environment_ids=None):
        ...
        if machine_type == 'custom':
            ...
            # TODO: Move to new payload style once galleon is latest everywhere
            payload = {'instanceType': type_,
                       'milliCpus': milli_cpus,
                       'memoryMb': memory_mb}
            ...
            instance_size = None
            # new, post-single-tenancy payload
            payload = {'instanceType': type_,
