...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeEncryptedFile, TypeChat, TypeUser, TypeHighScore, TypeDocument, TypeInlineBotSwitchPM, TypeMessage, TypeBotInlineResult, TypeChatFull, TypeFoundGif, TypeDialog, TypeStickerSet, TypeStickerPack, TypeStickerSetCovered
