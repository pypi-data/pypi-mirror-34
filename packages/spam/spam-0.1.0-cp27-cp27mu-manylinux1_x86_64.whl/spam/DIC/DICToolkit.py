...
def applyTransformationOperatorC(applyTransformationOperatorC_nz1, applyTransformationOperatorC_nz2, applyTransformationOperatorC_fourA, applyTransformationOperatorC_threeB, applyTransformationOperatorC_interpOrder):
    return _DICToolkit.applyTransformationOperatorC(applyTransformationOperatorC_nz1, applyTransformationOperatorC_nz2, applyTransformationOperatorC_fourA, applyTransformationOperatorC_threeB, applyTransformationOperatorC_interpOrder)
applyTransformationOperatorC = _DICToolkit.applyTransformationOperatorC
