...
####+BEGIN: bx:icm:python:func :funcName "examples_commonInvoker" :funcType "anyOrNone" :retType "bool" :deco "" :argsList "svcSpec perfSap headers"
"""
*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(org-tree-to-indirect-buffer)][|>]] [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Func-anyOrNone :: /examples_commonInvoker/ retType=bool argsList=(svcSpec perfSap headers)  [[elisp:(org-cycle)][| ]]
"""
...
####+END:
    ...
    #cmndArgs = ""; cps = cpsInit();  cps['svcSpec'] = "http://localhost:8080/swagger.json"
    ...
    cmndArgs = ""; cps = cpsInit();  cps['svcSpec'] = svcSpec
    #cps['perfSap'] = "http://localhost:8080"
    cps['perfSap'] = perfSap
    cps['headers'] = headers    
    menuItem(verbosity='none')    
...
####+END:
        ...
        processSvcSpec(loadedSvcSpec, origin_url, perfSap, headers)        
...
####+BEGIN: bx:icm:python:func :funcName "processSvcSpec" :funcType "anyOrNone" :retType "bool" :deco "" :argsList "spec origin_url perfSap headers"
"""
*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(org-tree-to-indirect-buffer)][|>]] [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Func-anyOrNone :: /processSvcSpec/ retType=bool argsList=(spec origin_url perfSap headers)  [[elisp:(org-cycle)][| ]]
"""
def processSvcSpec(
    spec,
    origin_url,
