...
class IsisL3Router(Base):
	...
	def IsisBierSubDomainList(self):
		"""Returns the one and only one IsisBierSubDomainList object from the server.
		...
		return self._read(IsisBierSubDomainList(self), None)

	@property
	def IsisMappingServerIPV4List(self):
		"""Returns the one and only one IsisMappingServerIPV4List object from the server.
		...
		return self._read(IsisMappingServerIPV4List(self), None)

	@property
	def IsisMappingServerIPV6List(self):
		"""Returns the one and only one IsisMappingServerIPV6List object from the server.
		...
		return self._read(IsisMappingServerIPV6List(self), None)
	...
	def IsisSRTunnelList(self):
		"""Returns the one and only one IsisSRTunnelList object from the server.
		...
		return self._read(IsisSRTunnelList(self), None)
	...
	def IsisStartRouter(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./isisL3Router object references
