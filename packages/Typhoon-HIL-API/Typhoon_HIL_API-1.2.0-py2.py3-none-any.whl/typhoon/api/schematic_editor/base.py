...
class SchematicAPIBase(object):
    ...
    def get_parent(item_handle):
        ...
        **Example:**
        ...
        """
        if item_handle.item_type == ITEM_COMPONENT:
            parent_handle = item_handle.parent
            if not parent_handle:
                raise SchApiException("Provided item doesn't have parent.")
            return parent_handle
        else:
            raise SchApiException("get_parent() for now only support component"
                                  " items.")
    ...
    def prop(component, prop_name):
        ...
        Args:
            component(ItemHandle): Component handle object.
    ...
    @staticmethod
    def prop_from_below(component, prop_name):
        """
        Create property handle for property named ``prop_name`` from level
        below.
