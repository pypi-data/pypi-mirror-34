...
class itkHessian3DToVesselnessMeasureImageFilterUS(itkImageToImageFilterBPython.itkImageToImageFilterISSRTD33IUS3):
    ...
    def GetPointer(self) -> "itkHessian3DToVesselnessMeasureImageFilterUS *":
        """GetPointer(itkHessian3DToVesselnessMeasureImageFilterUS self) -> itkHessian3DToVesselnessMeasureImageFilterUS"""
