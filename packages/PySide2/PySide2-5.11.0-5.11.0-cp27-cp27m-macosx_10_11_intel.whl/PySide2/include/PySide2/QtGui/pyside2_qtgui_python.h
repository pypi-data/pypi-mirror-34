...
#define SBK_QTGUI_QLIST_QINPUTMETHODEVENT_ATTRIBUTE_IDX              37 // const QList<QInputMethodEvent::Attribute > &
#define SBK_QTGUI_QLIST_QOBJECTPTR_IDX                               38 // const QList<QObject* > &
#define SBK_QTGUI_QLIST_QOPENGLDEBUGMESSAGE_IDX                      39 // QList<QOpenGLDebugMessage >
#define SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                            40 // QList<QTextFrame* >
#define SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                               41 // QList<QTextBlock >
#define SBK_QTGUI_QLIST_QSCREENPTR_IDX                               42 // QList<QScreen* >
#define SBK_QTGUI_QLIST_QWINDOWPTR_IDX                               43 // QList<QWindow* >
#define SBK_QTGUI_QVECTOR_UNSIGNEDLONGLONG_IDX                       44 // QVector<unsigned long long >
#define SBK_QTGUI_QVECTOR_FLOAT_IDX                                  45 // QVector<float >
#define SBK_QTGUI_QLIST_QOPENGLSHADERPTR_IDX                         46 // QList<QOpenGLShader* >
#define SBK_QTGUI_QVECTOR_INT_IDX                                    47 // const QVector<int > &
#define SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                           48 // const QHash<int,QByteArray > &
#define SBK_QTGUI_QLIST_QPERSISTENTMODELINDEX_IDX                    49 // const QList<QPersistentModelIndex > &
#define SBK_QTGUI_QSET_QBYTEARRAY_IDX                                50 // QSet<QByteArray >
#define SBK_QTGUI_QLIST_QOPENGLCONTEXTPTR_IDX                        51 // QList<QOpenGLContext* >
