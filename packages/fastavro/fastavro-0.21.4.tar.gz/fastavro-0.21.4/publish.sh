...
osx_wheels_url="https://github.com/fastavro/fastavro/releases/tag/${ver}"
if [ ! -f dist/fastavro-${ver}-cp27-cp27m-macosx_10_12_x86_64.whl ]; then
    echo "Make sure to download the Python 2.7 wheel from $osx_wheels_url"
    exit 1
fi
if [ ! -f dist/fastavro-${ver}-cp34-cp34m-macosx_10_12_x86_64.whl ]; then
    echo "Make sure to download the Python 3.4 wheel from $osx_wheels_url"
    exit 1
fi
if [ ! -f dist/fastavro-${ver}-cp35-cp35m-macosx_10_12_x86_64.whl ]; then
    echo "Make sure to download the Python 3.5 wheel from $osx_wheels_url"
    exit 1
fi
if [ ! -f dist/fastavro-${ver}-cp36-cp36m-macosx_10_12_x86_64.whl ]; then
    echo "Make sure to download the Python 3.6 wheel from $osx_wheels_url"
    exit 1
fi
if [ ! -f dist/fastavro-${ver}-cp37-cp37m-macosx_10_12_x86_64.whl ]; then
    echo "Make sure to download the Python 3.7 wheel from $osx_wheels_url"
    exit 1
fi
