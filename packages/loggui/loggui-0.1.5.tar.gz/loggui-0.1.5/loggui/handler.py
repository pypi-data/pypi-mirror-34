...
try:
    ...
    mname = "file name n/a"
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QTableView, QHBoxLayout, QStyle
...
class Queue2QThread(QThread):
    new_record = pyqtSignal(logging.LogRecord, name="newRecord")
...
class MainThreadWatcher(QThread):
    thread_stopped = pyqtSignal(name="mainThreadStopped")
