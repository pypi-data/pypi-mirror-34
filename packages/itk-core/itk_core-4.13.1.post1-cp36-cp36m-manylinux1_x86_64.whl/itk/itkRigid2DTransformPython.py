...
class itkRigid2DTransformD(itkMatrixOffsetTransformBasePython.itkMatrixOffsetTransformBaseD22):
    ...
    def GetPointer(self) -> "itkRigid2DTransformD *":
        """GetPointer(itkRigid2DTransformD self) -> itkRigid2DTransformD"""
        return _itkRigid2DTransformPython.itkRigid2DTransformD_GetPointer(self)
...
itkRigid2DTransformD.GetPointer = new_instancemethod(_itkRigid2DTransformPython.itkRigid2DTransformD_GetPointer, None, itkRigid2DTransformD)
