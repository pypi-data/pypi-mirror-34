...
from apimeter.compat import OrderedDict, basestring, numeric_types
from apimeter.utils import FileUtils
    ...
    @params
        (list) parameters: parameter name and value in list
            parameter value may be in three types:
                ...
                (3) call custom function in youmi.py
            e.g.
                [
        ...
        (str) testset_path: testset file path, used for locating csv file and youmi.py
