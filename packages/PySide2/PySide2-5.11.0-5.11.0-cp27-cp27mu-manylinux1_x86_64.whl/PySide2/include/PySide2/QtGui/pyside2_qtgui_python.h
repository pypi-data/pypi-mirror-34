...
#define SBK_QTGUI_QVECTOR_UNSIGNEDLONG_IDX                           44 // QVector<unsigned long >
...
#define SBK_QTGUI_QVECTOR_FLOAT_IDX                                  48 // QVector<float >
#define SBK_QTGUI_QLIST_QOPENGLSHADERPTR_IDX                         49 // QList<QOpenGLShader* >
#define SBK_QTGUI_QLIST_QSCREENPTR_IDX                               50 // QList<QScreen* >
