...
Available events: 'change'"""
    @_explicitize_args
    def __init__(self, id=None, date=None, min_date_allowed=None, max_date_allowed=None, initial_visible_month=None, day_size=39, calendar_orientation="Unparsable-JS-Object", is_RTL=False, placeholder=None, reopen_calendar_on_clear=False, number_of_months_shown=1, with_portal=False, with_full_screen_portal=False, first_day_of_week="Unparsable-JS-Object", stay_open_on_select=False, show_outside_days=True, month_format=None, display_format=None, disabled=False, clearable=False, **kwargs):
