...
function extract_element(elem){
    ...
    def fill(self, xpath, value, clear=True, javascript_safe=False):
        ...
        '''
        return self._fill(xpath, value, clear, javascript_safe, 'xpath')

    def fill_css(self, css_select, value, clear=True, javascript_safe=False):
        '''
        :param css_select: css selector string eg:".btn"
        :param value: string to fill the input with
        :param clear: if True clear input before writing
        :param javascript_safe: if True avoid javascript problem (assigning value to field)
        '''
        return self._fill(css_select, value, clear, javascript_safe, 'css')

    def _fill(self, select_expr, value, clear=True, javascript_safe=False, select_type='xpath'):
        '''
        returns the list of elements affected by the fill (which in general should only be 1)
        '''
        elements = self._select(select_expr, False, select_type)
    ...
    def fill_form(self, clear=True, javascript_safe=True, **inputs):
        ...
        '''
        return self.fill_form_attr('name', inputs, clear, javascript_safe)
    ...
    def fill_form_attr(self, attr, inputs, clear=True, javascript_safe=False):
        ...
        return self.fill_form_xpath(inputs, clear, javascript_safe)
    ...
    def fill_form_xpath(self, inputs, clear=True, javascript_safe=False):
        ...
        for xpath, value in inputs.items():
            elements.extend(self.fill(xpath, value, clear, javascript_safe))
        return elements
    ...
    def fill_form_ordered(self, items, attr='name', clear=True, javascript_safe=False):
        ...
        for name, value in items:
            els = self.fill('//input[@{0}={1!r}] | //textarea[@{0}={1!r}]'
