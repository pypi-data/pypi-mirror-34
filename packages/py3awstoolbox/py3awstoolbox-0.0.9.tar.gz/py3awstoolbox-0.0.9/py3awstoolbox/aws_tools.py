...
class Logs():
  ...
  def filter_logs(self, log_group, key_word, last_mins=None, start_time=None, next_mins=None, end_time=None,):
...
if __name__ == "__main__":
  aws_log = Logs()
  logs_found = aws_log.filter_logs(log_group='/aws/lambda/tafe-search-sit-tafe', key_word= 'animal', last_mins=15)
  print (logs_found.keys())