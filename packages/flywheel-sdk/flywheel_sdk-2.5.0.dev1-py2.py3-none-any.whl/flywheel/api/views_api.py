...
"""
    ...
    OpenAPI spec version: 2.5.0-dev.1
...
class ViewsApi(object):
    ...
    def save_view_data(self, container_id, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.save_view_data_with_http_info(container_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.save_view_data_with_http_info(container_id, body, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def save_view_data_with_http_info(self, container_id, body, **kwargs):  # noqa: E501
        """Execute a view, saving data to the target container / file
        ...
        if ('container_id' not in params or
                params['container_id'] is None):
            raise ValueError("Missing the required parameter `container_id` when calling `save_view_data`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `save_view_data`")  # noqa: E501
