...
class itkJointHistogramMutualInformationImageToImageMetricv4IF2IF2(itkImageToImageMetricv4Python.itkImageToImageMetricv4F2F2):
    ...
    def GetPointer(self) -> "itkJointHistogramMutualInformationImageToImageMetricv4IF2IF2 *":
        """GetPointer(itkJointHistogramMutualInformationImageToImageMetricv4IF2IF2 self) -> itkJointHistogramMutualInformationImageToImageMetricv4IF2IF2"""
        return _itkJointHistogramMutualInformationImageToImageMetricv4Python.itkJointHistogramMutualInformationImageToImageMetricv4IF2IF2_GetPointer(self)
...
itkJointHistogramMutualInformationImageToImageMetricv4IF2IF2.GetPointer = new_instancemethod(_itkJointHistogramMutualInformationImageToImageMetricv4Python.itkJointHistogramMutualInformationImageToImageMetricv4IF2IF2_GetPointer, None, itkJointHistogramMutualInformationImageToImageMetricv4IF2IF2)
...
class itkJointHistogramMutualInformationImageToImageMetricv4IF3IF3(itkImageToImageMetricv4Python.itkImageToImageMetricv4F3F3):
    ...
    def GetPointer(self) -> "itkJointHistogramMutualInformationImageToImageMetricv4IF3IF3 *":
        """GetPointer(itkJointHistogramMutualInformationImageToImageMetricv4IF3IF3 self) -> itkJointHistogramMutualInformationImageToImageMetricv4IF3IF3"""
        return _itkJointHistogramMutualInformationImageToImageMetricv4Python.itkJointHistogramMutualInformationImageToImageMetricv4IF3IF3_GetPointer(self)
...
itkJointHistogramMutualInformationImageToImageMetricv4IF3IF3.GetPointer = new_instancemethod(_itkJointHistogramMutualInformationImageToImageMetricv4Python.itkJointHistogramMutualInformationImageToImageMetricv4IF3IF3_GetPointer, None, itkJointHistogramMutualInformationImageToImageMetricv4IF3IF3)
