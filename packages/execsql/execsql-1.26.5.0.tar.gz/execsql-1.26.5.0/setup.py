...
* Display a tables or view in a GUI dialog,
...
* Display a pair of tables or views in a GUI dialog, allowing the user
  to compare data and find rows with matching key values.
...
* Write messages to the console or to a file during the processing of 
  a SQL script. These messages can be used to display the progress of 
  the script or create a custom log of the operations that have been 
  carried out or results obtained. Status messages and data exported in 
