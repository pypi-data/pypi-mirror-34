...
setup(
    name='w7x',
    version=w7x.__version__,
    description=('Convenience methods for magnetic field '
                 'evaluations evolved around the stellarator Wendelstein 7-X.'),
    author=w7x.__author__,
    author_email=w7x.__email__,
    license='MIT',
    ...
    python_requires='>=2.7',
    keywords="Wendelstein 7-X magnetic field field line diffusion VMEC EXTENDER",
    project_urls={
        'Documentation': 'https://gitlab.mpcdf.mpg.de/dboe/w7x/',
