...
#include "applyTransformationOperatorC.hpp"
...
%apply (int DIM1, int DIM2, int DIM3,            float        * IN_ARRAY3)      { (              int applyTransformationOperatorC_nz1,   int applyTransformationOperatorC_ny1,   int applyTransformationOperatorC_nx1, float*         applyTransformationOperatorC_im        ) };
%apply (int DIM1, int DIM2, int DIM3,            float        * INPLACE_ARRAY3) { (              int applyTransformationOperatorC_nz2,   int applyTransformationOperatorC_ny2,   int applyTransformationOperatorC_nx2, float*         applyTransformationOperatorC_imSub     ) };
%apply (int DIM1,                                int          * IN_ARRAY1)      { (              int applyTransformationOperatorC_threeA,                                                                              int*           applyTransformationOperatorC_originSub ) };
%apply (int DIM1, int DIM2,                      float        * IN_ARRAY2)      { (              int applyTransformationOperatorC_fourA, int applyTransformationOperatorC_fourB,                                       float*         applyTransformationOperatorC_Finv      ) };
%apply (int DIM1,                                float        * IN_ARRAY1)      { (              int applyTransformationOperatorC_threeB,                                                                              float*         applyTransformationOperatorC_Fpoint    ) };
