...
class AnalysisListEntry(object):
    ...
    def __init__(self, id=None, inputs=None, files=None, job=None, gear_info=None, notes=None, description=None, label=None, parent=None, created=None, modified=None):  # noqa: E501
