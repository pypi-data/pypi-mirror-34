...
class IsisTrillSimRouter(Base):
	...
	def TrillSimulatedMCastIpv4GroupList(self):
		"""Returns the one and only one TrillSimulatedMCastIpv4GroupList object from the server.
		...
		return self._read(TrillSimulatedMCastIpv4GroupList(self), None)

	@property
	def TrillSimulatedMCastIpv6GroupList(self):
		"""Returns the one and only one TrillSimulatedMCastIpv6GroupList object from the server.
		...
		return self._read(TrillSimulatedMCastIpv6GroupList(self), None)

	@property
	def TrillSimulatedMCastMacGroupList(self):
		"""Returns the one and only one TrillSimulatedMCastMacGroupList object from the server.
		...
		return self._read(TrillSimulatedMCastMacGroupList(self), None)
	...
	def remove(self):
		"""Deletes a child instance of IsisTrillSimRouter on the server.
