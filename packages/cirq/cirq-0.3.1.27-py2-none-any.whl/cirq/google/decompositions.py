...
def _easy_direction_partial_cz(q0, q1, t):
    u"""The actual hardware can only do CZs that phase counter-clockwise.
...
def two_qubit_matrix_to_native_gates(q0,
                                     q1,
                                     mat,
                                     allow_partial_czs,
                                     tolerance = 1e-8
...
def _kak_decomposition_to_native_gates(q0,
                                       q1,
                                       a0,
                                       a1,
                                       x,
