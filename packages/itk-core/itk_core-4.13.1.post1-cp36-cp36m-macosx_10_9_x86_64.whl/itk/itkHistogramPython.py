...
class itkHistogramD(itkSamplePython.itkSampleAD):
    ...
    def GetIndex(self, *args) -> "itkArraySL const &":
        """
        GetIndex(itkHistogramD self, itkArrayD measurement) -> itkArraySL
    ...
    def GetPointer(self) -> "itkHistogramD *":
...
class itkHistogramF(itkSamplePython.itkSampleAF):
    ...
    def GetIndex(self, *args) -> "itkArraySL const &":
        """
        GetIndex(itkHistogramF self, itkArrayF measurement) -> itkArraySL
    ...
    def GetPointer(self) -> "itkHistogramF *":
...
class itkSimpleDataObjectDecoratorHD(ITKCommonBasePython.itkDataObject):
    ...
    def GetPointer(self) -> "itkSimpleDataObjectDecoratorHD *":
...
class itkSimpleDataObjectDecoratorHF(ITKCommonBasePython.itkDataObject):
    ...
    def GetPointer(self) -> "itkSimpleDataObjectDecoratorHF *":
