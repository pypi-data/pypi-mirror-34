            ...
            <div class="row">
                <div class="col">
                    ...
                    <p class="mb-2 text-muted">This utility prints the complete response to the browser dev-tools
                        console in JSON format. Press F12
                        in chrome to view</p>
                    <div class="form-group">
                        <label class="lead" for="command">Command</label>
                        <input type="text" v-on:keyup="commandTextChange"
                               placeholder="Type a command here. e.g. (custom, script, shell)"
                               class="form-control"
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group" style="padding-left:15px;">
                                <input type="checkbox" id="debug" value="Debug" v-on:change="commandChange"
                                       v-model="commandtaxParams">
                                <label for="debug">Debug</label>
                                <small id="debugHelp" class="form-text text-muted">Outputs verbose, detailed information
                                    about the request.
                                </small>
                                <br>
                                <input type="checkbox" id="sensitive" value="Sensitive" v-on:change="commandChange"
                                       v-model="commandtaxParams">
                                ...
                                <br>
                                <input type="checkbox" id="escape" value="Escape" v-on:change="commandChange"
                                       v-model="commandtaxParams">
                                <label for="escape">Escape</label>
                                <small id="escapeHelp" class="form-text text-muted">Escapes double quotes. Useful when
                                    generating commands for Scriptax
                                </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <p class="lead">Data</p>
                            <div v-if="(dataMakers.includes('Post') || dataMakers.includes('Query') || dataMakers.includes('Path'))">
                                <p class="mb-2 text-muted">The generated command does not automatically update after
                                    each keystroke for data fields due to latency issues.</p></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="query" value="Query"
                                           v-model="dataMakers">
                                    <label class="form-check-label" for="query">Query Param</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="path" value="Path"
                                           v-model="dataMakers">
                                    <label class="form-check-label" for="path">Path Injection <span
                                            v-if="(totalPaths > 0)"
                                            class="badge badge-pill badge-danger">{{totalPaths}}</span></label>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="postDataText" rows="3"
                                                      v-on:change="commandChange" v-model="data.post"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div v-if="(dataMakers.includes('Query'))">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="lead" for="queryDataText">Query Params
                                                (?query=data&under=stand)</label>
                                            <p class="mb-2 text-muted">Use double quotes i.e " not '</p>
                                            <textarea class="form-control" id="queryDataText" rows="3"
                                                      v-on:change="commandChange" v-model="data.query"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div v-for="pathparam in data.path" class="row" style="margin-top:15px;">
                                            ...
                                            <div class="col-2">
                                                <label class="lead"
                                                       :for="pathparam.id"><strong>{{pathparam.label}}:</strong></label>
                                            </div>
                                            <div class="col-10">
                                                <input type="text" v-model="pathparam.value"
                                                       v-on:change="commandTextChange" placeholder="Type a value here"
                                                       class="form-control"
                                                       :id="pathparam.id">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row"
                                 style="border-left: 6px solid #ccc!important; color: #000!important; background-color: #ddffff!important; border-color: #2196F3!important;">

                                <div class="col-1 col-xs-1 text-center"
                                     style="flex: 0 0 2.333333% !important; max-width: 2.333333% !important;"
                                ...
                                <div class="col-11 col-xs-11">
                                    <span style="font-family: 'Courier New';font-size:12pt;"
                                          v-html="generatedCommandtax"> </span>
                                </div>
    ...
    export default {
        ...
        mounted() {
            apitax.catalogEndpoints(this, function (context, response) {
                ...
                context.endpoint = response.data.selected;
            });
