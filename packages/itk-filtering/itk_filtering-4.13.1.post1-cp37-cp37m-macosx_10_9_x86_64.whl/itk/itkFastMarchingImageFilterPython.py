...
class itkFastMarchingImageFilterIF2IF2(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    if the speed image is not ITK_NULLPTR, the output information is
    ...
    def SetSpeedConstant(self, value: 'double') -> "void":
        ...
        Set the Speed
        Constant. If the Speed Image is ITK_NULLPTR, the SpeedConstant value
        is used for the whole level set. By default, the SpeedConstant is set
        to 1.0. 
        """
    ...
    def SetOutputSize(self, size: 'itkSize2') -> "void":
        ...
        image is ITK_NULLPTR or if the OverrideOutputInformation is true, the
        output information is set from user specified parameters. These
        parameters can be specified using methods SetOutputRegion(),
        SetOutputSpacing(), SetOutputDirection(), and SetOutputOrigin(). Else
        if the speed image is not ITK_NULLPTR, the output information is
    ...
    def GetPointer(self) -> "itkFastMarchingImageFilterIF2IF2 *":
        """GetPointer(itkFastMarchingImageFilterIF2IF2 self) -> itkFastMarchingImageFilterIF2IF2"""
...
class itkFastMarchingImageFilterIF3IF3(itkImageToImageFilterAPython.itkImageToImageFilterIF3IF3):
    ...
    def GetPointer(self) -> "itkFastMarchingImageFilterIF3IF3 *":
        """GetPointer(itkFastMarchingImageFilterIF3IF3 self) -> itkFastMarchingImageFilterIF3IF3"""
