...
from smfishHmrf.DatasetMatrix import DatasetMatrixSingleField, DatasetMatrixMultiField
...
ncol=10, dot_size=20, outfile=None):
	...
	assert isinstance(goi, basestring), "goi must be a basestring"
...
dot_size=20, outfile=None):
	assert isinstance(goi, basestring), "gene must be basestring"
