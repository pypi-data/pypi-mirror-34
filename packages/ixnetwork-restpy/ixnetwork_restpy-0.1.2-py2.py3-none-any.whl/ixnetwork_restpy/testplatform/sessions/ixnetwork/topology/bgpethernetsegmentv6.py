...
class BgpEthernetSegmentV6(Base):
	...
	def Bgpv6BMacMappedIpList(self):
		"""Returns the one and only one Bgpv6BMacMappedIpList object from the server.
		...
		return self._read(Bgpv6BMacMappedIpList(self), None)
	...
	def FlushRemoteCMACForwardingTable(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpEthernetSegmentV6 object references
