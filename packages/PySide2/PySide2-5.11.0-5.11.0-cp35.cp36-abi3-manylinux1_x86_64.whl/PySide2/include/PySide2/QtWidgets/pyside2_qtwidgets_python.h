...
#define SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                        15 // QPair<qreal,QPointF >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX                  16 // QList<QPair< qreal,QPointF > >
#define SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                          17 // QPair<qreal,qreal >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                    18 // QList<QPair< qreal,qreal > >
#define SBK_QTWIDGETS_QVECTOR_INT_IDX                                19 // const QVector<int > &
#define SBK_QTWIDGETS_QHASH_INT_QBYTEARRAY_IDX                       20 // const QHash<int,QByteArray > &
#define SBK_QTWIDGETS_QMAP_INT_QVARIANT_IDX                          21 // QMap<int,QVariant >
#define SBK_QTWIDGETS_QLIST_QPERSISTENTMODELINDEX_IDX                22 // const QList<QPersistentModelIndex > &
#define SBK_QTWIDGETS_QLIST_QRECTF_IDX                               23 // const QList<QRectF > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                     24 // QList<QGraphicsView* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTANIMATIONPTR_IDX                25 // QList<QAbstractAnimation* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTSTATEPTR_IDX                    26 // const QList<QAbstractState* > &
#define SBK_QTWIDGETS_QLIST_QABSTRACTBUTTONPTR_IDX                   27 // QList<QAbstractButton* >
#define SBK_QTWIDGETS_QLIST_QACTIONPTR_IDX                           28 // QList<QAction* >
#define SBK_QTWIDGETS_QLIST_QSCROLLERPTR_IDX                         29 // QList<QScroller* >
#define SBK_QTWIDGETS_QLIST_QREAL_IDX                                30 // const QList<qreal > &
#define SBK_QTWIDGETS_QLIST_QUNDOSTACKPTR_IDX                        31 // QList<QUndoStack* >
#define SBK_QTWIDGETS_QLIST_QGRAPHICSWIDGETPTR_IDX                   32 // QList<QGraphicsWidget* >
#define SBK_QTWIDGETS_QLIST_QWIDGETPTR_IDX                           33 // QList<QWidget* >
...
#define SBK_QTWIDGETS_QMAP_QDATE_QTEXTCHARFORMAT_IDX                 37 // QMap<QDate,QTextCharFormat >
#define SBK_QTWIDGETS_QLIST_INT_IDX                                  38 // QList<int >
#define SBK_QTWIDGETS_QLIST_QWIZARD_WIZARDBUTTON_IDX                 39 // const QList<QWizard::WizardButton > &
#define SBK_QTWIDGETS_QLIST_QDOCKWIDGETPTR_IDX                       40 // const QList<QDockWidget* > &
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETITEMPTR_IDX                  41 // QList<QTableWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX           42 // QList<QTableWidgetSelectionRange >
#define SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX                   43 // QList<QListWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QMDISUBWINDOWPTR_IDX                     44 // QList<QMdiSubWindow* >
