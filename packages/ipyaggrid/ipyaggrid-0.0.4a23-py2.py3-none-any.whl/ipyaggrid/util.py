...
class Util:
    ...
    @staticmethod
    def setup_menu(grid, menu_in, menu):
        """
        ...
        if grid.export_mode == 'buttons':
            ...
            if 'enableRangeSelection' in grid.grid_options and grid.grid_options[
                    'enableRangeSelection']:
                # Add export data from selected range selection
                add_button(menu_in, 'Export Range Data',
                           'exportFunc.exportData(gridOptions, view)')
            ...
            if 'rowSelection' in grid.grid_options:
