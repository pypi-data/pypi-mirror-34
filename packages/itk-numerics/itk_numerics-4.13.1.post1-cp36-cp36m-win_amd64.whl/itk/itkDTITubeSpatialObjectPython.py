...
class itkDTITubeSpatialObject3_Superclass(itkPointBasedSpatialObjectPython.itkPointBasedSpatialObject3):
    ...
    def GetPoint(self, *args) -> "itkSpatialObjectPoint3 *":
        """
        GetPoint(itkDTITubeSpatialObject3_Superclass self, unsigned long long ind) -> itkSpatialObjectPoint3
        GetPoint(itkDTITubeSpatialObject3_Superclass self, unsigned long long ind) -> itkSpatialObjectPoint3
        """
        return _itkDTITubeSpatialObjectPython.itkDTITubeSpatialObject3_Superclass_GetPoint(self, *args)


    def SetPoint(self, ind: 'unsigned long long', pnt: 'itkDTITubeSpatialObjectPoint3') -> "void":
        """SetPoint(itkDTITubeSpatialObject3_Superclass self, unsigned long long ind, itkDTITubeSpatialObjectPoint3 pnt)"""
        return _itkDTITubeSpatialObjectPython.itkDTITubeSpatialObject3_Superclass_SetPoint(self, ind, pnt)


    def RemovePoint(self, ind: 'unsigned long long') -> "void":
        """RemovePoint(itkDTITubeSpatialObject3_Superclass self, unsigned long long ind)"""
