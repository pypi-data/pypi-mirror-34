...
urlpatterns = [
    ...
    url(r'^source/qrcode/(?P<qrcode_type>(.)+)/(?P<source_id>[0-9]+)/(?P<landing_id>[0-9]+)/$', views.source_qrcode, name='source_qrcode'),
    ...
    url(r'^preuser/contract/update/check/(?P<pk>[0-9]+)$', views.PreuserContractUpdateCheck.as_view(),
        name='preuser_contract_update_check'),
