...
"""
# Standardmodule:
from os import sep, unlink, listdir
...
class Browser(BrowserView):
    ...
    def save(self):
        ...
        try:
            ...
            if not context.getAdapter('sametype')(file, 'StringType'):
                data = file.read()
    ...
    def update(self):
        ...
        context.getAdapter('authorized')('Modify portal content')
    ...
    def cleanup(self):
        ...
        cnt = defaultdict(int)
        catalog = context.getAdapter('pc')()._catalog
