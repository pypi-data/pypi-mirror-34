...
def test_str():
    assert unicode(Pauli.X) == u'X'
    assert unicode(Pauli.Y) == u'Y'
    assert unicode(Pauli.Z) == u'Z'


def test_repr():
    assert repr(Pauli.X) == u'Pauli.X'
    assert repr(Pauli.Y) == u'Pauli.Y'
    assert repr(Pauli.Z) == u'Pauli.Z'
