...
u"""An optimization pass that pushes some W gates later and later in the circuit.
"""
...
class EjectFullW(circuits.OptimizationPass):
    u"""Pushes ExpW gates with half_turns=1 towards the end of the circuit.
