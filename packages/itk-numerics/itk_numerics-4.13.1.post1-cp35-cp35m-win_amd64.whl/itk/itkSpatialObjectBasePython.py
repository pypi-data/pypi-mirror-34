...
class itkSpatialObject2(ITKCommonBasePython.itkDataObject):
    ...
    def GetBoundingBox(self) -> "itkBoundingBoxULL2DVCULLPD2 *":
...
class itkSpatialObject3(ITKCommonBasePython.itkDataObject):
    ...
    def GetBoundingBox(self) -> "itkBoundingBoxULL3DVCULLPD3 *":
...
class itkTreeNodeSO2(ITKCommonBasePython.itkObject):
    ...
    def GetChild(self, number: 'long long') -> "itkTreeNodeSO2 *":
    ...
    def CountChildren(self) -> "long long":
    ...
    def GetNumberOfChildren(self, depth: 'unsigned int'=0, name: 'char *'=None) -> "long long":
        """
    ...
    def ChildPosition(self, *args) -> "long long":
        """
...
class itkTreeNodeSO3(ITKCommonBasePython.itkObject):
    ...
    def GetChild(self, number: 'long long') -> "itkTreeNodeSO3 *":
