...
class GracePlot:
    ...
    def __init__(self,width=None,height=None, auto_redraw=True, redraw_interval=0.1):
        ...
        try:
            ...
            raise OSError(e.errno,'XmGrace is not found on standard path!')
    ...
    def multi(self, rows, cols, offset=0.1, hgap=0.1, vgap=0.15):
        ...
        self._send( 'ARRANGE( %s, %s, %s, %s, %s )' % (
                            rows, cols, offset, hgap, vgap ) )
        self._flush()
        self.redraw()
        self.focus(0)
        self.updateall()
...
if __name__=='__main__':
    import math
    a=GracePlot(width=4, height=3, auto_redraw=True)
    a.debug=False
    xvals=range(100)
