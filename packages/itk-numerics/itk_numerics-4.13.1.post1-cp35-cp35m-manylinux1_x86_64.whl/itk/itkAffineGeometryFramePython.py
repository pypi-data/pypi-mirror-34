...
class itkAffineGeometryFrameD2(ITKCommonBasePython.itkObject):
    ...
    C++ includes: itkAffineGeometryFrame.h 
    """
    ...
    def GetModifiableBoundingBox(self) -> "itkBoundingBoxUL2DVCULPD2 *":
        """GetModifiableBoundingBox(itkAffineGeometryFrameD2 self) -> itkBoundingBoxUL2DVCULPD2"""
        return _itkAffineGeometryFramePython.itkAffineGeometryFrameD2_GetModifiableBoundingBox(self)


    def GetBoundingBox(self, *args) -> "itkBoundingBoxUL2DVCULPD2 *":
        """
        GetBoundingBox(itkAffineGeometryFrameD2 self) -> itkBoundingBoxUL2DVCULPD2
        GetBoundingBox(itkAffineGeometryFrameD2 self) -> itkBoundingBoxUL2DVCULPD2
        """
    ...
    def SetBounds(self, bounds: 'itkFixedArrayD4') -> "void":
        ...
        Set the bounding box Only
        possible via the BoundsArray to make clear that a copy of the
...
class itkAffineGeometryFrameD3(ITKCommonBasePython.itkObject):
    ...
    def GetModifiableBoundingBox(self) -> "itkBoundingBoxUL3DVCULPD3 *":
        """GetModifiableBoundingBox(itkAffineGeometryFrameD3 self) -> itkBoundingBoxUL3DVCULPD3"""
        return _itkAffineGeometryFramePython.itkAffineGeometryFrameD3_GetModifiableBoundingBox(self)


    def GetBoundingBox(self, *args) -> "itkBoundingBoxUL3DVCULPD3 *":
        """
        GetBoundingBox(itkAffineGeometryFrameD3 self) -> itkBoundingBoxUL3DVCULPD3
        GetBoundingBox(itkAffineGeometryFrameD3 self) -> itkBoundingBoxUL3DVCULPD3
        """
