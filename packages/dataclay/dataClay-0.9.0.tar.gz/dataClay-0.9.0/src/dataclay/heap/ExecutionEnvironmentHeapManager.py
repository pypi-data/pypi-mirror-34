    ...
    def gc_collect_internal(self, object_to_update):
        ...
        try:
            ...
            if object_to_update.is_pending_to_register():
                ...
                self.runtime.ready_clients["@STORAGE"].update_to_db(object_to_update.get_object_id(), obj_bytes, True)
            else: 
                ...
                if obj_bytes is not None:
                    ...
                    self.runtime.ready_clients["@STORAGE"].update_to_db(object_to_update.get_object_id(), ref_counting_bytes, False)
