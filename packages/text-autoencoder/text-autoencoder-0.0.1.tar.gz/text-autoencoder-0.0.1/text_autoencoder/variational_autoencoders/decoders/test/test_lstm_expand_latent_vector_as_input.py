...
from ..lstm_expand_latent_vector_as_input import LSTM_ExpandLatentVectorAsInput


class LSTMExpandLatentVectorAsInputTestCase(tf.test.TestCase):
    ...
    def test_input_with_tensor(self):
        with self.test_session() as sess:
            logits, word_indices = LSTM_ExpandLatentVectorAsInput(
