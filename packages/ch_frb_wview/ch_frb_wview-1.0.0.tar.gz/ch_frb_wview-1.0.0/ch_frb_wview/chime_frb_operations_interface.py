...
def create_user_account(database='sqlite:///databases/chime_frb_operations.sqlite3'):
...
def remove_user_account(database='sqlite:///databases/chime_frb_operations.sqlite3'):    
...
def main():
    database = "sqlite:///databases/chime_frb_operations.sqlite3"
    args = sys.argv
    print args
