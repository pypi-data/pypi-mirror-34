...
#define SBK_QTWIDGETS_QLIST_QRECTF_IDX                               16 // const QList<QRectF > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                     17 // QList<QGraphicsView* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTBUTTONPTR_IDX                   18 // QList<QAbstractButton* >
...
#define SBK_QTWIDGETS_QMAP_QDATE_QTEXTCHARFORMAT_IDX                 23 // QMap<QDate,QTextCharFormat >
#define SBK_QTWIDGETS_QLIST_INT_IDX                                  24 // QList<int >
...
#define SBK_QTWIDGETS_QLIST_QWIDGETPTR_IDX                           27 // QList<QWidget* >
#define SBK_QTWIDGETS_QVECTOR_INT_IDX                                28 // const QVector<int > &
#define SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX                   29 // QList<QListWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETITEMPTR_IDX                  30 // QList<QTableWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX           31 // QList<QTableWidgetSelectionRange >
#define SBK_QTWIDGETS_QLIST_QMDISUBWINDOWPTR_IDX                     32 // QList<QMdiSubWindow* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTANIMATIONPTR_IDX                33 // QList<QAbstractAnimation* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTSTATEPTR_IDX                    34 // const QList<QAbstractState* > &
#define SBK_QTWIDGETS_QHASH_INT_QBYTEARRAY_IDX                       35 // const QHash<int,QByteArray > &
#define SBK_QTWIDGETS_QMAP_INT_QVARIANT_IDX                          36 // QMap<int,QVariant >
#define SBK_QTWIDGETS_QLIST_QPERSISTENTMODELINDEX_IDX                37 // const QList<QPersistentModelIndex > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSWIDGETPTR_IDX                   38 // QList<QGraphicsWidget* >
#define SBK_QTWIDGETS_QLIST_QKEYSEQUENCE_IDX                         39 // const QList<QKeySequence > &
#define SBK_QTWIDGETS_QLIST_QWINDOWPTR_IDX                           40 // QList<QWindow* >
#define SBK_QTWIDGETS_QLIST_QSCREENPTR_IDX                           41 // QList<QScreen* >
#define SBK_QTWIDGETS_QLIST_QSCROLLERPTR_IDX                         42 // QList<QScroller* >
#define SBK_QTWIDGETS_QLIST_QREAL_IDX                                43 // const QList<qreal > &
