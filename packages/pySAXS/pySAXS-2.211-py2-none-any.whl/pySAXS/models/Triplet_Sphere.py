...
class Triplet_Sphere(Model):
    ...
    def __init__(self):
        Model.__init__(self)
        self.IntensityFunc=self.Triplet_Function #function
        ...
        self.name="Multi: Triplet of identical spheres"          #name of the model
        self.Description="Triplet of identical spheres"
