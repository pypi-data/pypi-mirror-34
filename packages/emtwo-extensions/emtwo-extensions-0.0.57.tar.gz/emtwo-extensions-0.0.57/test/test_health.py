...
from redash_stmo.health import update_health_status, health_status, datasource_health
...
class TestHealthStatus(BaseTestCase):
    def setUp(self):
        ...
        self.patched_custom_queries = self._setup_mock('redash_stmo.health.settings')
        self.patched_updated_health_status = self._setup_mock('redash_stmo.health.update_health_status')
    ...
    def test_health_status_run_query_throws_noop_not_implemented_exception(self):
        ...
        self.assertEqual(self.patched_updated_health_status.call_count, 0)
