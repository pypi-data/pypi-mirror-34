...
def test_u_gate_repr():
    ...
    assert repr(gate) == u'QasmUGate(0.1, 0.2, 0.3)'
...
def test_qasm_two_qubit_gate_repr():
    ...
    assert repr(gate) == (u'QasmTwoQubitGate(QasmUGate(0.1, 0.2, 0.3), '
                                           u'QasmUGate(0.4, 0.5, 0.6), '
                                           u'0.7, 0.8, 0.9, '
                                           u'QasmUGate(1.0, 1.1, 1.2), '
                                           u'QasmUGate(1.3, 1.4, 1.5))')
...
def test_output_unitary_same_as_qiskit():
    ...
    result = p.execute(backend=u'local_unitary_simulator')
