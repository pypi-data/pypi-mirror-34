...
class PodGenerator:
    ...
    def _get_log_containers(self):
        return self.log_containers
    ...
    def make_pod(self, namespace, image, pod_id, cmds, arguments, labels):
        ...
        worker_log_container_spec = self._get_log_containers()
        ...
        return Pod(
            ...
            log_containers=worker_log_container_spec,
            volumes=volumes,
