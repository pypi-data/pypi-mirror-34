...
#define SBK_QTCHARTS_QLIST_QPOINTF_IDX                               11 // const QList<QPointF > &
#define SBK_QTCHARTS_QVECTOR_QPOINTF_IDX                             12 // QVector<QPointF >
#define SBK_QTCHARTS_QLIST_QTCHARTS_QBOXSETPTR_IDX                   13 // QList<QtCharts::QBoxSet* >
