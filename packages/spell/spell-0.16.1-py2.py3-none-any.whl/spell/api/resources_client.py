...
class ResourcesClient(base_client.BaseClient):
    def __init__(self, owner, resource_url=RESOURCES_RESOURCE_URL, **kwargs):
        self.owner = owner
        self.resource_url = resource_url
        super(ResourcesClient, self).__init__(**kwargs)
    ...
    def get_ls(self, path):
        ...
        """
        endpoint = url_path_join(self.resource_url, self.owner, LS_RESOURCE_URL, *path.split('/'))
    ...
    def tar_of_path(self, path):
        ...
        """
        endpoint = url_path_join(self.resource_url, self.owner, COPY_RESOURCE_URL, *path.split('/'))
