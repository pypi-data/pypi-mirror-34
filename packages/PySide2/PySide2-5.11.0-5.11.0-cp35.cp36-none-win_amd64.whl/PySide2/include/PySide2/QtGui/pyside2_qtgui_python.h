...
#define SBK_QTGUI_QLIST_QOPENGLCONTEXTPTR_IDX                        39 // QList<QOpenGLContext* >
#define SBK_QTGUI_QSET_QBYTEARRAY_IDX                                40 // QSet<QByteArray >
#define SBK_QTGUI_QLIST_QOPENGLDEBUGMESSAGE_IDX                      41 // QList<QOpenGLDebugMessage >
#define SBK_QTGUI_QVECTOR_INT_IDX                                    42 // const QVector<int > &
#define SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                           43 // const QHash<int,QByteArray > &
#define SBK_QTGUI_QLIST_QPERSISTENTMODELINDEX_IDX                    44 // const QList<QPersistentModelIndex > &
#define SBK_QTGUI_QVECTOR_FLOAT_IDX                                  45 // QVector<float >
#define SBK_QTGUI_QLIST_QOPENGLSHADERPTR_IDX                         46 // QList<QOpenGLShader* >
#define SBK_QTGUI_QVECTOR_UNSIGNEDLONGLONG_IDX                       47 // QVector<unsigned long long >
#define SBK_QTGUI_QLIST_QWINDOWPTR_IDX                               48 // QList<QWindow* >
#define SBK_QTGUI_QLIST_QSCREENPTR_IDX                               49 // QList<QScreen* >
#define SBK_QTGUI_QLIST_QTEXTBLOCK_IDX                               50 // QList<QTextBlock >
#define SBK_QTGUI_QLIST_QTEXTFRAMEPTR_IDX                            51 // QList<QTextFrame* >
