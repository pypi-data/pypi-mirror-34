...
from kamonohashi.models.infos_storage_file_info import InfosStorageFileInfo  # noqa: F401,E501
from kamonohashi.models.storage_dir_info import StorageDirInfo  # noqa: F401,E501
...
class StorageListResultInfo(object):
    ...
    def dirs(self):
        ...
        searchDirPath 配下のディレクトリ  # noqa: E501
    ...
    def exceeded(self):
        ...
        ディレクトリ直下に1000件の結果があった場合true  1000件以上は省略される。ユーザー利用規約として1000件以上作らないようにする  # noqa: E501
    ...
    def files(self):
        ...
        searchDirPath 配下のファイル  # noqa: E501
