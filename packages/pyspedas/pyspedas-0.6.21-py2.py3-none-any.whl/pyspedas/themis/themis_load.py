...
def themis_load(dates, probes, instruments, level, downloadonly=False, varformat=None, get_support_data=False, prefix='', suffix=''):
    ...
    for remotef, localf in file_list:   
        ...
        if resp:
            ...
            if not downloadonly:
                try: 
                    cdfvars = pyspedas.cdf_to_tplot(locafile, varformat, get_support_data, prefix, suffix, False, True)                
