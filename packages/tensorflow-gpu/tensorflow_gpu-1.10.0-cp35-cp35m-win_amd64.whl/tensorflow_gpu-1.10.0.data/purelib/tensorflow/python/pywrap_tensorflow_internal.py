...
def TFE_ContextOptionsSetServerDef(options, proto):
    return _pywrap_tensorflow_internal.TFE_ContextOptionsSetServerDef(options, proto)
TFE_ContextOptionsSetServerDef = _pywrap_tensorflow_internal.TFE_ContextOptionsSetServerDef
