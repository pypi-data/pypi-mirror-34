...
from ..lstm_latent_vector_as_input import LSTM_LatentVectorAsInput


class LSTMLatentVectorAsInputTestCase(tf.test.TestCase):
    ...
    def test_input_with_tensor(self):
        with self.test_session() as sess:
            logits, word_indices = LSTM_LatentVectorAsInput(
