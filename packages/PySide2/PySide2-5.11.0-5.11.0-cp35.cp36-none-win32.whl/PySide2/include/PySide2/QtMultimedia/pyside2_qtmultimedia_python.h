...
#define SBK_QTMULTIMEDIA_QLIST_QREAL_IDX                             9 // QList<qreal >
#define SBK_QTMULTIMEDIA_QLIST_QCAMERAVIEWFINDERSETTINGS_IDX         10 // QList<QCameraViewfinderSettings >
#define SBK_QTMULTIMEDIA_QLIST_QVARIANT_IDX                          11 // QList<QVariant >
#define SBK_QTMULTIMEDIA_QLIST_QAUDIO_ROLE_IDX                       12 // QList<QAudio::Role >
#define SBK_QTMULTIMEDIA_QLIST_QSTRING_IDX                           13 // QList<QString >
#define SBK_QTMULTIMEDIA_QLIST_QNETWORKCONFIGURATION_IDX             14 // const QList<QNetworkConfiguration > &
