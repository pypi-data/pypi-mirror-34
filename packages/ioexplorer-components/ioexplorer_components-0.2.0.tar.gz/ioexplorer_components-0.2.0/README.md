...
Components for the IOExplorer Web App
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> ioexplorer-components -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import ioexplorer-components to your layout, then run it:
