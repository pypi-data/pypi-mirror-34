...
class Timer(object):
    ...
    def __init__(self,  key=None, verbose=False, store=True):
    ...
    @classmethod
    def printStats(cls, key=None, keys=None, header=True, sort_key=[7]):
    ...
    def wrapped_f(f):
        ...
        def wrapped(*args, **kwargs):
            ...
            if key:
                ...
                with Timer(key=func_name, verbose=verbose) as t:
                    out = f(*args, **kwargs)
            return out
        return wrapped
