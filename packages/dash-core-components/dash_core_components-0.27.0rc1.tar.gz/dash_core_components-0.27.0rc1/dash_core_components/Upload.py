...
Available events: """
    @_explicitize_args
    def __init__(self, children=None, id=None, contents=None, filename=None, last_modified=None, accept=None, disabled=False, disable_click=False, max_size=-1, min_size=0, multiple=False, className=None, className_active=None, className_reject=None, className_disabled=None, style={}, style_active={'borderColor': '#6c6', 'borderStyle': 'solid', 'backgroundColor': '#eee'}, style_reject={'borderColor': '#c66', 'borderStyle': 'solid', 'backgroundColor': '#eee'}, style_disabled={'opacity': 0.5}, **kwargs):
