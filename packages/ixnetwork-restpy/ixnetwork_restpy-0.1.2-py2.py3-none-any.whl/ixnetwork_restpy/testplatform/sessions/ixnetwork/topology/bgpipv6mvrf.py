...
class BgpIpv6MVrf(Base):
	...
	def remove(self):
		"""Deletes a child instance of BgpIpv6MVrf on the server.
	...
	def RestartDown(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpIpv6MVrf object references
