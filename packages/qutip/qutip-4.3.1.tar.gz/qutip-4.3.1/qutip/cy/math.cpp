...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "/Users/shahnawaz/miniconda3/lib/python3.6/site-packages/numpy/core/include"
        ],
        "language": "c++",
        "name": "qutip.cy.math",
        "sources": [
...
static int __pyx_pymod_exec_math(PyObject *__pyx_pyinit_module)
#endif
#endif
{
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init qutip.cy.math", 0, __pyx_lineno, __pyx_filename);
    }
