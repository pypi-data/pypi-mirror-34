...
@pytest.mark.parametrize(u'gate,rep', (
    (CliffordGate.I,       u'CliffordGate(X:+X, Y:+Y, Z:+Z)'),
    (CliffordGate.H,       u'CliffordGate(X:+Z, Y:-Y, Z:+X)'),
    (CliffordGate.X,       u'CliffordGate(X:+X, Y:-Y, Z:-Z)'),
    (CliffordGate.X_sqrt,  u'CliffordGate(X:+X, Y:+Z, Z:-Y)')))
...
@pytest.mark.parametrize(u'gate,sym,exp', (
    (CliffordGate.I,       u'I', 1),
    (CliffordGate.H,       u'H', 1),
    (CliffordGate.X,       u'X', 1),
    (CliffordGate.X_sqrt,  u'X', 0.5),
    (CliffordGate.X_nsqrt, u'X', -0.5),
    (
