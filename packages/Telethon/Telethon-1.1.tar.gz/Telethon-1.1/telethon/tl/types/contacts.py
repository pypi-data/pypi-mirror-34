...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeImportedContact, TypePopularContact, TypeChat, TypeUser, TypeContactBlocked, TypeContact, TypePeer, TypeTopPeerCategoryPeers, TypeContactLink
