...
#define SBK_QTHELP_QVECTOR_INT_IDX                                   5 // const QVector<int > &
#define SBK_QTHELP_QHASH_INT_QBYTEARRAY_IDX                          6 // const QHash<int,QByteArray > &
#define SBK_QTHELP_QMAP_INT_QVARIANT_IDX                             7 // QMap<int,QVariant >
#define SBK_QTHELP_QLIST_QPERSISTENTMODELINDEX_IDX                   8 // const QList<QPersistentModelIndex > &
#define SBK_QTHELP_QLIST_QACTIONPTR_IDX                              9 // QList<QAction* >
#define SBK_QTHELP_QLIST_QHELPSEARCHQUERY_IDX                        10 // QList<QHelpSearchQuery >
#define SBK_QTHELP_QLIST_QWIDGETPTR_IDX                              11 // QList<QWidget* >
#define SBK_QTHELP_QPAIR_QSTRING_QSTRING_IDX                         12 // QPair<QString,QString >
#define SBK_QTHELP_QLIST_QPAIR_QSTRING_QSTRING_IDX                   13 // QList<QPair< QString,QString > >
#define SBK_QTHELP_QVECTOR_QHELPSEARCHRESULT_IDX                     14 // QVector<QHelpSearchResult >
