...
#define SBK_QTMULTIMEDIA_QLIST_QSIZE_IDX                             8 // QList<QSize >
#define SBK_QTMULTIMEDIA_QLIST_QMEDIACONTENT_IDX                     9 // const QList<QMediaContent > &
#define SBK_QTMULTIMEDIA_QLIST_QVARIANT_IDX                          10 // QList<QVariant >
#define SBK_QTMULTIMEDIA_QLIST_QAUDIO_ROLE_IDX                       11 // QList<QAudio::Role >
#define SBK_QTMULTIMEDIA_QLIST_QSTRING_IDX                           12 // QList<QString >
#define SBK_QTMULTIMEDIA_QLIST_QNETWORKCONFIGURATION_IDX             13 // const QList<QNetworkConfiguration > &
#define SBK_QTMULTIMEDIA_QLIST_QCAMERAVIEWFINDERSETTINGS_IDX         14 // QList<QCameraViewfinderSettings >
#define SBK_QTMULTIMEDIA_QLIST_QREAL_IDX                             15 // QList<qreal >
#define SBK_QTMULTIMEDIA_QPAIR_INT_INT_IDX                           16 // QPair<int,int >
#define SBK_QTMULTIMEDIA_QLIST_QCAMERA_FRAMERATERANGE_IDX            17 // QList<QCamera::FrameRateRange >
