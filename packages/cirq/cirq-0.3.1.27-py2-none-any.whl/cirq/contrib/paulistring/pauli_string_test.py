...
@pytest.mark.parametrize(u'pauli', Pauli.XYZ)
...
def test_repr():
    ...
    assert (repr(pauli_string) ==
            u"PauliString({NamedQubit('q0'): Pauli.Z, "
            u"NamedQubit('q1'): Pauli.Y, NamedQubit('q2'): Pauli.X}, False)")
    assert (repr(pauli_string.negate()) ==
            u"PauliString({NamedQubit('q0'): Pauli.Z, "
            u"NamedQubit('q1'): Pauli.Y, NamedQubit('q2'): Pauli.X}, True)")
