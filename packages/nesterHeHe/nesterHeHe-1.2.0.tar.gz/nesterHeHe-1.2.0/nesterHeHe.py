...
def print_lol(the_list,level=0):
   ...
   used to insert a tab when a nested list is encountered.If you didn't give a
   value to "level",the function will assign "level" to 0.If you give a appropriate
   negative to "level",the indentation function can be shut down.Each item of the
