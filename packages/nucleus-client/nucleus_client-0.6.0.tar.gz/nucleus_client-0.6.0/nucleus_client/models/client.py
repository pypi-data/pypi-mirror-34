...
class Client(object):
    ...
    def __init__(self, id=None, name=None, code=None, amity_key=None, status=None, integrations=None, schedule=None, client_ids=None, nav_page_ids=None, dt_u=None):  # noqa: E501
