...
class BgpSRTEPoliciesListV4(Base):
	...
	def BgpSRTEPoliciesTunnelEncapsulationListV4(self):
		"""Returns the one and only one BgpSRTEPoliciesTunnelEncapsulationListV4 object from the server.
		...
		return self._read(BgpSRTEPoliciesTunnelEncapsulationListV4(self), None)
