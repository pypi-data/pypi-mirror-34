...
id = "b657ecbb054cac731001f4034c3d6db4b0d81e66"
date = "2018-07-19 18:46:25 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "b657ecbb054cac731001f4034c3d6db4b0d81e66":
        return
    msg = "Program id (b657ecbb054cac731001f4034c3d6db4b0d81e66) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
