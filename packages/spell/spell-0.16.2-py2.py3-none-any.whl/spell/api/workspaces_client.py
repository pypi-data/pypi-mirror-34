...
class WorkspacesClient(base_client.BaseClient):
    def __init__(self, owner, resource_url=WORKSPACES_RESOURCE_URL, **kwargs):
        self.owner = owner
    ...
    def new_workspace(self, root_commit, name, description):
        ...
        r = self.request("put", url_path_join(self.resource_url, self.owner), payload=payload)
    ...
    def get_workspaces(self):
        ...
        """
        r = self.request("get", url_path_join(self.resource_url, self.owner))
        self.check_and_raise(r)
    ...
    def get_workspace(self, ws_id):
        ...
        a Workspace object
        """
        r = self.request("get", url_path_join(self.resource_url, self.owner, str(ws_id)))
        self.check_and_raise(r)
        return self.get_json(r)["workspace"]
    ...
    def delete_workspace(self, ws_id):
        ...
        ws_id -- the id of the workspace
        """
        r = self.request("delete", url_path_join(self.resource_url, self.owner, str(ws_id)))
        self.check_and_raise(r)
