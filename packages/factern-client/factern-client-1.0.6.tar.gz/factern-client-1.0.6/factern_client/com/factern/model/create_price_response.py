...
class CreatePriceResponse(get_parent()):
    ...
    def compute_parent_updates():
        ...
        CreatePriceResponse.swagger_types.update(get_parent().swagger_types)
        CreatePriceResponse.attribute_map.update(get_parent().attribute_map)
    ...
    def __init__(self, **kwargs):  # noqa: E501
        ...
        for k in kwargs:
            if k not in self.swagger_types:
                raise ValueError("CreatePriceResponse got unexpected argument '%s'" % k)
