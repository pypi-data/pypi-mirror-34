# -*- coding: utf-8 -*-
#
# PyPexels documentation build configuration file, created by
# sphinx-quickstart on Wed Sep 27 16:16:16 2017.
#
...
#
# html_title = u'PyPexels v1.0.0b1'

# A shorter title for the _navigation bar.  Default is the same as html_title.
#
...
latex_documents = [
    (master_doc, 'pypexels.tex', u'PyPexels Documentation',
...
texinfo_documents = [
    (master_doc, 'PyPexels', u'PyPexels Documentation',
     author, 'pypexels', 'A Python wrapper for the Pexels.com REST API',
     'Miscellaneous'),
]
