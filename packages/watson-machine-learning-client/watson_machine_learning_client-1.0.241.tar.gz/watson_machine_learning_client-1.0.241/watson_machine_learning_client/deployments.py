...
class Deployments(WMLResource):
    """
        Deploy and score published assets (models).
    """
    ...
    def update(self, deployment_uid, name=None, description=None, asynchronous=False, meta_props=None):
        ...
        model_uid = self._get_required_element_from_dict(deployment_details, 'deployment_details', ['entity', 'deployable_asset', 'guid'])
    ...
    def create(self, asset_uid=None, name=u'Model deployment', description=u'Description of deployment', asynchronous=False, deployment_type=u'online', deployment_format='Core ML', meta_props=None, **kwargs):
        """
            Create deployment (online) from asset. As asset we understand model which may be deployed.

            :param model_uid:  Published asset UID (model)
    ...
    def list(self, limit=None):
        ...
        self._list(values, [u'GUID', u'NAME', u'TYPE', u'STATE', u'CREATED', u'FRAMEWORK'], limit, 50)
