...
class BgpL3VpnRouteProperty(Base):
	...
	def remove(self):
		"""Deletes a child instance of BgpL3VpnRouteProperty on the server.
	...
	def AgeOutRoutes(self, Arg1, Percentage):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpL3VpnRouteProperty object references
