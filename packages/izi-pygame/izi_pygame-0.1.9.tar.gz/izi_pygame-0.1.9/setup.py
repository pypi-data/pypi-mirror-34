...
setuptools.setup(
    ...
    + " In the 0.1.9 version -> add Fontstring object (work with Printstring)! Call izi_pygame.doc() the github of the project will open. dowload project and open /doc/index.html with your browser."
