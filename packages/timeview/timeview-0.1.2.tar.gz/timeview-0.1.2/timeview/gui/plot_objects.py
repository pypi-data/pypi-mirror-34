...
class InfiniteLinePlot(pg.PlotItem):
    ...
    updatePartitionValuePosition = Signal(
        int, float, name="updatePartitionValuePosition"
    )
    updatePartitionValue = Signal(int, name="updatePartitionValue")
    updatePartitionBoundaries = Signal(
        int, float, float, name="updatePartitionBoundaries"
    )
