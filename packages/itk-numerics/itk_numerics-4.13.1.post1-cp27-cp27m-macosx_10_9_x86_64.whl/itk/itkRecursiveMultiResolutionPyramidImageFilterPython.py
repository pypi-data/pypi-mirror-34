...
def itkRecursiveMultiResolutionPyramidImageFilterIF2IF2_cast(obj):
...
def itkRecursiveMultiResolutionPyramidImageFilterIF3IF3_cast(obj):
...
def itkRecursiveMultiResolutionPyramidImageFilterISS2ISS2___New_orig__():
...
def itkRecursiveMultiResolutionPyramidImageFilterISS2ISS2_cast(obj):
...
def itkRecursiveMultiResolutionPyramidImageFilterISS3ISS3___New_orig__():
...
def itkRecursiveMultiResolutionPyramidImageFilterISS3ISS3_cast(obj):
...
def itkRecursiveMultiResolutionPyramidImageFilterIUC2IUC2_cast(obj):
...
def itkRecursiveMultiResolutionPyramidImageFilterIUC3IUC3_cast(obj):
...
class itkRecursiveMultiResolutionPyramidImageFilterIUS2IUS2(itkMultiResolutionPyramidImageFilterPython.itkMultiResolutionPyramidImageFilterIUS2IUS2):
    ...
    def GetPointer(self):
        """GetPointer(itkRecursiveMultiResolutionPyramidImageFilterIUS2IUS2 self) -> itkRecursiveMultiResolutionPyramidImageFilterIUS2IUS2"""
...
def itkRecursiveMultiResolutionPyramidImageFilterIUS2IUS2_cast(obj):
...
class itkRecursiveMultiResolutionPyramidImageFilterIUS3IUS3(itkMultiResolutionPyramidImageFilterPython.itkMultiResolutionPyramidImageFilterIUS3IUS3):
    ...
    def GetPointer(self):
        """GetPointer(itkRecursiveMultiResolutionPyramidImageFilterIUS3IUS3 self) -> itkRecursiveMultiResolutionPyramidImageFilterIUS3IUS3"""
...
def itkRecursiveMultiResolutionPyramidImageFilterIUS3IUS3_cast(obj):
