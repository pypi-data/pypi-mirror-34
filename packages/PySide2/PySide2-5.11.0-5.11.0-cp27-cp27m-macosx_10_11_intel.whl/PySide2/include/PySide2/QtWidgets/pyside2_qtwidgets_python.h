...
#define SBK_QTWIDGETS_QLIST_QABSTRACTANIMATIONPTR_IDX                15 // QList<QAbstractAnimation* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTSTATEPTR_IDX                    16 // const QList<QAbstractState* > &
#define SBK_QTWIDGETS_QLIST_QACTIONPTR_IDX                           17 // QList<QAction* >
#define SBK_QTWIDGETS_QLIST_QDOCKWIDGETPTR_IDX                       18 // const QList<QDockWidget* > &
#define SBK_QTWIDGETS_QLIST_INT_IDX                                  19 // const QList<int > &
#define SBK_QTWIDGETS_QLIST_QWIDGETPTR_IDX                           20 // QList<QWidget* >
#define SBK_QTWIDGETS_QLIST_QMDISUBWINDOWPTR_IDX                     21 // QList<QMdiSubWindow* >
#define SBK_QTWIDGETS_QVECTOR_INT_IDX                                22 // const QVector<int > &
#define SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX                   23 // QList<QListWidgetItem* >
#define SBK_QTWIDGETS_QMAP_QDATE_QTEXTCHARFORMAT_IDX                 24 // QMap<QDate,QTextCharFormat >
#define SBK_QTWIDGETS_QLIST_QABSTRACTBUTTONPTR_IDX                   25 // QList<QAbstractButton* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETITEMPTR_IDX                  26 // QList<QTableWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX           27 // QList<QTableWidgetSelectionRange >
#define SBK_QTWIDGETS_QLIST_QWIZARD_WIZARDBUTTON_IDX                 28 // const QList<QWizard::WizardButton > &
#define SBK_QTWIDGETS_QHASH_INT_QBYTEARRAY_IDX                       29 // const QHash<int,QByteArray > &
#define SBK_QTWIDGETS_QMAP_INT_QVARIANT_IDX                          30 // QMap<int,QVariant >
#define SBK_QTWIDGETS_QLIST_QPERSISTENTMODELINDEX_IDX                31 // const QList<QPersistentModelIndex > &
#define SBK_QTWIDGETS_QLIST_QSCROLLERPTR_IDX                         32 // QList<QScroller* >
#define SBK_QTWIDGETS_QLIST_QREAL_IDX                                33 // const QList<qreal > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSWIDGETPTR_IDX                   34 // QList<QGraphicsWidget* >
#define SBK_QTWIDGETS_QLIST_QKEYSEQUENCE_IDX                         35 // const QList<QKeySequence > &
#define SBK_QTWIDGETS_QLIST_QRECTF_IDX                               36 // const QList<QRectF > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                     37 // QList<QGraphicsView* >
#define SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                        38 // QPair<qreal,QPointF >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX                  39 // QList<QPair< qreal,QPointF > >
#define SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                          40 // QPair<qreal,qreal >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                    41 // QList<QPair< qreal,qreal > >
#define SBK_QTWIDGETS_QLIST_QWINDOWPTR_IDX                           42 // QList<QWindow* >
#define SBK_QTWIDGETS_QLIST_QSCREENPTR_IDX                           43 // QList<QScreen* >
#define SBK_QTWIDGETS_QLIST_QUNDOSTACKPTR_IDX                        44 // QList<QUndoStack* >
