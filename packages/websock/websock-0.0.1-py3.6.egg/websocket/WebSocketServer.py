...
class WebSocketServer():
    ...
    def _manage_client(self, client):
        ...
        while True:
            ...
            frame_type, data = self._decode_data_frame(data)
    ...
    def send_ping(self, client):
        ...
        :param client: The Client to send the ping to.
        """
        data = WebSocketServer._encode_data_frame(FrameType.PING, '')
        client.send(data)

    def _send_pong(self, client, data):
        """Send a pong to the client.

        :param client: The client to send the pong to.
        """
        pass
