...
class itkDemonsImageToImageMetricv4IF2IF2(itkImageToImageMetricv4Python.itkImageToImageMetricv4F2F2):
    ...
    def GetPointer(self) -> "itkDemonsImageToImageMetricv4IF2IF2 *":
        """GetPointer(itkDemonsImageToImageMetricv4IF2IF2 self) -> itkDemonsImageToImageMetricv4IF2IF2"""
        return _itkDemonsImageToImageMetricv4Python.itkDemonsImageToImageMetricv4IF2IF2_GetPointer(self)
...
itkDemonsImageToImageMetricv4IF2IF2.GetPointer = new_instancemethod(_itkDemonsImageToImageMetricv4Python.itkDemonsImageToImageMetricv4IF2IF2_GetPointer, None, itkDemonsImageToImageMetricv4IF2IF2)
...
class itkDemonsImageToImageMetricv4IF3IF3(itkImageToImageMetricv4Python.itkImageToImageMetricv4F3F3):
    ...
    def GetPointer(self) -> "itkDemonsImageToImageMetricv4IF3IF3 *":
        """GetPointer(itkDemonsImageToImageMetricv4IF3IF3 self) -> itkDemonsImageToImageMetricv4IF3IF3"""
        return _itkDemonsImageToImageMetricv4Python.itkDemonsImageToImageMetricv4IF3IF3_GetPointer(self)
...
itkDemonsImageToImageMetricv4IF3IF3.GetPointer = new_instancemethod(_itkDemonsImageToImageMetricv4Python.itkDemonsImageToImageMetricv4IF3IF3_GetPointer, None, itkDemonsImageToImageMetricv4IF3IF3)
