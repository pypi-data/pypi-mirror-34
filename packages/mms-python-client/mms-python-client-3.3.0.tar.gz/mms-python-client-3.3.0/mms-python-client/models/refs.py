...
from mms-python-client.models.ref import Ref  # noqa: F401,E501
...
class Refs(object):
    ...
    def __init__(self, refs=None):  # noqa: E501
        """Refs - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def refs(self):
        """Gets the refs of this Refs.  # noqa: E501
    ...
    @refs.setter
    def refs(self, refs):
        """Sets the refs of this Refs.


        :param refs: The refs of this Refs.  # noqa: E501
        :type: list[Ref]
        """
        if refs is None:
