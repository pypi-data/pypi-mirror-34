...
# Andere Browser:
from ...browser.unitraccgroups.utils import split_group_id
...
class Browser(BrowserView):
    ...
    def getByType(self, getCustomSearch):
        ...
        context.getBrowser('authorized').raiseAnon()

        pc = context.getAdapter('pc')()
        member = context.getAdapter('auth')()
        if isinstance(getCustomSearch, basestring):
    ...
    def getOneList(self, **kwargs):
        ...
        if kwargs:
            raise TypeError('Falsche Argumente: %s' % (kwargs,))
