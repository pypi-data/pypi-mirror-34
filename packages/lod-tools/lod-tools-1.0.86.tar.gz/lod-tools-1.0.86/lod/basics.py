...
class FileObject(object):
    ...
    def __init__(self, identifier, file_name, creation_step, creation_index, creation_trigger=None, creator_id=None):
        ...
        self.creation_trigger = creation_trigger # set by the server; values provided by the user are ignored
...
class FeedbackRequest():
    ...
    """
    def __init__(self, id, feedback_type, trigger, target_identifier, event_identifier, execution_environment_id):
        self.id = id
...
def parse_feedback_request(dictionary):
    ...
    res = FeedbackRequest(id, feedback_type, trigger, target_identifier, event_identifier, execution_environment_id)
    return res
