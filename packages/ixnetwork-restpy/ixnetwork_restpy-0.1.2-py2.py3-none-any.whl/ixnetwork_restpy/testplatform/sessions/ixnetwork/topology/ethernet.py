...
class Ethernet(Base):
	...
	def DotOneX(self, DescriptiveName=None, Name=None):
		"""Gets child instances of DotOneX from the server.

		Use the named parameters as selection criteria to find specific instances.
		All named parameters support regex.
		If no named parameters are specified then all instances of DotOneX will be returned.
		...
		Returns:
			list(obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.dotonex.DotOneX))

		Raises:
			ServerError: The server has encountered an uncategorized error condition
		"""
		from ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.dotonex import DotOneX
		return self._select(DotOneX(self), locals())

	def add_DotOneX(self, ConnectedVia=None, Multiplier="1", Name=None, ParentEth=None, StackedLayers=None):
		"""Adds a child instance of DotOneX on the server.
		...
		"""
		from ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.dotonex import DotOneX
		return self._create(DotOneX(self), locals())
	...
	def PbbEVpnParameter(self):
		...
		Returns:
			list(obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.pbbevpnparameter.PbbEVpnParameter))
	...
	def VpnParameter(self):
		...
		Returns:
			list(obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.vpnparameter.VpnParameter))
