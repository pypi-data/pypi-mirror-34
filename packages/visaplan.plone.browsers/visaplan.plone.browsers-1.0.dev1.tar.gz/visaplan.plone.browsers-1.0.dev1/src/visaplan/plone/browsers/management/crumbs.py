...
from ...adapters.breadcrumbs.base import (BaseCrumb, RootedCrumb,
        RootedBrowserCrumb, RootedRequestvarCrumb, ContextCrumb,
        register, registered,
        )
...
def register_crumbs():
    ...
    for tid, label in [
            ...
            ('review_submitted_content',
             _('Manage submitted content'),
             ),
            ('review_accepted_content',
            ...
            ('versioninformation_view',
             _('Version information'),
             ),
            ('unitraccfeature_view',
    ...
    for tid, label in [
            ...
            ('management_7dbcefcded46f02aa83458d8b13580be_publish',
             _('Handlungsanweisung freigeben'),
             ),
