...
class Login(get_parent()):
    ...
    def compute_parent_updates():
        ...
        Login.swagger_types.update(get_parent().swagger_types)
        Login.attribute_map.update(get_parent().attribute_map)
    ...
    def __init__(self, **kwargs):  # noqa: E501
        ...
        for k in kwargs:
            if k not in self.swagger_types:
                raise ValueError("Login got unexpected argument '%s'" % k)
