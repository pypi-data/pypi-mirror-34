...
class itkWienerDeconvolutionImageFilterIUS2IUS2(itkInverseDeconvolutionImageFilterPython.itkInverseDeconvolutionImageFilterIUS2IUS2):
    ...
    def GetPointer(self) -> "itkWienerDeconvolutionImageFilterIUS2IUS2 *":
        """GetPointer(itkWienerDeconvolutionImageFilterIUS2IUS2 self) -> itkWienerDeconvolutionImageFilterIUS2IUS2"""
        return _itkWienerDeconvolutionImageFilterPython.itkWienerDeconvolutionImageFilterIUS2IUS2_GetPointer(self)
...
itkWienerDeconvolutionImageFilterIUS2IUS2.GetPointer = new_instancemethod(_itkWienerDeconvolutionImageFilterPython.itkWienerDeconvolutionImageFilterIUS2IUS2_GetPointer, None, itkWienerDeconvolutionImageFilterIUS2IUS2)
...
class itkWienerDeconvolutionImageFilterIUS3IUS3(itkInverseDeconvolutionImageFilterPython.itkInverseDeconvolutionImageFilterIUS3IUS3):
    ...
    def GetPointer(self) -> "itkWienerDeconvolutionImageFilterIUS3IUS3 *":
        """GetPointer(itkWienerDeconvolutionImageFilterIUS3IUS3 self) -> itkWienerDeconvolutionImageFilterIUS3IUS3"""
        return _itkWienerDeconvolutionImageFilterPython.itkWienerDeconvolutionImageFilterIUS3IUS3_GetPointer(self)
...
itkWienerDeconvolutionImageFilterIUS3IUS3.GetPointer = new_instancemethod(_itkWienerDeconvolutionImageFilterPython.itkWienerDeconvolutionImageFilterIUS3IUS3_GetPointer, None, itkWienerDeconvolutionImageFilterIUS3IUS3)
