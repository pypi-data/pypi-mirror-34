...
def estimator_logger(real_estimator):

    def wrapper(*args, **kwargs):
        ret_val = real_estimator(*args, **kwargs)
        try:
            ...
            if (
                ...
                config.experiment.log_multiple_params(params)
...
def patch(module_finder):
    ...
    for module, object_name in OPTIMIZER:
        module_finder.register(module, object_name, estimator_logger)
