...
from ..stacked_cnn_with_self_attention import StackedCNNWithSelfAttention


class StackedCNNWithSelfAttentionTestCase(Data, tf.test.TestCase):
    ...
    def test_input_with_tensor(self):
        with self.test_session() as sess:
            latent = StackedCNNWithSelfAttention(
