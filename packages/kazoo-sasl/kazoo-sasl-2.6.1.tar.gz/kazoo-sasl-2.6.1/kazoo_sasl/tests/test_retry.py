...
class TestRetrySleeper(unittest.TestCase):
    ...
    def test_too_many_tries(self):
        from kazoo_sasl.retry import RetryFailedError
...
class TestKazooRetry(unittest.TestCase):
    ...
    def test_connection_closed(self):
        from kazoo_sasl.exceptions import ConnectionClosedError
        retry = self._makeOne()
    ...
    def test_session_expired(self):
        from kazoo_sasl.exceptions import SessionExpiredError
