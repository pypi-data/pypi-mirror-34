...
#define SBK_QTLOCATION_QLIST_QGEOLOCATION_IDX                        10 // QList<QGeoLocation >
#define SBK_QTLOCATION_QMAP_INT_QPLACECONTENT_IDX                    11 // QMap<int,QPlaceContent >
#define SBK_QTLOCATION_QLIST_QGEOROUTE_IDX                           12 // const QList<QGeoRoute > &
