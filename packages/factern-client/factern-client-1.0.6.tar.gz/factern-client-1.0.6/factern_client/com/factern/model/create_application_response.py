...
class CreateApplicationResponse(get_parent()):
    ...
    def compute_parent_updates():
        ...
        CreateApplicationResponse.swagger_types.update(get_parent().swagger_types)
        CreateApplicationResponse.attribute_map.update(get_parent().attribute_map)
    ...
    def __init__(self, **kwargs):  # noqa: E501
        ...
        for k in kwargs:
            if k not in self.swagger_types:
                raise ValueError("CreateApplicationResponse got unexpected argument '%s'" % k)
