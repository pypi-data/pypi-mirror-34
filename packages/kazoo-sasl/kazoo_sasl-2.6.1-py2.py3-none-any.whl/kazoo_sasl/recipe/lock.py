...
class Lock(object):
    ...
    Example usage with a :class:`~kazoo_sasl.client.KazooClient` instance:
    ...
    def acquire(self, blocking=True, timeout=None, ephemeral=True):
        ...
        :raises: :exc:`~kazoo_sasl.exceptions.LockTimeout` if the lock
...
class Semaphore(object):
    ...
    def acquire(self, blocking=True, timeout=None):
        ...
        :raises:
            ...
            :exc:`~kazoo_sasl.exceptions.LockTimeout` if the semaphore
            wasn't acquired within `timeout` seconds.
