...
#define SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION__IDX               88
...
#define SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                          36 // const QHash<int,QByteArray > &
#define SBK_QTCORE_QMAP_INT_QVARIANT_IDX                             37 // QMap<int,QVariant >
#define SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX                   38 // const QList<QPersistentModelIndex > &
