...
def phasecorr_worker(data, refImg, ops):   
    ...
    return Y, ymax, xmax, tstart

def phasecorr(data, refImg, ops, pool):    
    nimg = data.shape[0]
