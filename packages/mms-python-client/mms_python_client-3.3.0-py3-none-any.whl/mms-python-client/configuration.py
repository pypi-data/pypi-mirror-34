...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self):
        """Constructor"""
        # Default Base url
        self.host = "https://localhost/alfresco/service"
        ...
        # Logging Settings
        self.logger = {}
        self.logger["package_logger"] = logging.getLogger("mms-python-client")
            ...
            'Ticket':
                {
                    ...
                    'in': 'query',
                    'key': 'alf_ticket',
                    'value': self.get_api_key_with_prefix('alf_ticket')
                },
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "SDK Package Version: 3.3.1-SNAPSHOT".\
