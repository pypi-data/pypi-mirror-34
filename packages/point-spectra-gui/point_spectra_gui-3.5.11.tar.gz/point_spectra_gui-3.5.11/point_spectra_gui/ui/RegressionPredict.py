...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.chooseDataListWidget = QtWidgets.QListWidget(self.formGroupBox)
        self.chooseDataListWidget.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.chooseDataListWidget.setObjectName("chooseDataListWidget")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.chooseDataListWidget)
