...
class TestAIFunction(unittest.TestCase):
    ...
    def test_02_create_ai_function(self):
        ...
        meta = {
            ...
            self.client.runtime_specs.ConfigurationMetaNames.DESCRIPTION: "runtime spec created for custom libraries",
        ...
        TestAIFunction.runtime_uid = self.client.runtime_specs.get_uid(runtime_details)
    ...
    def test_06_create_deployment(self):
        ...
        deployment = self.client.deployments.create(asset_uid=self.function_uid, name='temporary deployment name', asynchronous=False)
    ...
    def test_12_delete_runtime(self):
        self.client.runtime_specs.delete(TestAIFunction.runtime_uid)
