...
from thinkutils.tornadis.state import ConnectionState
from tornado.ioloop import IOLoop
import thinkutils.tornadis
import errno
import logging
...
class Connection(object):
    ...
    def __init__(self, read_callback, close_callback,
                 host='127.0.0.1',
                 port=6379, unix_domain_socket=None,
                 read_page_size=65536,
                 write_page_size=65536,
                 connect_timeout=20,
