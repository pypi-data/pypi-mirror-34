...
#define LOG_Z3_compute_interpolant(_ARG0, _ARG1, _ARG2, _ARG3, _ARG4) z3_log_ctx _LOG_CTX; Z3_ast_vector* _Z3_UNUSED Z3ARG3 = 0; Z3_model* _Z3_UNUSED Z3ARG4 = 0; if (_LOG_CTX.enabled()) { log_Z3_compute_interpolant(_ARG0, _ARG1, _ARG2, _ARG3, _ARG4); Z3ARG3 = _ARG3; Z3ARG4 = _ARG4; }
