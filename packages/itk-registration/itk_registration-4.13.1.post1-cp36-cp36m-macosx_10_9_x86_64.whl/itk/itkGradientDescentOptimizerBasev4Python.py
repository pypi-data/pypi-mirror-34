...
class itkGradientDescentOptimizerBasev4TemplateD(itkObjectToObjectOptimizerBasePython.itkObjectToObjectOptimizerBaseTemplateD):
    ...
    def GetPointer(self) -> "itkGradientDescentOptimizerBasev4TemplateD *":
        """GetPointer(itkGradientDescentOptimizerBasev4TemplateD self) -> itkGradientDescentOptimizerBasev4TemplateD"""
        return _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateD_GetPointer(self)
...
itkGradientDescentOptimizerBasev4TemplateD.GetPointer = new_instancemethod(_itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateD_GetPointer, None, itkGradientDescentOptimizerBasev4TemplateD)
...
class itkGradientDescentOptimizerBasev4TemplateF(itkObjectToObjectOptimizerBasePython.itkObjectToObjectOptimizerBaseTemplateF):
    ...
    def GetPointer(self) -> "itkGradientDescentOptimizerBasev4TemplateF *":
        """GetPointer(itkGradientDescentOptimizerBasev4TemplateF self) -> itkGradientDescentOptimizerBasev4TemplateF"""
        return _itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateF_GetPointer(self)
...
itkGradientDescentOptimizerBasev4TemplateF.GetPointer = new_instancemethod(_itkGradientDescentOptimizerBasev4Python.itkGradientDescentOptimizerBasev4TemplateF_GetPointer, None, itkGradientDescentOptimizerBasev4TemplateF)
