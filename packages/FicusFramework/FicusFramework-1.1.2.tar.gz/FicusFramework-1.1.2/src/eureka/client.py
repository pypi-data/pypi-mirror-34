...
class EurekaClient:
    ...
    def __init__(self,
        ...
        self.homepage_url = homepage_url or 'http://%s:%s/' % (self.host_name, self.port)
        self.health_check_url = health_check_url or 'http://%s:%s/actuator/health' % (self.host_name, self.port)
        self.status_page_url = status_page_url or 'http://%s:%s/actuator/info' % (self.host_name, self.port)
