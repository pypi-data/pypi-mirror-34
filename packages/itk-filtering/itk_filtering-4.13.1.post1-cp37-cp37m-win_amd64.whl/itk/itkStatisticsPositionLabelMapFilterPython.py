...
class itkStatisticsPositionLabelMapFilterLM2(itkShapePositionLabelMapFilterPython.itkShapePositionLabelMapFilterLM2):
    ...
    def GetPointer(self) -> "itkStatisticsPositionLabelMapFilterLM2 *":
        """GetPointer(itkStatisticsPositionLabelMapFilterLM2 self) -> itkStatisticsPositionLabelMapFilterLM2"""
        return _itkStatisticsPositionLabelMapFilterPython.itkStatisticsPositionLabelMapFilterLM2_GetPointer(self)
...
itkStatisticsPositionLabelMapFilterLM2.GetPointer = new_instancemethod(_itkStatisticsPositionLabelMapFilterPython.itkStatisticsPositionLabelMapFilterLM2_GetPointer, None, itkStatisticsPositionLabelMapFilterLM2)
...
class itkStatisticsPositionLabelMapFilterLM3(itkShapePositionLabelMapFilterPython.itkShapePositionLabelMapFilterLM3):
    ...
    def GetPointer(self) -> "itkStatisticsPositionLabelMapFilterLM3 *":
        """GetPointer(itkStatisticsPositionLabelMapFilterLM3 self) -> itkStatisticsPositionLabelMapFilterLM3"""
        return _itkStatisticsPositionLabelMapFilterPython.itkStatisticsPositionLabelMapFilterLM3_GetPointer(self)
...
itkStatisticsPositionLabelMapFilterLM3.GetPointer = new_instancemethod(_itkStatisticsPositionLabelMapFilterPython.itkStatisticsPositionLabelMapFilterLM3_GetPointer, None, itkStatisticsPositionLabelMapFilterLM3)
