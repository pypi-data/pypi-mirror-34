...
class itkOptimizerParameterScalesEstimatorTemplateD(ITKCommonBasePython.itkObject):
    ...
    def GetPointer(self) -> "itkOptimizerParameterScalesEstimatorTemplateD *":
        """GetPointer(itkOptimizerParameterScalesEstimatorTemplateD self) -> itkOptimizerParameterScalesEstimatorTemplateD"""
        return _itkOptimizerParameterScalesEstimatorPython.itkOptimizerParameterScalesEstimatorTemplateD_GetPointer(self)
...
itkOptimizerParameterScalesEstimatorTemplateD.GetPointer = new_instancemethod(_itkOptimizerParameterScalesEstimatorPython.itkOptimizerParameterScalesEstimatorTemplateD_GetPointer, None, itkOptimizerParameterScalesEstimatorTemplateD)
...
class itkOptimizerParameterScalesEstimatorTemplateF(ITKCommonBasePython.itkObject):
    ...
    def GetPointer(self) -> "itkOptimizerParameterScalesEstimatorTemplateF *":
        """GetPointer(itkOptimizerParameterScalesEstimatorTemplateF self) -> itkOptimizerParameterScalesEstimatorTemplateF"""
        return _itkOptimizerParameterScalesEstimatorPython.itkOptimizerParameterScalesEstimatorTemplateF_GetPointer(self)
...
itkOptimizerParameterScalesEstimatorTemplateF.GetPointer = new_instancemethod(_itkOptimizerParameterScalesEstimatorPython.itkOptimizerParameterScalesEstimatorTemplateF_GetPointer, None, itkOptimizerParameterScalesEstimatorTemplateF)
