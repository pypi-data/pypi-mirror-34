...
class Capture(Base):
	...
	def CurrentPacket(self):
		"""Returns the one and only one CurrentPacket object from the server.
		...
		return self._read(CurrentPacket(self), None)

	@property
	def Filter(self):
		"""Returns the one and only one Filter object from the server.
		...
		return self._read(Filter(self), None)

	@property
	def FilterPallette(self):
		"""Returns the one and only one FilterPallette object from the server.
		...
		return self._read(FilterPallette(self), None)

	@property
	def Trigger(self):
		"""Returns the one and only one Trigger object from the server.
		...
		return self._read(Trigger(self), None)
