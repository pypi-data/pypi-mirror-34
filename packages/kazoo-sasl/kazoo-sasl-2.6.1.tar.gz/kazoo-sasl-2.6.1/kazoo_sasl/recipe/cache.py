...
from kazoo_sasl.exceptions import NoNodeError, KazooException
from kazoo_sasl.protocol.states import KazooState, EventType
...
class TreeCache(object):
    ...
    :param client: A :class:`~kazoo_sasl.client.KazooClient` instance.
    ...
    def listen(self, listener):
        ...
        :param listener: A callable object which accepting a
                         :class:`~kazoo_sasl.recipe.cache.TreeEvent` instance as
                         its argument.
        """
    ...
    def get_data(self, path, default=None):
        ...
        :returns: A :class:`~kazoo_sasl.recipe.cache.NodeData` instance.
        """
...
class TreeNode(object):
    ...
    :param tree: A :class:`~kazoo_sasl.recipe.cache.TreeCache` instance.
...
class TreeEvent(tuple):
    ...
    #: A :class:`~kazoo_sasl.recipe.cache.NodeData` instance.
    ...
    def make(cls, event_type, event_data):
        ...
        :returns: A :class:`~kazoo_sasl.recipe.cache.TreeEvent` instance.
        """
