...
class CreateGroupResponse(get_parent()):
    ...
    def compute_parent_updates():
        ...
        CreateGroupResponse.swagger_types.update(get_parent().swagger_types)
        CreateGroupResponse.attribute_map.update(get_parent().attribute_map)
    ...
    def __init__(self, **kwargs):  # noqa: E501
        ...
        for k in kwargs:
            if k not in self.swagger_types:
                raise ValueError("CreateGroupResponse got unexpected argument '%s'" % k)
        ...
        if "name" not in kwargs:
            raise ValueError("CreateGroupResponse missing required argument: name")
