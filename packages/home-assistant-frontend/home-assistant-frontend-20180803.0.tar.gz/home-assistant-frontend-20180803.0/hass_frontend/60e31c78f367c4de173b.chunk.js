...
`,is:"paper-dialog-scrollable",properties:{dialogElement:{type:Object}},get scrollTarget(){return this.$.scrollable},ready:function(){this._ensureTarget(),this.classList.add("no-padding")},attached:function(){this._ensureTarget(),requestAnimationFrame(this.updateScrollState.bind(this))},updateScrollState:function(){this.toggleClass("is-scrolled",this.scrollTarget.scrollTop>0),this.toggleClass("can-scroll",this.scrollTarget.offsetHeight<this.scrollTarget.scrollHeight),this.toggleClass("scrolled-to-bottom",this.scrollTarget.scrollTop+this.scrollTarget.offsetHeight>=this.scrollTarget.scrollHeight)},_ensureTarget:function(){this.dialogElement=this.dialogElement||this.parentElement,this.dialogElement&&this.dialogElement.behaviors&&this.dialogElement.behaviors.indexOf(i.b)>=0?(this.dialogElement.sizingTarget=this.scrollTarget,this.scrollTarget.classList.remove("fit")):this.dialogElement&&this.scrollTarget.classList.add("fit")}})},262:function(t,e,a){"use strict";const i={DOMAIN_DEVICE_CLASS:{binary_sensor:["battery","cold","connectivity","door","garage_door","gas","heat","light","lock","moisture","motion","moving","occupancy","opening","plug","power","presence","problem","safety","smoke","sound","vibration","window"],cover:["garage"],sensor:["battery","humidity","illuminance","temperature"]},UNKNOWN_TYPE:"json",ADD_TYPE:"key-value",TYPE_TO_TAG:{string:"ha-customize-string",json:"ha-customize-string",icon:"ha-customize-icon",boolean:"ha-customize-boolean",array:"ha-customize-array","key-value":"ha-customize-key-value"}};i.LOGIC_STATE_ATTRIBUTES=i.LOGIC_STATE_ATTRIBUTES||{entity_picture:void 0,friendly_name:{type:"string",description:"Name"},icon:{type:"icon"},emulated_hue:{type:"boolean",domains:["emulated_hue"]},emulated_hue_name:{type:"string",domains:["emulated_hue"]},haaska_hidden:void 0,haaska_name:void 0,homebridge_hidden:{type:"boolean"},homebridge_name:{type:"string"},supported_features:void 0,attribution:void 0,custom_ui_more_info:{type:"string"},custom_ui_state_card:{type:"string"},device_class:{type:"array",options:i.DOMAIN_DEVICE_CLASS,description:"Device class",domains:["binary_sensor","cover","sensor"]},hidden:{type:"boolean",description:"Hide from UI"},assumed_state:{type:"boolean",domains:["switch","light","cover","climate","fan","group"]},initial_state:{type:"string",domains:["automation"]},unit_of_measurement:{type:"string"}},e.a=i},270:function(t,e,a){"use strict";var i=a(6),s=a(198),r=a(45),o=a(15);e.a=Object(i.a)(t=>(class extends(Object(r.b)([o.a,s.a],t)){static get properties(){return{withBackdrop:{type:Boolean,value:!0}}}}))},600:function(t,e,a){"use strict";a.r(e),a(201),a(227);var i=a(0),s=a(3),r=(a(149),a(115),a(60),a(159),a(160),a(162),a(30),a(53),a(59),a(15)),o=a(13);customElements.define("more-info-alarm_control_panel",class extends(Object(o.a)(Object(r.a)(s.a))){static get template(){return i["a"]`
    ...
    `}static get properties(){return{hass:Object,stateObj:Object}}handleTriggerTapped(){this.hass.callService("automation","trigger",{entity_id:this.stateObj.entity_id})}});var n=a(28);customElements.define("more-info-camera",class extends(Object(r.a)(s.a)){static get template(){return i["a"]`
    <style>
      :host {
        max-width:640px;
      }
...
`}static get properties(){return{caption:String,disabled:Boolean,min:Number,max:Number,pin:Boolean,step:Number,extra:{type:Boolean,value:!1},ignoreBarTouch:{type:Boolean,value:!0},icon:{type:String,value:""},value:{type:Number,notify:!0}}}});var u=a(78);const h={128:"has-set_tilt_position"};customElements.define("more-info-cover",class extends(Object(o.a)(s.a)){static get template(){return i["a"]`
  <style include="iron-flex"></style>
  <style>
...
`}static get properties(){return{hass:Object,stateObj:Object}}}),a(2),a(268),customElements.define("paper-time-input",class extends s.a{static get template(){return i["a"]`
      <style>
        :host {
          display: block;
...
`}static get properties(){return{hass:Object,stateObj:Object,playerObj:{type:Object,computed:"computePlayerObj(hass, stateObj)",observer:"playerObjChanged"},sourceIndex:{type:Number,value:0,observer:"handleSourceChanged"},SoundModeInput:{type:String,value:"",observer:"handleSoundModeChanged"},ttsLoaded:{type:Boolean,computed:"computeTTSLoaded(hass)"},ttsMessage:{type:String,value:""}}}computePlayerObj(t,e){return new _.a(t,e)}playerObjChanged(t,e){t&&void 0!==t.sourceList&&(this.sourceIndex=t.sourceList.indexOf(t.source)),t&&void 0!==t.soundModeList&&(this.SoundModeInput=t.soundMode),e&&setTimeout(()=>{this.fire("iron-resize")},500)}computeClassNames(t){return Object(p.a)(t,["volume_level"])}computeMuteVolumeIcon(t){return t.isMuted?"hass:volume-off":"hass:volume-high"}computeHideVolumeButtons(t){return!t.supportsVolumeButtons||t.isOff}computeShowPlaybackControls(t){return!t.isOff&&t.hasMediaControl}computePlaybackControlIcon(t){return t.isPlaying?t.supportsPause?"hass:pause":"hass:stop":t.supportsPlay?"hass:play":null}computeHidePowerButton(t){return t.isOff?!t.supportsTurnOn:!t.supportsTurnOff}computeHideSelectSource(t){return t.isOff||!t.supportsSelectSource||!t.sourceList}computeHideSelectSoundMode(t){return t.isOff||!t.supportsSelectSoundMode||!t.soundModeList}computeHideTTS(t,e){return!t||!e.supportsPlayMedia}computeTTSLoaded(t){return Object(O.a)(t,"tts")}handleTogglePower(){this.playerObj.togglePower()}handlePrevious(){this.playerObj.previousTrack()}handlePlaybackControl(){this.playerObj.mediaPlayPause()}handleNext(){this.playerObj.nextTrack()}handleSourceChanged(t,e){if(!this.playerObj||!this.playerObj.supportsSelectSource||void 0===this.playerObj.sourceList||t<0||t>=this.playerObj.sourceList||void 0===e)return;const a=this.playerObj.sourceList[t];a!==this.playerObj.source&&this.playerObj.selectSource(a)}handleSoundModeChanged(t,e){e&&t!==this.playerObj.soundMode&&this.playerObj.supportsSelectSoundMode&&this.playerObj.selectSoundMode(t)}handleVolumeTap(){this.playerObj.supportsVolumeMute&&this.playerObj.volumeMute(!this.playerObj.isMuted)}handleVolumeUp(){const t=this.$.volumeUp;this.handleVolumeWorker("volume_up",t,!0)}handleVolumeDown(){const t=this.$.volumeDown;this.handleVolumeWorker("volume_down",t,!0)}handleVolumeWorker(t,e,a){(a||void 0!==e&&e.pointerDown)&&(this.playerObj.callService(t),setTimeout(()=>this.handleVolumeWorker(t,e,!1),500))}volumeSliderChanged(t){const e=parseFloat(t.target.value),a=e>0?e/100:0;this.playerObj.setVolume(a)}ttsCheckForEnter(t){13===t.keyCode&&this.sendTTS()}sendTTS(){const t=this.hass.config.services.tts,e=Object.keys(t).sort();let a,i;for(i=0;i<e.length;i++)if(-1!==e[i].indexOf("_say")){a=e[i];break}a&&(this.hass.callService("tts",a,{entity_id:this.stateObj.entity_id,message:this.ttsMessage}),this.ttsMessage="",this.$.ttsInput.focus())}}),customElements.define("more-info-script",class extends s.a{static get template(){return i["a"]`
    <style include="iron-flex iron-flex-alignment"></style>
...
`}static get properties(){return{stateObj:{type:Object}}}});var j=a(106);customElements.define("more-info-sun",class extends s.a{static get template(){return i["a"]`
    <style include="iron-flex iron-flex-alignment"></style>
...
`}static get properties(){return{hass:Object,stateObj:Object}}constructor(){super(),this.cardinalDirections=["N","NNE","NE","ENE","E","ESE","SE","SSE","S","SSW","SW","WSW","W","WNW","NW","NNW","N"],this.weatherIcons={"clear-night":"hass:weather-night",cloudy:"hass:weather-cloudy",fog:"hass:weather-fog",hail:"hass:weather-hail",lightning:"mid:weather-lightning","lightning-rainy":"hass:weather-lightning-rainy",partlycloudy:"hass:weather-partlycloudy",pouring:"hass:weather-pouring",rainy:"hass:weather-rainy",snowy:"hass:weather-snowy","snowy-rainy":"hass:weather-snowy-rainy",sunny:"hass:weather-sunny",windy:"hass:weather-windy","windy-variant":"hass:weather-windy-variant"}}computeDateTime(t){const e=new Date(t),a=this.stateObj.attributes.attribution;return"Powered by Dark Sky"===a||"Data provided by OpenWeatherMap"===a?(new Date).getDay()===e.getDay()?e.toLocaleTimeString(this.hass.selectedLanguage||this.hass.language,{hour:"numeric"}):e.toLocaleDateString(this.hass.selectedLanguage||this.hass.language,{weekday:"long",hour:"numeric"}):e.toLocaleDateString(this.hass.selectedLanguage||this.hass.language,{weekday:"long",month:"short",day:"numeric"})}getUnit(t){const e=this.hass.config.core.unit_system.length||"";switch(t){case"air_pressure":return"km"===e?"hPa":"inHg";case"length":return e;case"precipitation":return"km"===e?"mm":"in";default:return this.hass.config.core.unit_system[t]||""}}windBearingToText(t){const e=parseInt(t);return isFinite(e)?this.cardinalDirections[((e+11.25)/22.5|0)%16]:t}getWind(t,e,a){if(null!=e){const i=this.windBearingToText(e);return`${t} ${this.getUnit("length")}/h (${a(`ui.card.weather.cardinal_direction.${i.toLowerCase()}`)||i})`}return`${t} ${this.getUnit("length")}/h`}getWeatherIcon(t){return this.weatherIcons[t]}}),customElements.define("more-info-content",class extends s.a{static get properties(){return{hass:Object,stateObj:Object}}static get observers(){return["stateObjChanged(stateObj, hass)"]}constructor(){super(),this.style.display="block"}stateObjChanged(t,e){let a;t&&e?(this._detachedChild&&(this.appendChild(this._detachedChild),this._detachedChild=null),a=t.attributes&&"custom_ui_more_info"in t.attributes?t.attributes.custom_ui_more_info:"more-info-"+Object(y.a)(t),Object(v.a)(this,a.toUpperCase(),{hass:e,stateObj:t})):this.lastChild&&(this._detachedChild=this.lastChild,this.removeChild(this.lastChild))}});var x=a(36);const w=["camera","configurator","history_graph"];customElements.define("more-info-controls",class extends(Object(r.a)(s.a)){static get template(){return i["a"]`
...
`}static get properties(){return{hass:Object,stateObj:{type:Object,observer:"_stateObjChanged"},dialogElement:Object,canConfigure:Boolean,domain:{type:String,reflectToAttribute:!0,computed:"_computeDomain(stateObj)"},_stateHistory:Object,_stateHistoryLoading:Boolean,large:{type:Boolean,value:!1,notify:!0},_cacheConfig:{type:Object,value:{refresh:60,cacheKey:null,hoursToShow:24}}}}enlarge(){this.large=!this.large}_computeShowStateInfo(t){return!t||!w.includes(Object(g.a)(t))}_computeShowHistoryComponent(t,e){return t&&e&&Object(O.a)(t,"history")&&!x.d.includes(Object(g.a)(e))}_computeDomain(t){return t?Object(g.a)(t):""}_computeStateName(t){return t?Object(n.a)(t):""}_stateObjChanged(t){t&&this._cacheConfig.cacheKey!==`more_info.${t.entity_id}`&&(this._cacheConfig=Object.assign({},this._cacheConfig,{cacheKey:`more_info.${t.entity_id}`}))}_gotoSettings(){this.fire("more-info-page",{page:"settings"})}}),customElements.define("more-info-settings",class extends(Object(o.a)(Object(r.a)(s.a))){static get template(){return i["a"]`
    <style>
      app-toolbar {
        color: var(--more-info-header-color);
        background-color: var(--more-info-header-background);
...
`}static get properties(){return{hass:Object,stateObj:Object,_componentLoaded:{type:Boolean,computed:"_computeComponentLoaded(hass)"},registryInfo:{type:Object,observer:"_registryInfoChanged",notify:!0},_name:String,_entityId:String}}_computeStateName(t){return t?Object(n.a)(t):""}_computeComponentLoaded(t){return Object(O.a)(t,"config.entity_registry")}_registryInfoChanged(t){t?this.setProperties({_name:t.name,_entityId:t.entity_id}):this.setProperties({_name:"",_entityId:""})}_backTapped(){this.fire("more-info-page",{page:null})}async _save(){try{const t=await this.hass.callWS({type:"config/entity_registry/update",entity_id:this.stateObj.entity_id,name:this._name,new_entity_id:this._entityId});this.registryInfo=t,this.stateObj.entity_id!==this._entityId&&this.fire("hass-more-info",{entityId:this._entityId})}catch(t){alert(`save failed: ${t.message}`)}}});var C=a(270);customElements.define("ha-more-info-dialog",class extends(Object(C.a)(s.a)){static get template(){return i["a"]`
