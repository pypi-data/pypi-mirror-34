...
Marginalization is particularly effective here because the 2-point fits give
good estimates for the nonlinear parameters (amplitudes and energies), while
the 3-point amplitudes are all linear. Extreme marginalization therefore makes
the 3-point fits much faster, but still also accurate.
