...
class CreateDomainResponse(get_parent()):
    ...
    def compute_parent_updates():
        ...
        CreateDomainResponse.swagger_types.update(get_parent().swagger_types)
        CreateDomainResponse.attribute_map.update(get_parent().attribute_map)
    ...
    def __init__(self, **kwargs):  # noqa: E501
        ...
        for k in kwargs:
            if k not in self.swagger_types:
                raise ValueError("CreateDomainResponse got unexpected argument '%s'" % k)
        ...
        if "name" not in kwargs:
            raise ValueError("CreateDomainResponse missing required argument: name")
