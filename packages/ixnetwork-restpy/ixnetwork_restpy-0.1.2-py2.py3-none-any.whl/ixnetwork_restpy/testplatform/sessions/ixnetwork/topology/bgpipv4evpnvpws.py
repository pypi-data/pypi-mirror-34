...
class BgpIPv4EvpnVpws(Base):
	...
	def BroadcastDomainV4Vpws(self):
		"""Returns the one and only one BroadcastDomainV4Vpws object from the server.
		...
		return self._read(BroadcastDomainV4Vpws(self), None)
	...
	def remove(self):
		"""Deletes a child instance of BgpIPv4EvpnVpws on the server.
	...
	def RestartDown(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpIPv4EvpnVpws object references
