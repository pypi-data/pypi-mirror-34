...
class MRMeasurementV3Packet(Packet):
    ...
    def __str__(self):
        ...
        msg += 'Avg.: {}mg | '.format(
            BMA280.gravity(1, self.mrt_average) * 1000 / scale)
        msg += 'Std.: {}mg | '.format(
            BMA280.gravity(1, self.mrt_stdev) * 1000 / scale)
        msg += 'Min: {}mg | '.format(
            BMA280.gravity(1, self.mrt_min) * 1000 / scale)
        msg += 'Max: {}mg | '.format(
            BMA280.gravity(1, self.mrt_max) * 1000 / scale)
