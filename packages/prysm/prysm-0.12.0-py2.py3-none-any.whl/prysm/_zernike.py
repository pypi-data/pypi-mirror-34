...
primary_coma_y.name = 2 * 'Primary Coma Y'
primary_coma_x.name = 2 * 'Primary Coma X'
primary_spherical.name = 'Primary Spherical'
primary_trefoil_y.name = 2 * 'Primary Trefoil X'
primary_trefoil_x.name = 2 * 'Primary Trefoil Y'
secondary_astigmatism_00.name = 'Secondary Astigmatism 0°'
secondary_astigmatism_45.name = 'Secondary Astigmatism 45°'
secondary_coma_y.name = 2 * 'Secondary Coma Y'
secondary_coma_x.name = 2 * 'Secondary Coma X'
