...
class Tetra1_Sphere(Model):
    ...
    def __init__(self):
        Model.__init__(self)
        self.IntensityFunc=self.Tetra1_Function #function
        ...
        self.name="Multi: Tetrahedra of identical spheres"          #name of the model
        self.Description="Tetrahedra of identical spheres"
