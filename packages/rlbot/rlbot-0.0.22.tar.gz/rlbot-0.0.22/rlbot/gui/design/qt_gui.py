...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame = QtWidgets.QFrame(self.bot_config_groupbox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.frame_2 = QtWidgets.QFrame(self.bot_config_groupbox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_15 = QtWidgets.QLabel(self.match_settings_groupbox)
        self.label_15.setObjectName("label_15")
        self.gridLayout_2.addWidget(self.label_15, 0, 6, 1, 1)
        self.match_length_combobox = QtWidgets.QComboBox(self.match_settings_groupbox)
        self.match_length_combobox.setObjectName("match_length_combobox")
        self.gridLayout_2.addWidget(self.match_length_combobox, 0, 7, 1, 1)
        ...
        self.label_16 = QtWidgets.QLabel(self.match_settings_groupbox)
        self.label_16.setObjectName("label_16")
        self.gridLayout_2.addWidget(self.label_16, 1, 6, 1, 1)
        self.boost_type_combobox = QtWidgets.QComboBox(self.match_settings_groupbox)
        self.boost_type_combobox.setObjectName("boost_type_combobox")
        self.gridLayout_2.addWidget(self.boost_type_combobox, 1, 7, 1, 1)
