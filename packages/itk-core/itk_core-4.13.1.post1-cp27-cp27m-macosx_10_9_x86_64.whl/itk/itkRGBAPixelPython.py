...
class itkRGBAPixelD(itkFixedArrayPython.itkFixedArrayD4):
    ...
    https://www.itk.org/Wiki/ITK/Examples/SimpleOperations/Transparency
    ...
    def GetScalarValue(self):
        ...
        norm of the vector defined by the RGB components. Alpha is not used.
...
def itkRGBAPixelD_GetNumberOfComponents():
