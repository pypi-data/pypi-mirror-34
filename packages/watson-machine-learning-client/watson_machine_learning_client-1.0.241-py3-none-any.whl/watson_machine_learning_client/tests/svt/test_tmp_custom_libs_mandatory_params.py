...
class TestCustomLibraries(unittest.TestCase):
    ...
    def test_2_create_custom_library(self):
        TestCustomLibraries.custom_library_uid = self.client._runtimes._create_custom_library({
    ...
    def test_3_delete_custom_library(self):
        self.client._runtimes.delete_custom_library(TestCustomLibraries.custom_library_uid)
