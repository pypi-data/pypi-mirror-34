...
def test_depolarizer_all_errors():
    ...
    p0 = Symbol(DepolarizerChannel._parameter_name + u'0')
    p1 = Symbol(DepolarizerChannel._parameter_name + u'1')
...
def test_depolarizer_different_gate():
    ...
    p0 = Symbol(DepolarizerChannel._parameter_name + u'0')
    p1 = Symbol(DepolarizerChannel._parameter_name + u'1')
    p2 = Symbol(DepolarizerChannel._parameter_name + u'2')
    p3 = Symbol(DepolarizerChannel._parameter_name + u'3')
...
def test_depolarizer_parameterized_gates():
    q1 = ops.QubitId()
    q2 = ops.QubitId()
    cnot_param = Symbol(u'cnot_turns')
    cnot_gate = xmon_gates.Exp11Gate(half_turns=cnot_param).on(q1, q2)

    job_sweep = Points(u'cnot_turns', [0.5])
