...
u"""Defines the interface for black box optimization algorithms."""
...
class OptimizationAlgorithm(object):
    ...
    u"""An optimization algorithm for black-box objective functions.
    ...
    def default_options(self):
        u"""Default options for the algorithm."""
    ...
    def optimize(self,
        ...
        u"""Perform the optimization and return the result.
...
class OptimizationParams(object):
    u"""Parameters for an optimization run.
    ...
    def __init__(self,
        ...
        u"""Construct a parameters object by setting its attributes."""
