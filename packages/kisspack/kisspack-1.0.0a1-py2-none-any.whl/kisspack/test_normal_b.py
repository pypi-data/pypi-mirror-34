...
def get_params(global_params):
    ...
    params['est_task_time'] = (global_params.get('iterations', 10) * 4) + 3
    params['priority'] = 3
...
def task_setup(global_params):
    ...
    logger.info("execute setup normal b")
...
def task_main(global_params):
    ...
    logger.info("execute task_main normal b")
    result = "Passed"
...
def test_teardown(global_params):
    ...
    logger.info("execute teardown normal b")
