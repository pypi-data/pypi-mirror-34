...
# NOTE: Add keywords
# NOTE: Add install_requires
# NOTE: Set version in package's __init__.py
#
...
setup(
    ...
    #
    # Required
    description="A django ImageField that generates it's upload_to value from the model instance method get_upload_to.",
