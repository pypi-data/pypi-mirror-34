...
class BgpIPv6EvpnPbb(Base):
	...
	def remove(self):
		"""Deletes a child instance of BgpIPv6EvpnPbb on the server.
	...
	def RestartDown(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpIPv6EvpnPbb object references
