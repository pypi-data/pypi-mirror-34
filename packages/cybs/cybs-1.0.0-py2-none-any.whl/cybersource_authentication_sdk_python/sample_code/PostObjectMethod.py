...
class PostObjectMethod:
    ...
    def post_object_method(self):
        ...
        try:
            ...
            # This reads the data from sample payment data as the request.json is absent
            mconfig.request_json_path_data = cybersource_authentication_sdk_python.data.RequestData.sample_payment_data()
