...
class LegacyStream(HydraStream):
    def __init__(self, brand, channel, rdl_schema, odl_schema, max_attempts=5, streaming=True, level='INFO'):
        """
        Constructor
        ...
        HydraStream.__init__(self, brand, channel, rdl_schema, odl_schema, max_attempts, streaming, level)
