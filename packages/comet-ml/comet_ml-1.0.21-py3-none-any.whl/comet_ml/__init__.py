...
from .file_uploader import (
    upload_file_process, upload_file_contents_process, upload_repo_start_process
)
from .comet import (
    Message,
    Streamer,
...
class Experiment(object):
    ...
    def _authenticate(self):
        ...
        try:
            ...
            self.run_id, full_ws_url, self.project_id, self.is_github, self.focus_link, self.upload_limit, feature_toggles = run_id_results
...
class ExistingExperiment(Experiment):
    ...
    def _authenticate(self):
        ...
        try:
            ...
            self.run_id, full_ws_url, self.project_id, self.is_github, self.focus_link, self.upload_limit, feature_toggles = run_id_response
