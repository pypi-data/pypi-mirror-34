...
class TestXpathBrowser(WebUnitTestBase):
    ...
    def test_fill(self):
        ...
        <form>
          First name:<br>
          <input id=input1 type="text" name="firstname">
          <br>
          Last name:<br>
          <input id=input2 type="text" name="lastname">
        </form> 
        '''
        ...
        with self.create_html('test_fill', body) as path:
            ...
            self.browser.fill_form_attr('id', {'input1':'John2', 'input2':'Doe2'})
            ...
            self.browser.fill_css('#input1', 'CSS fill')
...
#            self.fail('No alert wiped')
    ...
    def test_select(self):
        ...
        with self.create_html('test_select', body) as path:
            self.get_local_page(path)
            self.assert_(self.browser.select_xpath('//div'))
            self.assert_(self.browser.select_xsingle('//div'))
            self.assert_(self.browser.select_css('#some_text'))
            self.assert_(self.browser.select_css_single('#some_text'))
