...
class itkHalfHermitianToRealInverseFFTImageFilterICF2IF2(itkImageToImageFilterBPython.itkImageToImageFilterICF2IF2):
    ...
    def GetPointer(self) -> "itkHalfHermitianToRealInverseFFTImageFilterICF2IF2 *":
        """GetPointer(itkHalfHermitianToRealInverseFFTImageFilterICF2IF2 self) -> itkHalfHermitianToRealInverseFFTImageFilterICF2IF2"""
        return _itkHalfHermitianToRealInverseFFTImageFilterPython.itkHalfHermitianToRealInverseFFTImageFilterICF2IF2_GetPointer(self)
...
itkHalfHermitianToRealInverseFFTImageFilterICF2IF2.GetPointer = new_instancemethod(_itkHalfHermitianToRealInverseFFTImageFilterPython.itkHalfHermitianToRealInverseFFTImageFilterICF2IF2_GetPointer, None, itkHalfHermitianToRealInverseFFTImageFilterICF2IF2)
...
class itkHalfHermitianToRealInverseFFTImageFilterICF3IF3(itkImageToImageFilterBPython.itkImageToImageFilterICF3IF3):
    ...
    def GetPointer(self) -> "itkHalfHermitianToRealInverseFFTImageFilterICF3IF3 *":
        """GetPointer(itkHalfHermitianToRealInverseFFTImageFilterICF3IF3 self) -> itkHalfHermitianToRealInverseFFTImageFilterICF3IF3"""
        return _itkHalfHermitianToRealInverseFFTImageFilterPython.itkHalfHermitianToRealInverseFFTImageFilterICF3IF3_GetPointer(self)
...
itkHalfHermitianToRealInverseFFTImageFilterICF3IF3.GetPointer = new_instancemethod(_itkHalfHermitianToRealInverseFFTImageFilterPython.itkHalfHermitianToRealInverseFFTImageFilterICF3IF3_GetPointer, None, itkHalfHermitianToRealInverseFFTImageFilterICF3IF3)
