...
`}static get properties(){return{hass:{type:Object},entityId:{type:String,value:""},entityName:{type:String,value:null},entityPicture:{type:String,value:null}}}ready(){super.ready(),this.addEventListener("click",t=>this.badgeTap(t))}badgeTap(t){t.stopPropagation(),this.entityId&&this.fire("hass-more-info",{entityId:this.entityId})}})},610:function(t,e,a){"use strict";a.r(e),a(117);var i=a(0),r=a(3),s=a(261),n=a.n(s),o=(a(128),a(84),a(303),a(26)),c=a(28),l=a(13),u=a(302);n.a.Icon.Default.imagePath="/static/images/leaflet",customElements.define("ha-panel-map",class extends(Object(l.a)(r.a)){static get template(){return i["a"]`
...
//# sourceMappingURL=9ae79ea9a2fd0b848e37.chunk.js.map