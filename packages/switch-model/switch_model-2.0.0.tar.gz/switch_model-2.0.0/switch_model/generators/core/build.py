...
def define_components(mod):
    ...
    # TODO: finish introducing these, maybe use a construction dictionary or closure, 
    # remove equivalent ones from hawaii.switch_patch, test
    # m.GENS_BY_NON_FUEL_ENERGY_SOURCE = Set(
    ...
    #         (g for g in m.FUEL_BASED_GENS if f in m.FUELS_FOR_GEN[p])
    # )
