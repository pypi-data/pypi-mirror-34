...
class RequestedLsps(Base):
	...
	def PccRequestedMetricSubObjectsList(self, DescriptiveName=None, Name=None):
	...
	def PcepIroSubObjectsList(self, DescriptiveName=None, Name=None):
	...
	def PcepXroSubObjectsList(self, DescriptiveName=None, Name=None):
