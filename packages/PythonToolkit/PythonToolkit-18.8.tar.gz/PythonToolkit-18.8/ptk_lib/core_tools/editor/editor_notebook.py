...
class EditorNotebook(aui.AuiNotebook):   
    def __init__(self,parent):
        ...
        aui.AuiNotebook.__init__(self,parent,-1,style=style)
        ...
        self.Bind(aui.EVT_AUINOTEBOOK_PAGE_CHANGED, self.OnChangedPage)
    ...
    def OnClosePage(self,event):
        ...
        if result is False:
            ...
            #skip not working Aug 2018?
            #event.Skip()
            #need to manually remove and destroy later to prevent crash?
            self.RemovePage(num)
            page.DestroyLater()
