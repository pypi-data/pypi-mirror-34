...
"""
*  This file:/acct/smb/com/dev-py/LUE/Sync/pypi/pkgs/unisos/wsInvokerIcm/dev/bin/rinvoker.py :: [[elisp:(org-cycle)][| ]]
...
__icmName__ = "rinvoker"
####+END:

####+BEGIN: bx:global:timestamp:version-py :style "date"
__version__ = "201807225333"
####+END:
...
from unisos.wsInvokerIcm import wsInvokerIcm
...
####+END:
        ...
        icm.cmndExampleMenuChapter('*Create Header Files*')
        ...
        execLineEx("""rinvoker.py -i headersCreate > {headersFileName}""".format(headersFileName=headersFileName))        

        # wsInvokerIcm.examples_commonInvoker(
        #     svcSpec="http://localhost:8080/swagger.json",
