...
class InteractionState(State):
    ...
    def to_structured_from_state(self, state: 'State') -> 'State':
        ...
        print('entered to structured from state', state)
        print(super().to_structured_from_state(state), 'structured:', super().to_structured_from_state(state).is_structured)
        print()
        ...
        elif not super().to_structured_from_state(state).is_structured:
            x = (super().to_structured_from_state(state))
            print('x: ', x)
            print(x.first, x.first.is_structured, type(x.first))
            print(x.second, x.second.is_structured)
            print('x: ', x)
