...
from watson_machine_learning_client.runtime_specs import RuntimeSpecs
...
class WatsonMachineLearningAPIClient:
    ...
    def __init__(self, wml_credentials, project_id='Not provided'):
        ...
        self.runtime_specs = RuntimeSpecs(self)
