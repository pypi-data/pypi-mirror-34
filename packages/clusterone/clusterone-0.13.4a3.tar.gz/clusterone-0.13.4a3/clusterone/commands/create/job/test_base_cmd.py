...
def test_custom_user_arguments(mocker):
    output_arguments = base_cmd.validate_module_arguments(mocker.ANY, mocker.ANY,
                                                          ('--custom-dummy-argument0', 'dummy0',
                                                           '--custom-dummy-argument1', 'dummy1'))
    assert output_arguments == {'custom-dummy-argument0': 'dummy0', 'custom-dummy-argument1': 'dummy1'}


def test_custom_user_arguments_missing_value(mocker):
    with pytest.raises(BadParameter):
        base_cmd.validate_module_arguments(mocker.ANY, mocker.ANY,
                                           ('--custom-dummy-argument0', '--custom-dummy-argument1', 'dummy1'))
