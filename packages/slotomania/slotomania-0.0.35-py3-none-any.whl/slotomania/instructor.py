...
from slotomania.contrib.dataclass_converter import Contract
...
class RequestResolver:
    ...
    def clean_request_data(self) -> None:
        contract_class = self.get_contract_class()
        # TODO: deprecate marshmallow schema
        if issubclass(contract_class, Schema):
            schema = class_registry.get_class(
                self.get_contract_class().__name__
            )()
    ...
    @classmethod
    def get_contract_class(cls) -> Type[Sloto]:
