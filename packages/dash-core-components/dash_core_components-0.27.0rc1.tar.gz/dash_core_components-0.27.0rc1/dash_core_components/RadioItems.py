...
Available events: 'change'"""
    @_explicitize_args
    def __init__(self, id=None, options="Unparsable-JS-Object", value=None, style=None, className=None, inputStyle={}, inputClassName='', labelStyle={}, labelClassName='', **kwargs):
