...
"""
from slack.api.channels import Channels
from slack.api.chat import Chat
from slack.api.users import Users
...
class SlackClient:
    ...
    def __init__(self, slack_token: str, slack_api_url: str = None) -> None:
        ...
        self._slack_api_url = 'https://slack.com/api/'
        if slack_api_url:
            self._slack_api_url = slack_api_url
        self._users_api = None
        self._channels_api = None
        self._chat_api = None
