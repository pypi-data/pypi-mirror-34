...
#define SBK_QTMULTIMEDIA_QLIST_QREAL_IDX                             12 // QList<qreal >
#define SBK_QTMULTIMEDIA_QLIST_QCAMERAVIEWFINDERSETTINGS_IDX         13 // QList<QCameraViewfinderSettings >
#define SBK_QTMULTIMEDIA_QLIST_QAUDIO_ROLE_IDX                       14 // QList<QAudio::Role >
...
#define SBK_QTMULTIMEDIA_QLIST_QCAMERAINFO_IDX                       19 // QList<QCameraInfo >
