...
class BgpIPRouteProperty(Base):
	...
	def remove(self):
		"""Deletes a child instance of BgpIPRouteProperty on the server.
	...
	def AgeOutRoutes(self, Arg1, Percentage):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpIPRouteProperty object references
