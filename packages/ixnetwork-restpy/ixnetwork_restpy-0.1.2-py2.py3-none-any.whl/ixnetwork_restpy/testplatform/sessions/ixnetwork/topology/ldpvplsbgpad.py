...
class Ldpvplsbgpad(Base):
	...
	def remove(self):
		"""Deletes a child instance of Ldpvplsbgpad on the server.
	...
	def PurgeVCRanges(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./ldpvplsbgpad object references
