...
class itkPolygonGroupSpatialObject2(itkGroupSpatialObjectPython.itkGroupSpatialObject2):
    ...
    This class implements a Region of Interest, which is simply a space in
    a medical image that has some significance as a component of the scan.
    Different components of brain anatomy, for instance are Regions of
    Interest in the human brain. The primary difference between
    PolygonGroupSpatialObject and other descendants of SpatialObject are
    these: For now, an PolygonGroup needs to comprise a series of slices
    parallel to a plane swept by any two of the major axes. In other
    words, the points in each slice (or strand) all need to have one of
    the X,Y,Z values to be constant.

    The IsInside method implements the concept of spatial 'insidedness'
    where other descendents of SpatialObject have a concept of insidedness
    defined in a rather ad-hoc manner. PolygonGroupSpatialObjects define
    IsInside to mean that the given point resides in space inside the
    surface of the PolygonGroupSpatialObject.

    C++ includes: itkPolygonGroupSpatialObject.h 
    """
    ...
    def AddStrand(self, toAdd: 'itkPolygonSpatialObject2') -> "bool":
        ...
        PolygonSpatialObject is successfully added to the PolygonGroup. 
        """
    ...
    def DeleteStrand(self, toDelete: 'itkPolygonSpatialObject2') -> "bool":
        ...
        Return true if the
        given PolygonSpatialObject is successfully removed from the
        PolygonGroup 
        """
    ...
    def ReplaceStrand(self, toReplace: 'itkPolygonSpatialObject2', replacement: 'itkPolygonSpatialObject2') -> "bool":
        ...
        Return true if the
        given PolygonSpatialObject successfully replaces the Polygon given in
        toReplace. This will fail if toReplace is not a strand in the
        PolygonGroupObject. 
        """
    ...
    def IsClosed(self) -> "bool":
        ...
        Return true if all
        constituent Polygons are closed. 
        """
    ...
    def NumberOfStrands(self) -> "unsigned int":
        ...
        returns the number
        of Polygons in this PolygonGroup 
        """
    ...
    def Volume(self) -> "double":
        ...
        Volume of this PolygonGroup,
        which is the sum of the volume of all its constituent Polygons 
        """
