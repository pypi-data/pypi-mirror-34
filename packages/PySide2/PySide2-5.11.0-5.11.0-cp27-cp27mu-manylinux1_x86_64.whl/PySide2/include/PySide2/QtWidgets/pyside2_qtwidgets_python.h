...
#define SBK_QTWIDGETS_QVECTOR_QLINE_IDX                              6 // const QVector<QLine > &
#define SBK_QTWIDGETS_QVECTOR_QLINEF_IDX                             7 // const QVector<QLineF > &
#define SBK_QTWIDGETS_QVECTOR_QPOINT_IDX                             8 // const QVector<QPoint > &
#define SBK_QTWIDGETS_QVECTOR_QPOINTF_IDX                            9 // const QVector<QPointF > &
#define SBK_QTWIDGETS_QVECTOR_QRECT_IDX                              10 // const QVector<QRect > &
#define SBK_QTWIDGETS_QVECTOR_QRECTF_IDX                             11 // const QVector<QRectF > &
#define SBK_QTWIDGETS_QLIST_QGESTUREPTR_IDX                          12 // const QList<QGesture* > &
#define SBK_QTWIDGETS_QLIST_QACTIONPTR_IDX                           13 // QList<QAction* >
#define SBK_QTWIDGETS_QLIST_QOBJECTPTR_IDX                           14 // const QList<QObject* > &
#define SBK_QTWIDGETS_QLIST_QBYTEARRAY_IDX                           15 // QList<QByteArray >
#define SBK_QTWIDGETS_QLIST_QDOCKWIDGETPTR_IDX                       16 // const QList<QDockWidget* > &
#define SBK_QTWIDGETS_QLIST_INT_IDX                                  17 // const QList<int > &
#define SBK_QTWIDGETS_QLIST_QWIDGETPTR_IDX                           18 // QList<QWidget* >
#define SBK_QTWIDGETS_QVECTOR_INT_IDX                                19 // const QVector<int > &
#define SBK_QTWIDGETS_QLIST_QMDISUBWINDOWPTR_IDX                     20 // QList<QMdiSubWindow* >
#define SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX                   21 // QList<QListWidgetItem* >
...
#define SBK_QTWIDGETS_QLIST_QWIZARD_WIZARDBUTTON_IDX                 25 // const QList<QWizard::WizardButton > &
#define SBK_QTWIDGETS_QMAP_QDATE_QTEXTCHARFORMAT_IDX                 26 // QMap<QDate,QTextCharFormat >
#define SBK_QTWIDGETS_QLIST_QRECTF_IDX                               27 // const QList<QRectF > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                     28 // QList<QGraphicsView* >
#define SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                        29 // QPair<qreal,QPointF >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX                  30 // QList<QPair< qreal,QPointF > >
#define SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                          31 // QPair<qreal,qreal >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                    32 // QList<QPair< qreal,qreal > >
#define SBK_QTWIDGETS_QLIST_QGRAPHICSWIDGETPTR_IDX                   33 // QList<QGraphicsWidget* >
#define SBK_QTWIDGETS_QLIST_QKEYSEQUENCE_IDX                         34 // const QList<QKeySequence > &
#define SBK_QTWIDGETS_QLIST_QUNDOSTACKPTR_IDX                        35 // QList<QUndoStack* >
#define SBK_QTWIDGETS_QLIST_QSCROLLERPTR_IDX                         36 // QList<QScroller* >
#define SBK_QTWIDGETS_QLIST_QREAL_IDX                                37 // const QList<qreal > &
#define SBK_QTWIDGETS_QLIST_QWINDOWPTR_IDX                           38 // QList<QWindow* >
#define SBK_QTWIDGETS_QLIST_QSCREENPTR_IDX                           39 // QList<QScreen* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTANIMATIONPTR_IDX                40 // QList<QAbstractAnimation* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTSTATEPTR_IDX                    41 // const QList<QAbstractState* > &
#define SBK_QTWIDGETS_QHASH_INT_QBYTEARRAY_IDX                       42 // const QHash<int,QByteArray > &
#define SBK_QTWIDGETS_QMAP_INT_QVARIANT_IDX                          43 // QMap<int,QVariant >
#define SBK_QTWIDGETS_QLIST_QPERSISTENTMODELINDEX_IDX                44 // const QList<QPersistentModelIndex > &
#define SBK_QTWIDGETS_QLIST_QURL_IDX                                 45 // QList<QUrl >
#define SBK_QTWIDGETS_QLIST_QTEXTEDIT_EXTRASELECTION_IDX             46 // QList<QTextEdit::ExtraSelection >
