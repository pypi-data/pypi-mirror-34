...
class BgpIPv6EvpnVpws(Base):
	...
	def BroadcastDomainV6Vpws(self):
		"""Returns the one and only one BroadcastDomainV6Vpws object from the server.
		...
		return self._read(BroadcastDomainV6Vpws(self), None)
	...
	def remove(self):
		"""Deletes a child instance of BgpIPv6EvpnVpws on the server.
	...
	def RestartDown(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpIPv6EvpnVpws object references
