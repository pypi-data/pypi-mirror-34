...
Parameters:
    ...
    method: str
        ...
        ‘quadratic’, ‘cubic’, ‘previous’, ‘next’, where ‘zero’, ‘slinear’, ‘quadratic’ and 
        ‘cubic’ refer to a spline interpolation of zeroth, first, second or third order; 
        ‘previous’ and ‘next’ simply return the previous or next value of the point) or 
...
def tinterpol(names, interp_names=None, method=None, new_names=None, suffix=None):
