...
#define SWIGTYPE_p_f_p_struct__GPContext_float_p_q_const__char_p_void__unsigned_int swig_types[43]
#define SWIGTYPE_p_f_p_struct__GPContext_p_q_const__char_p_void___GPContextFeedback swig_types[44]
#define SWIGTYPE_p_f_p_struct__GPContext_p_q_const__char_p_void__void swig_types[45]
#define SWIGTYPE_p_f_p_struct__GPContext_p_void___GPContextFeedback swig_types[46]
#define SWIGTYPE_p_f_p_struct__GPContext_p_void__void swig_types[47]
#define SWIGTYPE_p_f_p_struct__GPContext_unsigned_int_float_p_void__void swig_types[48]
#define SWIGTYPE_p_f_p_struct__GPContext_unsigned_int_p_void__void swig_types[49]
