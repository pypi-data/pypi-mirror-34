...
from spell.cli.utils import HiddenOption, tabulate_rows, prettify_size
...
@click.command(name="stats",
               short_help="Display performance statistics for a run")
...
def stats(ctx, run_id, raw, follow):
    ...
    client = RunsClient(owner=username, token=token, **ctx.obj["client_args"])
