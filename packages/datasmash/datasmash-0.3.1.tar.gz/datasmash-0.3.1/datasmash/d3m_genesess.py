...
#         return Params(
#                 bin_path = self._bin_path = BIN_PATH,
#                 params['tmp_dir'] =self._tmp_dir = ''
#                 params['channel_dirs'] =self._channel_dirs = []
#                 params['selected_channels'] =self._selected_channels = set()
#                 params['detrending'] = self._detrending = False
#                 params['inplace'] =self._inplace = True
#                 params['channel_probabilities'] =self._channel_probabilities = {}
#                 params['channel_predictions'] =self._channel_predictions = {}
#                 params['fitted'] =self._fitted = False
#                 params['channels'] = self._channels = None)
    
#                     self._channel_partition_map = {}###
        return None

    def set_params(self, *, params: Params) -> None:
#         self._bin_path = params['bin_path'] = self._bin_path = BIN_PATH
#         self._channel_partition_map = {}###
#         self._cwd = os.getcwd()
#         self._d3m_reader = params['d3m_reader'] =self._d3m_reader = D3MDatasetLoader()
#         self._tmp_dir = params['tmp_dir'] =self._tmp_dir = ''
#         self._channel_dirs = params['channel_dirs'] =self._channel_dirs = []
#         self._selected_channels = params['selected_channels'] =self._selected_channels = set()
#         self._detrending = params['detrending'] = self._detrending = False
#         self._inplace = params['inplace'] =self._inplace = True
#         self._channel_probabilities = params['channel_probabilities'] =self._channel_probabilities = {}
#         self._channel_predictions = params['channel_predictions'] =self._channel_predictions = {}
#         self._fitted = params['fitted'] =self._fitted = False
...
#         self._channels = params['channels'] 
    ...
    def __getstate__(self) -> dict:
        ...
        state = dict()      
        state['constructor'] = {name: value for name, value in standard_arguments.items()}
        state['__dict__'] = self.__dict__
        return state

    def __setstate__(self, state: dict) -> None:
        self.__dict__ = state['__dict__']
        self.hyperparams = state['constructor']['hyperparams']       
        self.random_seed = state['constructor']['random_seed']
        self.docker_containers = state['constructor']['docker_containers']       
        self.volumes = state['constructor']['volumes']
