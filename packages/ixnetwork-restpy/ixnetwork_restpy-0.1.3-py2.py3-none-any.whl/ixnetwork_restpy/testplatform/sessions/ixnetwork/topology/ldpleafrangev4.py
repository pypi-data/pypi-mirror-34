...
class LdpLeafRangeV4(Base):
	...
	def LdpTLVList(self, DescriptiveName=None, Name=None):
	...
	def ActivateLeafRange(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./ldpLeafRangeV4 object references
