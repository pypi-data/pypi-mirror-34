...
from .templates import build_user_command
...
class InvocationDocker:
    ...
    async def decrypt_data(self):
        ...
        try:
            ...
            for k, v in self.secured_data['docker'].items():
                await self.log_cb(f'Adding docker login ofr  env: {k}')
    ...
    def __init__(self, **kwargs):
        ...
        self.command_parts = {
            ...
            'mali_data_b64': self.active_config.general.mali_data,
            'mali_file_name': self.active_config.general.mali_path
        }
        # updates
