...
class InstanceV(DockerV):
    ...
    def db_config(self):
        ...
        res = {
            'db_host': instance_cfg.get('db_host') or env_vars.get('db_host') or '127.0.0.1',
            'db_port': instance_cfg.get('db_port') or env_vars.get('db_port') or 5432,
            'db_user': instance_cfg.get('db_user') or env_vars.get('db_user') or 'odoo',
            'db_password': (instance_cfg.get('db_password') or
                            env_vars.get('db_password') or 'odoo'),
        }
