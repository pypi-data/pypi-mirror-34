...
class JemuSudo(JemuMemPeripheral):
    ...
    _VALUE = "value"
    _TIMER_ID = "timer_id"
    _GDB_CLIENT_CONNECTED = "gdb_client_connected_event"
    ...
    def __init__(self, jemu_connection, id, peripheral_type, gdb_mode):
        ...
        self._client_connect_event = threading.Event()
    ...
    def run_for_ns(self, nanoseconds):
        ...
        if (self._gdb_mode):
            self._client_connect_event.wait()
    ...
    def _receive_packet(self, jemu_packet):
        if self._DESCRIPTION in jemu_packet:
            ...
            elif jemu_packet[self._DESCRIPTION] == self._GDB_CLIENT_CONNECTED:
                self._client_connect_event.set()
