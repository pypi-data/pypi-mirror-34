...
T_AVAILABLE_UNION = TypeVar(u'T_AVAILABLE_UNION')


class PotentialImplementation(Generic[T_AVAILABLE_UNION]):
    u"""For values that may or may not implement an interface / feature, but can
    ...
    def try_cast_to(self,
        ...
        u"""Turns this value into the desired type, if possible.
