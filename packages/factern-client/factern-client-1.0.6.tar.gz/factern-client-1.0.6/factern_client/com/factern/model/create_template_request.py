...
class CreateTemplateRequest(get_parent()):
    ...
    def compute_parent_updates():
        ...
        CreateTemplateRequest.swagger_types.update(get_parent().swagger_types)
        CreateTemplateRequest.attribute_map.update(get_parent().attribute_map)
    ...
    def __init__(self, **kwargs):  # noqa: E501
        ...
        for k in kwargs:
            if k not in self.swagger_types:
                raise ValueError("CreateTemplateRequest got unexpected argument '%s'" % k)
        ...
        if "member_ids" not in kwargs:
            raise ValueError("CreateTemplateRequest missing required argument: member_ids")
