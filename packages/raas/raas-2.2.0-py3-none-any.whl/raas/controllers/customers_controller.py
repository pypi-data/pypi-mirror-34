...
"""
    raas.controllers.customers_controller
...
class CustomersController(BaseController):
    ...
    def create_customer(self,
        ...
        try:
            ...
            self.logger.info('Validating response for create_customer.')
    ...
    def get_all_customers(self):
        ...
        try:
            ...
            # Endpoint and global error handling using HTTP status codes.
            self.logger.info('Validating response for get_all_customers.')
            if _context.response.status_code == 0:
                raise RaasGenericException('API Error', _context)
            self.validate_response(_context)
    ...
    def get_customer(self,
        ...
        try:
            ...
            # Endpoint and global error handling using HTTP status codes.
            self.logger.info('Validating response for get_customer.')
            if _context.response.status_code == 0:
                raise RaasGenericException('API Error', _context)
            self.validate_response(_context)
