...
#define SBK_QTNETWORK_QLIST_QDNSDOMAINNAMERECORD_IDX                 14 // QList<QDnsDomainNameRecord >
#define SBK_QTNETWORK_QLIST_QOBJECTPTR_IDX                           15 // const QList<QObject* > &
#define SBK_QTNETWORK_QLIST_QDNSHOSTADDRESSRECORD_IDX                16 // QList<QDnsHostAddressRecord >
#define SBK_QTNETWORK_QLIST_QDNSMAILEXCHANGERECORD_IDX               17 // QList<QDnsMailExchangeRecord >
#define SBK_QTNETWORK_QLIST_QDNSSERVICERECORD_IDX                    18 // QList<QDnsServiceRecord >
#define SBK_QTNETWORK_QLIST_QDNSTEXTRECORD_IDX                       19 // QList<QDnsTextRecord >
#define SBK_QTNETWORK_QLIST_QNETWORKCOOKIE_IDX                       20 // QList<QNetworkCookie >
#define SBK_QTNETWORK_QVECTOR_QHSTSPOLICY_IDX                        21 // const QVector<QHstsPolicy > &
#define SBK_QTNETWORK_QLIST_QSSLERROR_IDX                            22 // const QList<QSslError > &
