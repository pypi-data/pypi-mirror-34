...
def _init_from_environ_property():
    import os
    ...
    if "eureka.cloud.service-url.defaultZone" in environs:
        config.eureka_default_zone = environs["eureka.cloud.service-url.defaultZone"]
        log.info(f"从系统环境变量中获取到eureka.cloud.service-url.defaultZone:{config.eureka_default_zone}")
