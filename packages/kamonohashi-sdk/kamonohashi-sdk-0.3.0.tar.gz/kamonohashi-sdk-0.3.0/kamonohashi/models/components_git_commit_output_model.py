...
class ComponentsGitCommitOutputModel(object):
    ...
    def __init__(self, branch=None, commit_id=None, owner=None, repository=None, url=None):  # noqa: E501
    ...
    def branch(self):
        ...
        ブランチ名。指定しない場合はmasterになる。  Nssol.Platypus.ApiModels.Components.GitCommitInputModel.CommitIdを指定した場合は無視される。  # noqa: E501
    ...
    def commit_id(self):
        ...
        コミットID。指定しない場合はNssol.Platypus.ApiModels.Components.GitCommitInputModel.BranchのHEADコミットになる。  # noqa: E501
