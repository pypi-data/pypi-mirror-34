...
class DataWatch(object):
    ...
    will be a :class:`~kazoo_sasl.protocol.states.WatchedEvent`. It will
    ...
    def __init__(self, client, path, func=None, *args, **kwargs):
        ...
        :type client: :class:`~kazoo_sasl.client.KazooClient`
        ...
        :param func: Function to call initially and every time the
                     ...
                     :class:`~kazoo_sasl.client.ZnodeStat` instance.
        :type func: callable
...
class ChildrenWatch(object):
    ...
    Otherwise it's a :class:`~kazoo_sasl.prototype.state.WatchedEvent`
    instance.
...
class PatientChildrenWatch(object):
    ...
    .. note::
        ...
        :class:`~kazoo_sasl.interfaces.IAsyncResult` object that can be
    ...
    def start(self):
        ...
        :returns: An :class:`~kazoo_sasl.interfaces.IAsyncResult` instance
