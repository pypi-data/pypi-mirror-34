...
def get_params(global_params):
    ...
    params['prereq_tasks'].append("test_normal_c")
...
def task_setup(global_params):
    ...
    logger.info("execute setup normal d")
...
def task_main(global_params):
    ...
    logger.info("execute task_main normal d")
    result = "Passed"
    ...
    for i in range(0, global_params['iterations']):
        logger.debug("normal_d loop %s", i)
...
def test_teardown(global_params):
    ...
    logger.info("execute teardown normal d")
