...
ios_cmd_build = 'xcodebuild -project @{ROOT}/proj.ios/@{XCODEPROJECT}.xcodeproj archive -archivePath @{XCODEPROJECT}.xcarchive -scheme @{SCHEME} -allowProvisioningUpdates'
