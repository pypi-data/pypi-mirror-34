...
What's New
----------
**1.0.0** - Esper is now using simple lru_caching internally by default.
            The cache is currently flushed when adding or deleting Entities or Components from the
            World, Component queries are much faster otherwise. This will likely be improved in a
            Future version. In addition to caching, Esper now supports passing kwargs to Processors.
            Continuous Integration testing is now doing for Python 3.7.
