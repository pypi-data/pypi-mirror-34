...
if __name__ == '__main__':
	...
	swap   = cmdline.Option( 'swap',     1, type=( int ), container=None, min=1, doc='Number of physical frames per `World` update (NB: some back-ends and some operating systems may not support anything other than 1).' )
