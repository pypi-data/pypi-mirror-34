...
"""
    raascontrollers.base_controller
...
from ..exceptions.raas_client_exception import RaasClientException
from ..exceptions.raas_generic_exception import RaasGenericException
from ..exceptions.raas_server_exception import RaasServerException
...
class BaseController(object):
    ...
    def validate_response(self, context):
        ...
        if context.response.status_code == 400:
            raise RaasClientException('Bad Request', context)
            ...
            raise RaasServerException('Service Unavailable - Retry Later', context)
