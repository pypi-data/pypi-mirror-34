...
def components_microstate(cont_set: VennSet[State], rxncon_system: RxnConSystem) -> Dict[Spec, VennSet[State]]:
    ...
    for comp, states in comp_to_states.items():
        ...
        def state_to_locus(state: State) -> Locus:
            print('state_to_locus (state, locus):', state, '->', state.specs[0], '->', state.specs[0].locus)
            print('name: ',state.specs[0].name, state.specs[0].struct_index)
            print(comp.name, comp.struct_index)
        ...
        print('complement_states: ', complement_states)
        ...
        print('comp_constraint: ', comp_constraint)
        ...
        print('comp_constraint(after): ', comp_constraint)
