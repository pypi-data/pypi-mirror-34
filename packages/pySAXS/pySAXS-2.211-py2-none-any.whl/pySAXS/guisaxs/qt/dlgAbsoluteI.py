...
def getTheParameters(datasetname,parentwindow,referencedata=None,printout=None,workingdirectory=None):
            ...
            #print "reference has parameters ?"
                if parentwindow.data_dict.has_key(referencedata): #print "yes ", self.referencedata
...
def OnScalingSAXSApply(parentwindow,applyQ=False,applyI=True,dataname=None,parameters=None,backgroundname=None,referencedata=None):
        '''
