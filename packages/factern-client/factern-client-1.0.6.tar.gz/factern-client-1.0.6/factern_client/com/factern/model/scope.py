...
class Scope(get_parent()):
    ...
    def compute_parent_updates():
        ...
        Scope.swagger_types.update(get_parent().swagger_types)
        Scope.attribute_map.update(get_parent().attribute_map)
    ...
    def __init__(self, **kwargs):  # noqa: E501
        ...
        for k in kwargs:
            if k not in self.swagger_types:
                raise ValueError("Scope got unexpected argument '%s'" % k)
        ...
        if "member_ids" not in kwargs:
            raise ValueError("Scope missing required argument: member_ids")
        self._member_ids = kwargs["member_ids"]

        if "name" not in kwargs:
            raise ValueError("Scope missing required argument: name")
