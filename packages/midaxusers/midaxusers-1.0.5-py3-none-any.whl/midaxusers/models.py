...
from sqlalchemy import PrimaryKeyConstraint, UniqueConstraint, String, Integer, DateTime, Column, Boolean, CHAR, Sequence
...
class User(db.Model):
    ...
    uuid = Column(HybridUniqueIdentifier(), unique=True, index = True, default=uuid.uuid4)
