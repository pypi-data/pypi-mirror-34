...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeer, TypeAccountDaysTTL, TypeReportReason, TypeSecureCredentialsEncrypted, TypeInputNotifyPeer, TypeInputSecureValue, TypeInputPrivacyKey, TypeInputPeerNotifySettings, TypeSecureValueHash, TypeInputPrivacyRule, TypeBool, TypeSecureValueType
