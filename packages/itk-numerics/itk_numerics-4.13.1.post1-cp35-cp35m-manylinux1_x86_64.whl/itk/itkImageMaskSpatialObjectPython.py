...
class itkImageMaskSpatialObject2(itkImageSpatialObjectPython.itkImageSpatialObject2UC):
    ...
    IsInside() method. One of the common uses of this class is to serve as
    Mask for the Image Registration Metrics.
    ...
    def IsInside(self, *args) -> "bool":
        """
        IsInside(itkImageMaskSpatialObject2 self, itkPointD2 point, unsigned int depth, char * name) -> bool
        IsInside(itkImageMaskSpatialObject2 self, itkPointD2 point) -> bool
    ...
    def GetAxisAlignedBoundingBoxRegion(self) -> "itkImageRegion2":
        ...
        Compute axis aligned bounding box from the image mask. The bounding
        box is returned as an image region. Each call to this function will
        recompute the region. This function is useful in cases, where you may
        have a mask image resulting from say a segmentation and you want to
        get the smallest box region that encapsulates the mask image.
        Currently this is done only for 3D volumes. 
        """
    ...
    def GetPointer(self) -> "itkImageMaskSpatialObject2 *":
        """GetPointer(itkImageMaskSpatialObject2 self) -> itkImageMaskSpatialObject2"""
...
class itkImageMaskSpatialObject3(itkImageSpatialObjectPython.itkImageSpatialObject3UC):
    ...
    def IsInside(self, *args) -> "bool":
        """
        IsInside(itkImageMaskSpatialObject3 self, itkPointD3 point, unsigned int depth, char * name) -> bool
        IsInside(itkImageMaskSpatialObject3 self, itkPointD3 point) -> bool
    ...
    def GetPointer(self) -> "itkImageMaskSpatialObject3 *":
        """GetPointer(itkImageMaskSpatialObject3 self) -> itkImageMaskSpatialObject3"""
