...
class CameraList(object):
    ...
    def append(self, name: 'char const *', value: 'char const *') -> "void":
        """
        append(CameraList self, char const * name, char const * value)
    ...
    def find_by_name(self, index: 'int *', name: 'char const *') -> "void":
        """
        find_by_name(CameraList self, int * index, char const * name)
    ...
    def get_name(self, index: 'int') -> "void":
        """
        get_name(CameraList self, int index)
    ...
    def get_value(self, index: 'int') -> "void":
        """
        get_value(CameraList self, int index)
    ...
    def set_name(self, index: 'int', name: 'char const *') -> "void":
        """
        set_name(CameraList self, int index, char const * name)
    ...
    def set_value(self, index: 'int', value: 'char const *') -> "void":
        """
        set_value(CameraList self, int index, char const * value)
    ...
    def populate(self, format: 'char const *', count: 'int') -> "void":
        """
        populate(CameraList self, char const * format, int count)
    ...
    def __init__(self):
        """__init__(_CameraList self) -> CameraList"""
