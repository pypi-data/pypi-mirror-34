...
class itkPlaneSpatialObject2(itkSpatialObjectBasePython.itkSpatialObject2):
    ...
    A plane spatial object is defined by two pointsWiki Examples:

    All Examples

    https://www.itk.org/Wiki/ITK/Examples/SpatialObjects/PlaneSpatialObjec
    t Plane spatial object

    C++ includes: itkPlaneSpatialObject.h 
    """
