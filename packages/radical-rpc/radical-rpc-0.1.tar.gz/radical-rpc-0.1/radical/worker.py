...
def main():  # pragma: no cover
    ...
    sys.stderr.write('Radical RPC server starting\n\n')
    sys.stderr.write(f'  Transport URL:     {args["transport_url"]}\n')
    sys.stderr.write(f'  Queue name:        {args["queue_name"]}\n')
    sys.stderr.write(f'  Transport class:   {args["transport"]}\n')
    sys.stderr.write(f'  Serializer:        {args["serializer"]}\n')
    sys.stderr.write(f'\n')
    if len(methods):
        sys.stderr.write('Methods provided:\n\n')
