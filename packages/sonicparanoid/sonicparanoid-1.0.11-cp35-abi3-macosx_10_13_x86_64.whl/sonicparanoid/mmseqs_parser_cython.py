...
def main():
    ...
    #mmseqs_parser_c.mmseqs_parser(inputPath, queryPath, targetPath, outDir=outDir, outName=outName, scoreCoff=cutoff, debug=debug)
    # Takes alignments with convertalis format 0 and output 9 fields (not the final segment locations)
    ...
    # This has problems at present
    #mmseqs_parser_c.mmseqs_parser_convertalis_format_2_NNEDS_FIX(inputPath, outDir=outDir, outName=outName, scoreCoff=cutoff, debug=debug)
