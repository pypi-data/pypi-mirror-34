...
class RethinkDBFilterQueryParser(BaseFilterQueryParser[R.RqlQuery]):
    ...
    def process_simple_statement(self, db_query: R.RqlQuery, simple_statement: QueryBinaryFilterStatement) -> R.RqlQuery:
    ...
    def index_bounds(self, statements: Iterable[QueryBinaryFilterStatement]):
        right_close = None
        left_close = None
        bound_statements = [
    ...
    def process_complicated_statement(self, db_query: R.RqlQuery, statement: QueryBinaryFilterStatement) -> R.RqlQuery:
