...
_FEATURENAMESTATISTICS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='tensorflow.metadata.v0.FeatureNameStatistics.type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_stats', full_name='tensorflow.metadata.v0.FeatureNameStatistics.num_stats', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='string_stats', full_name='tensorflow.metadata.v0.FeatureNameStatistics.string_stats', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bytes_stats', full_name='tensorflow.metadata.v0.FeatureNameStatistics.bytes_stats', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='struct_stats', full_name='tensorflow.metadata.v0.FeatureNameStatistics.struct_stats', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_stats', full_name='tensorflow.metadata.v0.FeatureNameStatistics.custom_stats', index=6,
...
_STRUCTSTATISTICS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='common_statistics', full_name='tensorflow.metadata.v0.StructStatistics.common_statistics', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STRUCTSTATISTICS.fields_by_name['common_statistics'].message_type = _COMMONSTATISTICS
