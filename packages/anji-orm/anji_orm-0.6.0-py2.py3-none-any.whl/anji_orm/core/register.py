...
__all__ = [
    ...
    'AbstractSyncRegisterStrategy', 'AbstractBackendAdapter', 'SharedEnv'
]
...
class ORMRegister(object):
    ...
    def current_datetime(self) -> datetime:
        return self.backend_adapter.now()

    def current_utc_datetime(self) -> datetime:
        return self.backend_adapter.utcnow()

    def ensure_compatibility(self, value: Any) -> Any:
        return self.backend_adapter.ensure_compatibility(value)
