...
class itkHoughTransform2DLinesImageFilterFF(itkImageToImageFilterAPython.itkImageToImageFilterIF2IF2):
    ...
    represents the distance R from the corner to the line -The second
    dimension (Y) represents the angle between the X axis and the normal
    to the line.
    ...
    def SetAngleResolution(self, _arg: 'float const') -> "void":
        ...
        Set the
        resolution angle: The hough space descibes (in the angle direction)
        [-PI,PI[ with a constant stepe AngleResolution 
        """
    ...
    def GetLines(self, *args) -> "std::list< itkLineSpatialObject2_Pointer,std::allocator< itkLineSpatialObject2_Pointer > > &":
        """
        ...
        GetLines(itkHoughTransform2DLinesImageFilterFF self, unsigned int n) -> std::list< itkLineSpatialObject2_Pointer,std::allocator< itkLineSpatialObject2_Pointer > > &

        Get the list of lines.
        This recomputes the lines 
        """
        return _itkHoughTransform2DLinesImageFilterPython.itkHoughTransform2DLinesImageFilterFF_GetLines(self, *args)
    ...
    def SetVariance(self, _arg: 'float const') -> "void":
        ...
        gaussian bluring for the accumulator 
        """
