...
Available events: """
    @_explicitize_args
    def __init__(self, id=None, message=None, submit_n_clicks=0, submit_n_clicks_timestamp=-1, cancel_n_clicks=0, cancel_n_clicks_timestamp=-1, displayed=None, **kwargs):
