...
namespace py cerebro.RecordService
...
enum TTypeId {
  ...
  // These types are not currently fully implemented but we support returning tables
  // with these types.
  ARRAY,
  MAP,
}
...
struct TSchema {
  // In order traversal of the schema.
...
enum TRecordFormat {
  ...
  //       Columnar: 5hello,4,world
  //       ColumnarNumPy: 5(undefined 4 bytes)4helloworld
  ColumnarNumPy,
}
