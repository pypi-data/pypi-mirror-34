    ...
    if next_plugin != None:
        ...
        while trying_to_ack:
            ...
            try:
                ...
                logger.info("MESSAGE INFO IS:-")
                logger.info("Message tools")
                logger.info(str(dir(message)))
                logger.info("Channel")
                logger.info(str(message.channel))
                logger.info(str(dir(message.channel)))
                logger.info("Is message channel open")
                logger.info(message.channel.is_open)
                logger.info("Is message channel active")
                logger.info(message.channel.active)
                logger.info("What is message channel name")
                logger.info(message.channel.channel_id)
                logger.info("properties")
                logger.info(str(message.properties))
                logger.info("headers")
                logger.info(str(message.headers))
                logger.info("Delivery tag")
                logger.info(str(message.delivery_tag))
                
                logger.info("Producer info:-")
                logger.info(str(dir(message.channel.Producer)))
                
                logger.info("Consumer info:-")
                logger.info(str(dir(message.channel.Consumer)))
                
                logger.info("Message connection info")
                logger.info(str(dir(message.channel.connection)))
                
                if message.channel.connection == None:
                    logger.info("Trying to force a connection")
                    message.channel.connection = conn
                else:
                
                    logger.info(message.channel.connection.is_open)
                
                #Try to set the message to connect via the connection
                
                
                logger.warning("ATTEMPTING TO REJECT THE MESSAGE")
