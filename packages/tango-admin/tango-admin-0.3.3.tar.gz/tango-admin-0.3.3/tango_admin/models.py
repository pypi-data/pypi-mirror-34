...
class Blacklist(models.Model):
    user = models.ForeignKey(UserModel, editable=False, on_delete="CASCADE")
    date = models.DateTimeField(auto_now_add=True)
    blacklister = models.ForeignKey(UserModel, editable=False, related_name="blacklister", on_delete="CASCADE")
