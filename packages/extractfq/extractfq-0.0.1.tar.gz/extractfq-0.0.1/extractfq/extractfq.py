...
def main():
	description = '''
Extract some fastq reads from the beginning of the files. Author: mengguanliang@foxmail.com. This script is part of the package `MitoZ`, when you use the script in your work, please cite: MitoZ: A toolkit for mitochondrial genome assembly, annotation and visualization with NGS data. Guangliang Meng, Yiyuan Li, Chentao Yang, Shanlin Liu (in manuscript)
	'''
