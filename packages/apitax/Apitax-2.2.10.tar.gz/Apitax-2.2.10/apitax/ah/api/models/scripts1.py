...
class Scripts1(Model):
    ...
    def __init__(self, script=None):  # noqa: E501
        """Scripts1 - a model defined in Swagger

        :param script: The script of this Scripts1.  # noqa: E501
        :type script: Script
        """
        self.swagger_types = {
            'script': Script
    ...
    @property
    def script(self):
        """Gets the script of this Scripts1.


        :return: The script of this Scripts1.
        :rtype: Script
        """
        return self._script
    ...
    def script(self, script):
        """Sets the script of this Scripts1.


        :param script: The script of this Scripts1.
        :type script: Script
        """
        if script is None:
