...
class itkBSplineTransformD23(itkBSplineBaseTransformPython.itkBSplineBaseTransformD23):
    ...
    * transform->SetTransformDomainDirection( direction ); *
    ...
    def GetPointer(self) -> "itkBSplineTransformD23 *":
        """GetPointer(itkBSplineTransformD23 self) -> itkBSplineTransformD23"""
        return _itkBSplineTransformPython.itkBSplineTransformD23_GetPointer(self)
...
itkBSplineTransformD23.GetPointer = new_instancemethod(_itkBSplineTransformPython.itkBSplineTransformD23_GetPointer, None, itkBSplineTransformD23)
