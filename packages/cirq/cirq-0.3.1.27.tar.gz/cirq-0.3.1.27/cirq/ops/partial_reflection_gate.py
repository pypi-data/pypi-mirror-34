...
class PartialReflectionGate(raw_types.Gate,
    ...
    u"""An interpolated reflection operation.
    ...
    def _with_half_turns(self,
        ...
        u"""Initialize an instance by specifying the number of half-turns."""
        pass
    ...
    def try_cast_to(self, desired_type, ext):
        if (desired_type in [gate_features.ExtrapolatableEffect,
            ...
            return self
        return super(PartialReflectionGate, self).try_cast_to(desired_type, ext)

    @abc.abstractmethod
    def _reflection_matrix(self):
        u"""The reflection matrix corresponding to half_turns=1."""
        pass
