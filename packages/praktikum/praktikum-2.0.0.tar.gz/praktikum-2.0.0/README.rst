...
(Grundpraktikum Physik). It also includes tools for passing data files
...
Please see the `homepage <http://accms04.physik.rwth-aachen.de/~praktapp/software/python/>`_.
