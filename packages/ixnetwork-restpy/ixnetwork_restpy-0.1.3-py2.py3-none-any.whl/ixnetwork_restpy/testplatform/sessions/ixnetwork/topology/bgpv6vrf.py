...
class BgpV6Vrf(Base):
	...
	def remove(self):
		"""Deletes a child instance of BgpV6Vrf on the server.
	...
	def RestartDown(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpV6Vrf object references
