...
class IUser(BaseEndpoint):
    ...
    def updateAccountType (self, uid , accountType ):
        ...
        __data__ = None
        postUri = postUri.replace("{uid}",uid);
        from netbluemind.directory.api.DirEntryAccountType import DirEntryAccountType
        from netbluemind.directory.api.DirEntryAccountType import __DirEntryAccountTypeSerDer__
        __data__ = __DirEntryAccountTypeSerDer__().encode(accountType)
