...
Available events: 'change'"""
    @_explicitize_args
    def __init__(self, id=None, start_date=None, end_date=None, min_date_allowed=None, max_date_allowed=None, initial_visible_month=None, start_date_placeholder_text=None, end_date_placeholder_text=None, day_size=39, calendar_orientation="Unparsable-JS-Object", is_RTL=False, reopen_calendar_on_clear=False, number_of_months_shown=1, with_portal=False, with_full_screen_portal=False, first_day_of_week="Unparsable-JS-Object", minimum_nights=None, stay_open_on_select=False, show_outside_days=None, month_format=None, display_format=None, disabled=False, clearable=False, updatemode="Unparsable-JS-Object", **kwargs):
