...
class itkNearestNeighborInterpolateImageFunctionIUS2D(itkInterpolateImageFunctionPython.itkInterpolateImageFunctionIUS2D):
    ...
    def GetPointer(self) -> "itkNearestNeighborInterpolateImageFunctionIUS2D *":
        """GetPointer(itkNearestNeighborInterpolateImageFunctionIUS2D self) -> itkNearestNeighborInterpolateImageFunctionIUS2D"""
...
class itkNearestNeighborInterpolateImageFunctionIUS3D(itkInterpolateImageFunctionPython.itkInterpolateImageFunctionIUS3D):
    ...
    def GetPointer(self) -> "itkNearestNeighborInterpolateImageFunctionIUS3D *":
        """GetPointer(itkNearestNeighborInterpolateImageFunctionIUS3D self) -> itkNearestNeighborInterpolateImageFunctionIUS3D"""
