...
class itkBSplineBaseTransformD23(itkTransformBasePython.itkTransformD22):
    ...
    def GetPointer(self) -> "itkBSplineBaseTransformD23 *":
        """GetPointer(itkBSplineBaseTransformD23 self) -> itkBSplineBaseTransformD23"""
        return _itkBSplineBaseTransformPython.itkBSplineBaseTransformD23_GetPointer(self)
...
itkBSplineBaseTransformD23.GetPointer = new_instancemethod(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD23_GetPointer, None, itkBSplineBaseTransformD23)
