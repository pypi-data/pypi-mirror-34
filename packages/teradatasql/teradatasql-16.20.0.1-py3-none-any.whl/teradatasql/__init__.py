    ...
    def __init__ (self, sConnectParams, **kwargs):
        ...
        try:
            ...
            if not bInitDone:
                ...
                prototype(None, goside.goCloseOrphanedConnections)
                ...
                atexit.register(goside.goCloseOrphanedConnections)
