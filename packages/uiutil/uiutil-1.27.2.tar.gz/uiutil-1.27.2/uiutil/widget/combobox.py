...
class Combobox(BaseWidget):
    ...
    def __init__(self,
        ...
        mousewheel = kwargs.get(u'mousewheel', False)
    ...
    def disable_mousewheel(self):
        ...
        # Windows and OSX
        self.widget.bind("<MouseWheel>", self.empty_scroll_command)

        # Linux and other *nix systems
        self.widget.bind("<ButtonPress-4>", self.empty_scroll_command)
        self.widget.bind("<ButtonPress-5>", self.empty_scroll_command)

    def empty_scroll_command(self,
                             _):
        return "break"