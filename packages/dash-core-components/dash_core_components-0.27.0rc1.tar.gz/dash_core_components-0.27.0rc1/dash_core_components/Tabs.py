...
Available events: """
    @_explicitize_args
    def __init__(self, children=None, id=None, value=None, className=None, content_className=None, parent_className=None, style=None, parent_style=None, content_style=None, vertical=None, mobile_breakpoint=800, colors={'border': '#d6d6d6', 'primary': '#1975FA', 'background': '#f9f9f9'}, **kwargs):
