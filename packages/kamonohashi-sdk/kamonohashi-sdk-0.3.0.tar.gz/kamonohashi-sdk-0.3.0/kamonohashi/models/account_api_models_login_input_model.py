...
class AccountApiModelsLoginInputModel(object):
    ...
    def __init__(self, expire_days=None, password=None, tenant_id=None, user_name=None):  # noqa: E501
    ...
    def expire_days(self):
        """Gets the expire_days of this AccountApiModelsLoginInputModel.  # noqa: E501

        有効期限(日数)。省略時はシステムの既定値。  # noqa: E501

        :return: The expire_days of this AccountApiModelsLoginInputModel.  # noqa: E501
        :rtype: int
        """
    ...
    def expire_days(self, expire_days):
        """Sets the expire_days of this AccountApiModelsLoginInputModel.

        有効期限(日数)。省略時はシステムの既定値。  # noqa: E501

        :param expire_days: The expire_days of this AccountApiModelsLoginInputModel.  # noqa: E501
        :type: int
        """
    ...
    def tenant_id(self):
        ...
        テナントID。省略時はデフォルトテナント。  # noqa: E501
