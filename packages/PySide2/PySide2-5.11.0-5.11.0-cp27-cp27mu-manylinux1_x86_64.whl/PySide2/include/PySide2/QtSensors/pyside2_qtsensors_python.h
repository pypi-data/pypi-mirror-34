...
#define SBK_QTSENSORS_QPAIR_INT_INT_IDX                              1 // QPair<int,int >
#define SBK_QTSENSORS_QLIST_QPAIR_INT_INT_IDX                        2 // QList<QPair< int,int > >
#define SBK_QTSENSORS_QLIST_QOBJECTPTR_IDX                           3 // const QList<QObject* > &
#define SBK_QTSENSORS_QLIST_QBYTEARRAY_IDX                           4 // QList<QByteArray >
