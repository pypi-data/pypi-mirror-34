...
#define SBK_QTCORE_QLIST_QABSTRACTTRANSITIONPTR_IDX                  35 // QList<QAbstractTransition* >
#define SBK_QTCORE_QSET_QABSTRACTSTATEPTR_IDX                        36 // QSet<QAbstractState* >
#define SBK_QTCORE_QLIST_QABSTRACTANIMATIONPTR_IDX                   37 // QList<QAbstractAnimation* >
#define SBK_QTCORE_QLIST_QABSTRACTSTATEPTR_IDX                       38 // const QList<QAbstractState* > &
...
#define SBK_QTCORE_QLIST_QURL_IDX                                    41 // const QList<QUrl > &
#define SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                          42 // const QHash<int,QByteArray > &
#define SBK_QTCORE_QMAP_INT_QVARIANT_IDX                             43 // QMap<int,QVariant >
#define SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX                   44 // const QList<QPersistentModelIndex > &
#define SBK_QTCORE_QLIST_QABSTRACTEVENTDISPATCHER_TIMERINFO_IDX      45 // QList<QAbstractEventDispatcher::TimerInfo >
