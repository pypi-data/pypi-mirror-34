...
class TestAIFunction(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.recommendation_model_path = os.path.join(os.getcwd(), 'artifacts', 'model_recommendation.tar.gz')
        self.area_model_path = os.path.join(os.getcwd(), 'artifacts', 'model_area.tar.gz')
    ...
    def test_02_create_ai_function(self):
        ...
        wml_credentials = {
            "username": "61261a0f-df08-4176-a559-5affc3016575",
            "password": "f0ec5f1d-ca3c-4d29-b61c-631a958aa190",
            "instance_id": "e094dca3-9e98-40b0-a084-521b01950dea",
        ...
        recommendation_model = client2.repository.load('357c06cd-5075-430e-9af7-d44e8bbe7fdf')
        area_model = client2.repository.load('b973ccfa-36e3-4631-af71-754ee0de1b74')

        # create model area
        area_model_details = self.client.repository.store_model(area_model, {
        ...
        # create model action
        recommendation_model_details = self.client.repository.store_model(recommendation_model, {
        ...
        def score_wrapper(
                wml_credentials=self.client.wml_credentials,
                modelver_area='ver1',
                scoring_url_area=area_scoring_url,
                modelver_action='ver2',
                scoring_url_action = recommendation_scoring_url
        ):
            def score(payload):
    ...
    def test_12_clean(self):
        ...
        self.client.repository.delete(TestAIFunction.area_deployment_uid)
        self.client.repository.delete(TestAIFunction.recommendation_deployment_uid)
