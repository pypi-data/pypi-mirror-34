...
class Price(get_parent()):
    ...
    def compute_parent_updates():
        ...
        Price.swagger_types.update(get_parent().swagger_types)
        Price.attribute_map.update(get_parent().attribute_map)
    ...
    def __init__(self, **kwargs):  # noqa: E501
        ...
        for k in kwargs:
            if k not in self.swagger_types:
                raise ValueError("Price got unexpected argument '%s'" % k)
