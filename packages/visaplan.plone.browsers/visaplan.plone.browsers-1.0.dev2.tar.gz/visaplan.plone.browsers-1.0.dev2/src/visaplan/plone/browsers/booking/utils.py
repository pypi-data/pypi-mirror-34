...
from .exceptions import (UidNotfoundException, MixedVendorException,
        MixedCurrencyException, BookingProgrammingError,
        MissingValueError, MissingFallbackError,
        )
...
def sendMail(mail, mail_from, mail_to,
    ...
    message -- der message-Browser, zur Ausgabe einer Flash-Message
...
def article_dicts(uid, order, hub, info,  # ---- [ article_dicts ... [
    ...
    # pp(article_vat=article_vat, price_shop=price_shop, vat_percent=vat_percent)
    # set_trace()
