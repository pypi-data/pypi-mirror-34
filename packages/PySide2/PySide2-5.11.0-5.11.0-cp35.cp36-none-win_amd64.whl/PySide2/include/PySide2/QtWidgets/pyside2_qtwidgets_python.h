...
#define SBK_QTWIDGETS_QLIST_QACTIONPTR_IDX                           15 // QList<QAction* >
#define SBK_QTWIDGETS_QLIST_QSCROLLERPTR_IDX                         16 // QList<QScroller* >
#define SBK_QTWIDGETS_QLIST_QREAL_IDX                                17 // const QList<qreal > &
#define SBK_QTWIDGETS_QVECTOR_INT_IDX                                18 // QVector<int >
#define SBK_QTWIDGETS_QLIST_QUNDOSTACKPTR_IDX                        19 // QList<QUndoStack* >
#define SBK_QTWIDGETS_QLIST_QGRAPHICSWIDGETPTR_IDX                   20 // QList<QGraphicsWidget* >
#define SBK_QTWIDGETS_QLIST_QWIDGETPTR_IDX                           21 // QList<QWidget* >
#define SBK_QTWIDGETS_QLIST_QKEYSEQUENCE_IDX                         22 // const QList<QKeySequence > &
#define SBK_QTWIDGETS_QLIST_QABSTRACTBUTTONPTR_IDX                   23 // QList<QAbstractButton* >
...
#define SBK_QTWIDGETS_QLIST_QDOCKWIDGETPTR_IDX                       27 // const QList<QDockWidget* > &
#define SBK_QTWIDGETS_QLIST_QMDISUBWINDOWPTR_IDX                     28 // QList<QMdiSubWindow* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETITEMPTR_IDX                  29 // QList<QTableWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QTABLEWIDGETSELECTIONRANGE_IDX           30 // QList<QTableWidgetSelectionRange >
#define SBK_QTWIDGETS_QLIST_QLISTWIDGETITEMPTR_IDX                   31 // QList<QListWidgetItem* >
#define SBK_QTWIDGETS_QLIST_QWINDOWPTR_IDX                           32 // QList<QWindow* >
#define SBK_QTWIDGETS_QLIST_QSCREENPTR_IDX                           33 // QList<QScreen* >
#define SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                        34 // QPair<qreal,QPointF >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX                  35 // QList<QPair< qreal,QPointF > >
#define SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                          36 // QPair<qreal,qreal >
#define SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                    37 // QList<QPair< qreal,qreal > >
#define SBK_QTWIDGETS_QLIST_QRECTF_IDX                               38 // const QList<QRectF > &
#define SBK_QTWIDGETS_QLIST_QGRAPHICSVIEWPTR_IDX                     39 // QList<QGraphicsView* >
#define SBK_QTWIDGETS_QHASH_INT_QBYTEARRAY_IDX                       40 // const QHash<int,QByteArray > &
#define SBK_QTWIDGETS_QMAP_INT_QVARIANT_IDX                          41 // QMap<int,QVariant >
#define SBK_QTWIDGETS_QLIST_QPERSISTENTMODELINDEX_IDX                42 // const QList<QPersistentModelIndex > &
#define SBK_QTWIDGETS_QLIST_QABSTRACTANIMATIONPTR_IDX                43 // QList<QAbstractAnimation* >
#define SBK_QTWIDGETS_QLIST_QABSTRACTSTATEPTR_IDX                    44 // const QList<QAbstractState* > &
