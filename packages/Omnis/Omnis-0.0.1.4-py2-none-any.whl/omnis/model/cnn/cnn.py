...
class CNN:
    ...
    def save(self, model_path, class_dictionary_path = None):
        ...
        Keyword Arguments:
            class_dictionary_path {str or None} --
                If a model is trained with image data(when self.is_image_data is True) and class_dictionary_path is specified,
    ...
    def load(self, model_path, class_dictionary_path = None):
        ...
        Keyword Arguments:
            class_dictionary_path {str or None} -- Path of saved classed_dictionary (default: {None})
