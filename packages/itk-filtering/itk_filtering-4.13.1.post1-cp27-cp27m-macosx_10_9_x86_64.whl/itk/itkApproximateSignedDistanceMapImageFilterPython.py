...
def itkApproximateSignedDistanceMapImageFilterIF2IF2_cast(obj):
...
def itkApproximateSignedDistanceMapImageFilterIF3IF3_cast(obj):
...
def itkApproximateSignedDistanceMapImageFilterISS2ISS2___New_orig__():
...
def itkApproximateSignedDistanceMapImageFilterISS2ISS2_cast(obj):
...
def itkApproximateSignedDistanceMapImageFilterISS3ISS3___New_orig__():
...
def itkApproximateSignedDistanceMapImageFilterISS3ISS3_cast(obj):
