...
Available events: 'blur', 'change'"""
    @_explicitize_args
    def __init__(self, id=None, value=None, style=None, className=None, type=None, autocomplete=None, autofocus=None, disabled=None, inputmode=None, list=None, max=None, maxlength=None, min=None, minlength=None, multiple=None, name=None, pattern=None, placeholder=None, readonly=None, required=None, selectionDirection=None, selectionEnd=None, selectionStart=None, size=None, spellcheck=None, step=None, **kwargs):
