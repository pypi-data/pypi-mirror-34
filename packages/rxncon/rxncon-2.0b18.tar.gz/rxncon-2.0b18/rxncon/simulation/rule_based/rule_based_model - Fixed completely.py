...
def components_microstate(cont_set: VennSet[State], rxncon_system: RxnConSystem) -> Dict[Spec, VennSet[State]]:
    ...
    for comp, states in comp_to_states.items():
        ...
        for state in states:
            """must add structure to complements of unbound domains"""
            print('complement: ',rxncon_system.complement_states_for_component(comp, state))
            print()
