...
install_requires = \
['django-model-utils>=2.6,<3.0', 'djangorestframework>=3.5.3,<3.6.0']

extras_require = \
{'email_invoice': ['premailer>=3.0.1,<4.0.0'],
 'starshipit': ['requests>=2.13.0,<3.0.0'],
 'stripe': ['stripe>=1.44.0,<2.0.0']}
