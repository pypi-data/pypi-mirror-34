...
PAYLOAD_LOGGING_HREF_PATTERN = u'{}/v3/wml_instances/{}/published_models/{}/deployments/{}/payload_logging_configuration'
...
RUNTIME_SPEC_HREF_PATTERN = u'{}/v4/runtimes/{}'
RUNTIME_SPECS_HREF_PATTERN = u'{}/v4/runtimes'
...
class HrefDefinitions:
    ...
    def get_payload_logging_href(self, model_uid, deployment_uid):
        return PAYLOAD_LOGGING_HREF_PATTERN.format(self._wml_credentials['url'], self._wml_credentials['instance_id'], model_uid, deployment_uid)
    ...
    def get_runtime_spec_href(self, runtime_uid):
        return RUNTIME_SPEC_HREF_PATTERN.format(self._wml_credentials['url'], runtime_uid)

    def get_runtime_specs_href(self):
        return RUNTIME_SPECS_HREF_PATTERN.format(self._wml_credentials['url'])
