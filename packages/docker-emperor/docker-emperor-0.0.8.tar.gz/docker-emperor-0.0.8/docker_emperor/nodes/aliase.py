    ...
    def __init__(self, data):
        ...
        for key, val in self.items(): 
            if isinstance(val, list):
                self[key] = Aliase_list(key, val)
            else:
                self[key] = Aliase_str(key, val)
...
class Aliase_str(Aliase, str):
    ...
    def __init__(self, name, data, *args, **kwargs):
        self.name = name
        self.data = data
        super(Aliase_str, self).__init__(data)
...
class Aliase_list(Aliase, list):
    ...
    def __init__(self, name, data, *args, **kwargs):
        self.name = name
        self.data = data
        super(Aliase_list, self).__init__(data)
