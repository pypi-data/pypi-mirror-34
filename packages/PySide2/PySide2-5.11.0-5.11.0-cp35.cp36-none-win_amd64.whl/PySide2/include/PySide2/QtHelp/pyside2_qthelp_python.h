...
#define SBK_QTHELP_QVECTOR_QHELPSEARCHRESULT_IDX                     8 // QVector<QHelpSearchResult >
#define SBK_QTHELP_QVECTOR_INT_IDX                                   9 // const QVector<int > &
...
#define SBK_QTHELP_QLIST_QACTIONPTR_IDX                              13 // QList<QAction* >
#define SBK_QTHELP_QLIST_QWIDGETPTR_IDX                              14 // QList<QWidget* >
