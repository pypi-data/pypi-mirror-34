...
_MPSOLUTIONRESPONSE.fields_by_name['reduced_cost'].has_options = True
_MPSOLUTIONRESPONSE.fields_by_name['reduced_cost']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\020\001'))
