...
@account.command(help="Login to KAMONOHASHI system and generate a CLI's configuration file to ~/.kqi.config.")
@click.option('-s', '--server', prompt=True, confirmation_prompt=False,
