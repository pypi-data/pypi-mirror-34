...
class itkVTKImageIO(ITKIOImageBaseBasePython.itkStreamingImageIOBase):
    ...
    def GetPointer(self) -> "itkVTKImageIO *":
        """GetPointer(itkVTKImageIO self) -> itkVTKImageIO"""
        return _itkVTKImageIOPython.itkVTKImageIO_GetPointer(self)
...
itkVTKImageIO.GetPointer = new_instancemethod(_itkVTKImageIOPython.itkVTKImageIO_GetPointer, None, itkVTKImageIO)
...
class itkVTKImageIOFactory(ITKCommonBasePython.itkObjectFactoryBase):
    ...
    def GetPointer(self) -> "itkVTKImageIOFactory *":
        """GetPointer(itkVTKImageIOFactory self) -> itkVTKImageIOFactory"""
        return _itkVTKImageIOPython.itkVTKImageIOFactory_GetPointer(self)
...
itkVTKImageIOFactory.GetPointer = new_instancemethod(_itkVTKImageIOPython.itkVTKImageIOFactory_GetPointer, None, itkVTKImageIOFactory)
