...
def set_system_time(imet_device):
    ...
    if p_status !=0:
        ...
        sho_logger.info("Set system time: {}".format(output.decode("utf-8")))
        return 0
...
def find_devices():
    ...
    if p_status == 0:
        ...
        sho_logger.error("Error: couldn't access ports, most likely this is a permissions issue or no sensors are plugged in")
        return -1
