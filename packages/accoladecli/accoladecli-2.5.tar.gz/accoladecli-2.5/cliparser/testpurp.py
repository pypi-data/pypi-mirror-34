...
if which == 'upload':
    if args['replace']:
        try:
            ...
            s3client.upload_file(args['file'], 'accolade-platform-ext-dev-partners-577121982548','Hashed/' + username + addon)
...
def logdata():
    ...
    logdata = {'user': storedusername, 'date&time': formattedtime, 'filename': addon[1:], 'action': action}
