...
class TestWMLClientWithCaffe(unittest.TestCase):
    ...
    def test_08a_monitor(self):
        self.client.experiments.monitor_logs(TestWMLClientWithCaffe.experiment_run_uid)
    ...
    def test_16_create_deployment(self):
        ...
        deployment_details = self.client.deployments.create(asset_uid=TestWMLClientWithCaffe.trained_model_uid, name="Test deployment", asynchronous=False)
