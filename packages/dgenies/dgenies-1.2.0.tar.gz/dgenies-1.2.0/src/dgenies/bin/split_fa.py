...
def parse_args():
    ...
    parser.add_argument('-s', '--size', type=int, required=False, default=10000, help="Max size of contigs (Kb)")
...
def __main__():
    args = parse_args()
    splitter = Splitter(args.input, args.name, args.output, args.size * 1000)
