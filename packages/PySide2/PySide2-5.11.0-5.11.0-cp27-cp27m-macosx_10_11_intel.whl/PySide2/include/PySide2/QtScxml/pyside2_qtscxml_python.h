...
#define SBK_QTSCXML_QVECTOR_INT_IDX                                  1 // const QVector<int > &
#define SBK_QTSCXML_QVECTOR_QSCXMLEXECUTABLECONTENT_PARAMETERINFO_IDX 2 // const QVector<QScxmlExecutableContent::ParameterInfo > &
#define SBK_QTSCXML_QLIST_QOBJECTPTR_IDX                             3 // const QList<QObject* > &
#define SBK_QTSCXML_QLIST_QBYTEARRAY_IDX                             4 // QList<QByteArray >
#define SBK_QTSCXML_QVECTOR_QSCXMLINVOKABLESERVICEPTR_IDX            5 // QVector<QScxmlInvokableService* >
