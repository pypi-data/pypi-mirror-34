...
#--------------------------------------------------
def synthetic_images(data, nr, nc, apertures, nrnc_are_chunks=False):
    '''
...
def find_circ_centre(im, sigma, rmms, mask=None, plot=True, spf=1, low_threshold=0.1,
    ...
    details. The single best matching circle is returned.
...
def map_image_function(data, nr, nc, cyx=None, crop_r=None, func=None, params=None,
    ...
    # convert dtype from object to float if possible
    try:
        rdf = rd.ravel()
