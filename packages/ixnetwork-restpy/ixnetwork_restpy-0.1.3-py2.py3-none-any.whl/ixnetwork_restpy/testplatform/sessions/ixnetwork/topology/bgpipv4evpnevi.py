...
class BgpIPv4EvpnEvi(Base):
	...
	def remove(self):
		"""Deletes a child instance of BgpIPv4EvpnEvi on the server.
	...
	def AdvertiseAliasingPerEvi(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpIPv4EvpnEvi object references
