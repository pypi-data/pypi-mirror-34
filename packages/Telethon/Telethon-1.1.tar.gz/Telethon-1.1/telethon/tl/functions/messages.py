...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessageEntity, TypeInputStickerSet, TypeInputMedia, TypeReplyMarkup, TypeInputEncryptedChat, TypeBool, TypeInputPeer, TypeMessagesFilter, TypeInputUser, TypeInputDocument, TypeInputGeoPoint, TypeInputChatPhoto, TypeInputBotInlineResult, TypeSendMessageAction, TypeInputMessage, TypeShippingOption, TypeInputEncryptedFile, TypeReportReason, TypeInputStickeredMedia, TypeInputSingleMedia, TypeInlineBotSwitchPM, TypeInputDialogPeer, TypeInputBotInlineMessageID
