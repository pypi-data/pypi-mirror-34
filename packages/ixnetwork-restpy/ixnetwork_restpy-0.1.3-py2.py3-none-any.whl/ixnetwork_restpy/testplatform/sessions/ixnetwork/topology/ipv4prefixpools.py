...
class Ipv4PrefixPools(Base):
	...
	def remove(self):
		"""Deletes a child instance of Ipv4PrefixPools on the server.
	...
	def Start(self, Targets):
		...
		Args:
			Targets (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./ipv4PrefixPools object references
