...
class itkOffset1(object):
    ...
    https://www.itk.org/Wiki/ITK/Examples/SimpleOperations/Offset Add an
    offset to a pixel index
    ...
    def SetOffset(self, val: 'long const *') -> "void":
        """
