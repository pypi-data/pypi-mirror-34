...
config_file_path = os.path.expanduser('~/.kqi.config')
...
def create_api_client_base(config_file):
    ...
    api_client.rest_client.pool_manager.connection_pool_kw['timeout'] = urllib3.Timeout(config_file.get('timeout', 30))
