...
class VssManager(object):
    ...
    def get_user_ssh_key(self, key_id):
        ...
        """
        json = self.request_v2('/user/ssh-key/{id}'.format(id=key_id),
                               method='GET')
        return json.get('data')
    ...
    def create_user_ssh_key(self, public_key):
        ...
        json = self.request_v2('/user/ssh-key',
    ...
    def get_user_notification_settings(self):
        ...
        :return: object
        """
        json = self.request_v2('/user/setting/notification', method='GET')
        return json.get('data')
    ...
    def get_user_request_notification_settings(self):
        ...
        :return: object
        """
        json = self.request_v2('/user/setting/notification/request',
                               method='GET')
        return json.get('data')
    ...
    def get_user_notification_method(self):
        ...
        :return: object
        """
        json = self.request_v2('/user/setting/notification/method',
                               method='GET')
        return json.get('data')
    ...
    def update_user_notification_method(self, method):
        ...
        _json = self.request_v2('/user/setting/notification/method',
                                method='PUT',
                                payload=payload)
    ...
    def get_user_notification_format(self):
        ...
        :return:
        """
        json = self.request_v2('/user/setting/notification/format',
                               method='GET')
        return json.get('data')
    ...
    def update_user_notification_format(self, fmt):
        ...
        _json = self.request_v2('/user/setting/notification/format',
                                method='PUT',
                                payload=payload)
    ...
    def get_user_digest_settings(self):
        ...
        :return: object
        """
        json = self.request_v2('/user/setting/digest', method='GET')
        return json.get('data')
    ...
    def enable_user_message_digest(self):
        ...
        :return: updated email settings object
        """
        json = self.request_v2('/user/setting/digest/message',
                               method='PUT',
    ...
    def get_vm_disk_backing(self, uuid, disk):
        ...
        """
        json = self.request_v2('/vm/{uuid}/disk/{disk}/backing'.format(
            uuid=uuid, disk=disk))
        return json.get('data')
