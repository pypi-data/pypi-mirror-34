...
from clusterone.client_exceptions import WrongNumberOfGPUs, NoCommitsInProjectFound, NotebookCreationError, JobNotFound, ClusteroneException
...
try:
    ...
    # disabling all warnings better than worrying the users and breaking CLI
