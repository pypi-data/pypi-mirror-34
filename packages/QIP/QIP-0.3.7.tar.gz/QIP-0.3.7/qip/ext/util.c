...
#define __PYX_HAVE__qip__ext__util
#define __PYX_HAVE_API__qip__ext__util
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'qip.ext.util' */
#define __Pyx_MODULE_NAME "qip.ext.util"
extern int __pyx_module_is_main_qip__ext__util;
int __pyx_module_is_main_qip__ext__util = 0;

/* Implementation of 'qip.ext.util' */
...
static int __pyx_f_3qip_3ext_4util_entwine_bit(int __pyx_v_n_indices, int __pyx_v_n_non_indices, int __pyx_v_v_indices, int __pyx_v_v_non_indices, int __pyx_v_mask) {
  int __pyx_v_n;
  int __pyx_v_indices_mask;
  int __pyx_v_non_indices_mask;
  int __pyx_v_mask_mask;
  int __pyx_v_m;
  int __pyx_v_j;
  int __pyx_r;
  int __pyx_t_1;
 ...
 */
  __pyx_v_n = (__pyx_v_n_indices + __pyx_v_n_non_indices);
 ...
 */
  __pyx_v_indices_mask = (1 << (__pyx_v_n_indices - 1));
 ...
 *     cdef int m = 0
 */
  __pyx_v_non_indices_mask = (1 << (__pyx_v_n_non_indices - 1));
 ...
 *     cdef int j
 */
  __pyx_v_mask_mask = (1 << (__pyx_v_n - 1));
 ...
 */
    __pyx_t_3 = (((__pyx_v_mask & __pyx_v_mask_mask) >> ((__pyx_v_n - 1) - __pyx_v_j)) != 0);
    if (__pyx_t_3) {
 ...
 *         else:
 */
      __pyx_v_m = (__pyx_v_m + ((__pyx_v_v_indices & __pyx_v_indices_mask) >> __pyx_v_n_indices));
 ...
 *             n_non_indices -= 1
 */
      __pyx_v_indices_mask = (__pyx_v_indices_mask >> 1);
 ...
 */
    /*else*/ {
      __pyx_v_n_non_indices = (__pyx_v_n_non_indices - 1);
 ...
 */
      __pyx_v_m = (__pyx_v_m + ((__pyx_v_v_non_indices & __pyx_v_non_indices_mask) >> __pyx_v_n_non_indices));
 ...
 *     return m
 */
      __pyx_v_non_indices_mask = (__pyx_v_non_indices_mask >> 1);
    }
    __pyx_L5:;
 ...
 * 
 */
    __pyx_v_mask_mask = (__pyx_v_mask_mask >> 1);
  }
...
static int __pyx_f_3qip_3ext_4util_set_bit(int __pyx_v_num, int __pyx_v_bit_index, int __pyx_v_value) {
  int __pyx_r;
 ...
 * 
 */
  __pyx_r = (__pyx_v_num ^ (((-(__pyx_v_value != 0)) ^ __pyx_v_num) & (1 << __pyx_v_bit_index)));
  goto __pyx_L0;
...
static int __pyx_f_3qip_3ext_4util_get_bit(int __pyx_v_num, int __pyx_v_bit_index) {
  int __pyx_r;
 ...
 *     return (num >> bit_index) & 1             # <<<<<<<<<<<<<<
 */
  __pyx_r = ((__pyx_v_num >> __pyx_v_bit_index) & 1);
  goto __pyx_L0;
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_qip__ext__util) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "qip.ext.util")) {
      if (unlikely(PyDict_SetItemString(modules, "qip.ext.util", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("entwine_bit", (void (*)(void))__pyx_f_3qip_3ext_4util_entwine_bit, "int (int, int, int, int, int)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ExportFunction("set_bit", (void (*)(void))__pyx_f_3qip_3ext_4util_set_bit, "int (int, int, int)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  if (__Pyx_ExportFunction("get_bit", (void (*)(void))__pyx_f_3qip_3ext_4util_get_bit, "int (int, int)") < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  /*--- Type init code ---*/
  /*--- Type import code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init qip.ext.util", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init qip.ext.util");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
