...
This code was translated into python from matlab by Quinn MacPherson in 2017.
"""



import numpy as np
from utils import sphinx_compat_jit as jit
...
def InvGprimeGeneral(p,lam,lam0,mu,K,jp,jm,djp,djm,d=3):
    ...
    because :math:`X_1=0` at the poles, :math:`\partial_p X^\left{ \pm \\right}` does not generally diverge at the poles.
...
common_params = {'lam':'(int): l total angular momentum enignvalue for orientation',
                 'lam1':'(int): l total angular momentum enignvalue for orientation',
                 'lam2':'(int): l total angular momentum enignvalue for orientation',
                 'l':'(int): eignenvalue index',
                 'mu':'(int): m z-component of angular momentum for orientation',
