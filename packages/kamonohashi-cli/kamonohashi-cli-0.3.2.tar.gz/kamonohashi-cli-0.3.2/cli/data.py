...
@click.option('-f', '--file', type=click.Path(exists=True, dir_okay=False), required=True, multiple=True, help='A file path you want to upload')
...
@click.pass_obj
def download_file(api, id, destination):
    """
    :param kamonohashi.DataApi api:
    """
