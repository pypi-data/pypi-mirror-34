...
rs_setup_url = "https://raw.githubusercontent.com/radical-cybertools/radical.synapse/feature/named_storage/bin/radical-synapse-setup.sh"
...
if __name__ == '__main__':
    ...
    try:
      ...
      # scheduler = rp.umgr.scheduler.SCHEDULER_ROUND_ROBIN
        ...
        for unit in units:
            report.plain('  * %s: %s, %5s' \
                        % (unit.uid, unit.state[:4], unit.stdout))
