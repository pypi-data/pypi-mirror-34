...
class SegmentedDPC:    
    def __init__(self, ds, path=None, ext='dm3', alpha=None, 
        ...
        ds : string or ndarray
            ...
            detector signals in order of inner 0->3, outer 0->3.
        path : string
            Directory containing data. CWD if None.
        ext : string
            DM file extension.
        alpha : scalar
            Semi-convergence angle in mrad.
            Taken as 1.0 if None.
        scan_deg : scalar
