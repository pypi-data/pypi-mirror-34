`Build Status <https://travis-ci.org/coursera-dl/edx-dl>`__ `Coverage
Status <https://coveralls.io/github/coursera-dl/edx-dl?branch=master>`__
`Code Climate <https://codeclimate.com/github/coursera-dl/edx-dl>`__
`PyPI version <https://badge.fury.io/py/edx-dl>`__
