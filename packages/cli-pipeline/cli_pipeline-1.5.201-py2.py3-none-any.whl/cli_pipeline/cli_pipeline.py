...
#        print(response)
        ...
        print('Navigate to "https://%s" to Optimize and Deploy the Model into Live Production.' % (host))
        print('')
...
def _cluster_kube_delete(tag,
    ...
    cmd = """
# Certs
kubectl apply -f /root/product/yaml/certs/cloud-pipeline-ai-secret.yaml
kubectl apply -f /root/product/yaml/certs/tls-secret.yaml
...
kubectl create -f /root/product/yaml/dashboard/kubernetes-dashboard-1.8.3.yaml
