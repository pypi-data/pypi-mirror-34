...
#define SWIGTYPE_p_f_p_struct__GPContext_float_p_q_const__char_va_list_p_void__unsigned_int swig_types[44]
#define SWIGTYPE_p_f_p_struct__GPContext_p_q_const__char_va_list_p_void___GPContextFeedback swig_types[45]
#define SWIGTYPE_p_f_p_struct__GPContext_p_q_const__char_va_list_p_void__void swig_types[46]
