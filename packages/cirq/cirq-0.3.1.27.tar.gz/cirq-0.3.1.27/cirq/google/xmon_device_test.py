...
def test_validate_circuit_repeat_measurement_keys():
    ...
    circuit.append([cg.XmonMeasurementGate(u'a').on(cirq.GridQubit(0, 0)),
                    cg.XmonMeasurementGate(u'a').on(cirq.GridQubit(0, 1))])
