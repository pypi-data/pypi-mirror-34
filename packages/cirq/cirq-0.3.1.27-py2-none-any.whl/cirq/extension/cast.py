...
u"""Casting methods that are aware of PotentialImplementation."""
...
def cast(desired_type,
         actual_value):
    u"""Equivalent to the default cirq.Extensions()'s cast method.
...
def try_cast(desired_type,
             actual_value):
    u"""Equivalent to the default cirq.Extensions()'s try_cast method.
...
def can_cast(desired_type,
             actual_value):
    u"""Equivalent to the default cirq.Extensions()'s can_cast method.
