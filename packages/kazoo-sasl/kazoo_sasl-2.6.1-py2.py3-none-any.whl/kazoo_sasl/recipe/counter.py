...
"""
from kazoo_sasl.exceptions import BadVersionError
from kazoo_sasl.retry import ForceRetryError
...
class Counter(object):
    ...
    :class:`~kazoo_sasl.exceptions.BadVersionError` if the retry policy
