...
class BgpIPv6EvpnVXLAN(Base):
	...
	def BroadcastDomainV6(self):
		"""Returns the one and only one BroadcastDomainV6 object from the server.
		...
		return self._read(BroadcastDomainV6(self), None)
	...
	def remove(self):
		"""Deletes a child instance of BgpIPv6EvpnVXLAN on the server.
	...
	def AdvertiseAliasingPerEvi(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpIPv6EvpnVXLAN object references
