...
class IsisL3PseudoRouter(Base):
	...
	def IPv4PseudoNodeRoutes(self, DescriptiveName=None, Name=None):
		"""Gets child instances of IPv4PseudoNodeRoutes from the server.

		Use the named parameters as selection criteria to find specific instances.
		All named parameters support regex.
		If no named parameters are specified then all instances of IPv4PseudoNodeRoutes will be returned.
		...
		Returns:
			list(obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.ipv4pseudonoderoutes.IPv4PseudoNodeRoutes))
		...
		return self._select(IPv4PseudoNodeRoutes(self), locals())

	def IPv6PseudoNodeRoutes(self, DescriptiveName=None, Name=None):
		"""Gets child instances of IPv6PseudoNodeRoutes from the server.

		Use the named parameters as selection criteria to find specific instances.
		All named parameters support regex.
		If no named parameters are specified then all instances of IPv6PseudoNodeRoutes will be returned.
		...
		Returns:
			list(obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.ipv6pseudonoderoutes.IPv6PseudoNodeRoutes))

		Raises:
			ServerError: The server has encountered an uncategorized error condition
		"""
		from ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.ipv6pseudonoderoutes import IPv6PseudoNodeRoutes
		return self._select(IPv6PseudoNodeRoutes(self), locals())

	def IsisSRAlgorithmList(self, DescriptiveName=None, Name=None):
		"""Gets child instances of IsisSRAlgorithmList from the server.

		Use the named parameters as selection criteria to find specific instances.
		All named parameters support regex.
		If no named parameters are specified then all instances of IsisSRAlgorithmList will be returned.
		...
		Returns:
			list(obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.isissralgorithmlist.IsisSRAlgorithmList))

		Raises:
			ServerError: The server has encountered an uncategorized error condition
		"""
		from ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.isissralgorithmlist import IsisSRAlgorithmList
		return self._select(IsisSRAlgorithmList(self), locals())

	def IsisSRGBRangeSubObjectsList(self, DescriptiveName=None, Name=None):
		"""Gets child instances of IsisSRGBRangeSubObjectsList from the server.

		Use the named parameters as selection criteria to find specific instances.
		All named parameters support regex.
		If no named parameters are specified then all instances of IsisSRGBRangeSubObjectsList will be returned.
		...
		Returns:
			list(obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.isissrgbrangesubobjectslist.IsisSRGBRangeSubObjectsList))
		...
		return self._select(IsisSRGBRangeSubObjectsList(self), locals())

	def IsisSRLBDescriptorList(self, DescriptiveName=None, Name=None):
		"""Gets child instances of IsisSRLBDescriptorList from the server.

		Use the named parameters as selection criteria to find specific instances.
		All named parameters support regex.
		If no named parameters are specified then all instances of IsisSRLBDescriptorList will be returned.
		...
		Returns:
			list(obj(ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.isissrlbdescriptorlist.IsisSRLBDescriptorList))

		Raises:
			ServerError: The server has encountered an uncategorized error condition
		"""
		from ixnetwork_restpy.testplatform.sessions.ixnetwork.topology.isissrlbdescriptorlist import IsisSRLBDescriptorList
		return self._select(IsisSRLBDescriptorList(self), locals())
	...
	def Start(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./isisL3PseudoRouter object references
