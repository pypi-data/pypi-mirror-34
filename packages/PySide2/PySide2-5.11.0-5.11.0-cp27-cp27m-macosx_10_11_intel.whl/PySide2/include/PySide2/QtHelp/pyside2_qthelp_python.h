...
#define SBK_QTHELP_QPAIR_QSTRING_QSTRING_IDX                         2 // QPair<QString,QString >
#define SBK_QTHELP_QLIST_QPAIR_QSTRING_QSTRING_IDX                   3 // QList<QPair< QString,QString > >
#define SBK_QTHELP_QLIST_QHELPSEARCHQUERY_IDX                        4 // QList<QHelpSearchQuery >
#define SBK_QTHELP_QVECTOR_QHELPSEARCHRESULT_IDX                     5 // QVector<QHelpSearchResult >
#define SBK_QTHELP_QLIST_QACTIONPTR_IDX                              6 // QList<QAction* >
#define SBK_QTHELP_QVECTOR_INT_IDX                                   7 // const QVector<int > &
#define SBK_QTHELP_QLIST_QWIDGETPTR_IDX                              8 // QList<QWidget* >
#define SBK_QTHELP_QMAP_QSTRING_QURL_IDX                             9 // const QMap<QString,QUrl > &
