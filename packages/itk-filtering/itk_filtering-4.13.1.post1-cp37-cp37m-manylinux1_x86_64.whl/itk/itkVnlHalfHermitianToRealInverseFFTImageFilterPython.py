...
class itkVnlHalfHermitianToRealInverseFFTImageFilterICF2IF2(itkHalfHermitianToRealInverseFFTImageFilterPython.itkHalfHermitianToRealInverseFFTImageFilterICF2IF2):
    ...
    def GetPointer(self) -> "itkVnlHalfHermitianToRealInverseFFTImageFilterICF2IF2 *":
        """GetPointer(itkVnlHalfHermitianToRealInverseFFTImageFilterICF2IF2 self) -> itkVnlHalfHermitianToRealInverseFFTImageFilterICF2IF2"""
        return _itkVnlHalfHermitianToRealInverseFFTImageFilterPython.itkVnlHalfHermitianToRealInverseFFTImageFilterICF2IF2_GetPointer(self)
...
itkVnlHalfHermitianToRealInverseFFTImageFilterICF2IF2.GetPointer = new_instancemethod(_itkVnlHalfHermitianToRealInverseFFTImageFilterPython.itkVnlHalfHermitianToRealInverseFFTImageFilterICF2IF2_GetPointer, None, itkVnlHalfHermitianToRealInverseFFTImageFilterICF2IF2)
...
class itkVnlHalfHermitianToRealInverseFFTImageFilterICF3IF3(itkHalfHermitianToRealInverseFFTImageFilterPython.itkHalfHermitianToRealInverseFFTImageFilterICF3IF3):
    ...
    def GetPointer(self) -> "itkVnlHalfHermitianToRealInverseFFTImageFilterICF3IF3 *":
        """GetPointer(itkVnlHalfHermitianToRealInverseFFTImageFilterICF3IF3 self) -> itkVnlHalfHermitianToRealInverseFFTImageFilterICF3IF3"""
        return _itkVnlHalfHermitianToRealInverseFFTImageFilterPython.itkVnlHalfHermitianToRealInverseFFTImageFilterICF3IF3_GetPointer(self)
...
itkVnlHalfHermitianToRealInverseFFTImageFilterICF3IF3.GetPointer = new_instancemethod(_itkVnlHalfHermitianToRealInverseFFTImageFilterPython.itkVnlHalfHermitianToRealInverseFFTImageFilterICF3IF3_GetPointer, None, itkVnlHalfHermitianToRealInverseFFTImageFilterICF3IF3)
