...
'''
def correctFfield(fileName=None, fieldCoords=None, fieldValues=None, fieldRS=None, fieldDF=None, onlyT=False, fieldBinRatio=1.0,
                  ignoreBadPoints=False, correctBadPoints=False, deltaFnormMin=0.001, neighbours=12, filterPoints=False,
                  filterPointsRadius=3, verbose=False, saveFile=False, saveFileName=None):
    """
