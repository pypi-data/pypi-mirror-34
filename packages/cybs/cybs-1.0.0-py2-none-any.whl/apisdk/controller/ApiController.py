from apisdk.service.PaymentRequestService import *
...
# on the parameters
# The controller class decides the next step in moving the logic from Sample code to servicing the payment request
class ApiController:
    ...
    def payment_get(self, mconfig):
        ...
        try:
            ...
            # Calls PaymentRequestService class of service of APISDK
