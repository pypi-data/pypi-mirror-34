...
u"""An optimizer that expands CompositeOperation instances."""
...
class ExpandComposite(PointOptimizer):
    u"""An optimization pass that expands CompositeOperation instances.
    ...
    def _decompose(self, op):
        u"""Recursively decompose composite gates into an OP_TREE of gates."""
