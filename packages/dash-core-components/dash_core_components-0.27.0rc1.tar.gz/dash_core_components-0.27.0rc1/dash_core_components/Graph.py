...
Available events: 'click', 'hover', 'selected', 'relayout', 'unhover'"""
    @_explicitize_args
    def __init__(self, id=None, clickData=None, hoverData=None, clear_on_unhover=False, selectedData=None, relayoutData=None, figure={'data': [], 'layout': {}}, style=None, className=None, animate=False, animation_options={'frame': {'redraw': False}, 'transition': {'duration': 750, 'ease': 'cubic-in-out'}}, config={'showAxisDragHandles': True, 'modeBarButtons': False, 'scrollZoom': False, 'editable': False, 'showSources': False, 'topojsonURL': 'https://cdn.plot.ly/', 'fillFrame': False, 'displayModeBar': 'hover', 'modeBarButtonsToAdd': [], 'autosizable': False, 'linkText': 'Edit chart', 'doubleClick': 'reset+autosize', 'staticPlot': False, 'sendData': True, 'showTips': True, 'mapboxAccessToken': 'None', 'frameMargins': 0, 'plotGlPixelRatio': 2, 'queueLength': 0, 'displaylogo': True, 'edits': {'colorbarPosition': False, 'annotationPosition': False, 'shapePosition': False, 'annotationText': False, 'colorbarTitleText': False, 'legendPosition': False, 'legendText': False, 'axisTitleText': False, 'titleText': False, 'annotationTail': False}, 'modeBarButtonsToRemove': [], 'showLink': False, 'showAxisRangeEntryBoxes': True}, **kwargs):
