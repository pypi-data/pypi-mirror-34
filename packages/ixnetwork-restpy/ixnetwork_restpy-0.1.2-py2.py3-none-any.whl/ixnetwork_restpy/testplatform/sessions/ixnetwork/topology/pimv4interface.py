...
class PimV4Interface(Base):
	...
	def PimV4CandidateRPsList(self):
		"""Returns the one and only one PimV4CandidateRPsList object from the server.
		...
		return self._read(PimV4CandidateRPsList(self), None)

	@property
	def PimV4JoinPruneList(self):
		"""Returns the one and only one PimV4JoinPruneList object from the server.
		...
		return self._read(PimV4JoinPruneList(self), None)

	@property
	def PimV4SourcesList(self):
		"""Returns the one and only one PimV4SourcesList object from the server.
		...
		return self._read(PimV4SourcesList(self), None)
	...
	def remove(self):
		"""Deletes a child instance of PimV4Interface on the server.
	...
	def ClearLearnedInfo(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./pimV4Interface object references
