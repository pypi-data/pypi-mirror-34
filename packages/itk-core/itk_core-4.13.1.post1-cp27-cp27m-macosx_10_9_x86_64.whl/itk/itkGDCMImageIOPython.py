...
class itkGDCMImageIO(ITKIOImageBaseBasePython.itkImageIOBase):
    ...
    https://www.itk.org/Wiki/ITK/Examples/DICOM/ResampleDICOM Resample a
    DICOM series
    ...
    def GetNumberOfStudyRelatedSeries(self, series):
    ...
    def GetScanOptions(self, options):
    ...
    def SetMaxSizeLoadEntry(self, arg0):
        """
        SetMaxSizeLoadEntry(itkGDCMImageIO self, long const arg0)

        A DICOM file
        can contains multiple binary stream that can be very long For example
        an Overlay on the image. Most of the time user do not want to load
        this binary structure in memory since it can consume lot of memory.
        Therefore any field that is bigger than the default value 0xfff is
        discarded and just seek'd This method allow advanced user to force the
        reading of such field WARNING:  this is a GDCM 1.x only option, no
        effect on GDCM 2.x 
        """
        return _itkGDCMImageIOPython.itkGDCMImageIO_SetMaxSizeLoadEntry(self, arg0)


    def SetLoadSequences(self, arg0):
        """
    ...
    def SetLoadSequencesDefault(arg0):
    ...
    def SetLoadPrivateTagsDefault(arg0):
    ...
    def GetPointer(self):
        """GetPointer(itkGDCMImageIO self) -> itkGDCMImageIO"""
        return _itkGDCMImageIOPython.itkGDCMImageIO_GetPointer(self)
...
itkGDCMImageIO.GetPointer = new_instancemethod(_itkGDCMImageIOPython.itkGDCMImageIO_GetPointer, None, itkGDCMImageIO)
...
def itkGDCMImageIO_GetLabelFromTag(tag, labelId):
    """itkGDCMImageIO_GetLabelFromTag(std::string const & tag, std::string & labelId) -> bool"""
    return _itkGDCMImageIOPython.itkGDCMImageIO_GetLabelFromTag(tag, labelId)

def itkGDCMImageIO_SetLoadSequencesDefault(arg0):
...
def itkGDCMImageIO_SetLoadPrivateTagsDefault(arg0):
...
class itkGDCMImageIOFactory(ITKCommonBasePython.itkObjectFactoryBase):
    ...
    def GetPointer(self):
        """GetPointer(itkGDCMImageIOFactory self) -> itkGDCMImageIOFactory"""
        return _itkGDCMImageIOPython.itkGDCMImageIOFactory_GetPointer(self)
...
itkGDCMImageIOFactory.GetPointer = new_instancemethod(_itkGDCMImageIOPython.itkGDCMImageIOFactory_GetPointer, None, itkGDCMImageIOFactory)
...
def itkGDCMImageIOFactory_cast(obj):
...
class itkGDCMSeriesFileNames(ITKCommonBasePython.itkProcessObject):
    ...
    def GetSeriesHelper(self):
        """GetSeriesHelper(itkGDCMSeriesFileNames self) -> gdcm::SerieHelper *"""
        return _itkGDCMImageIOPython.itkGDCMSeriesFileNames_GetSeriesHelper(self)
    ...
    def GetPointer(self):
        """GetPointer(itkGDCMSeriesFileNames self) -> itkGDCMSeriesFileNames"""
        return _itkGDCMImageIOPython.itkGDCMSeriesFileNames_GetPointer(self)
...
itkGDCMSeriesFileNames.GetSeriesHelper = new_instancemethod(_itkGDCMImageIOPython.itkGDCMSeriesFileNames_GetSeriesHelper, None, itkGDCMSeriesFileNames)
...
itkGDCMSeriesFileNames.GetPointer = new_instancemethod(_itkGDCMImageIOPython.itkGDCMSeriesFileNames_GetPointer, None, itkGDCMSeriesFileNames)
...
def itkGDCMSeriesFileNames_cast(obj):
