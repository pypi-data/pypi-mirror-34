...
#define SBK_QTHELP_QLIST_QURL_IDX                                    7 // QList<QUrl >
#define SBK_QTHELP_QLIST_QSTRINGLIST_IDX                             8 // QList<QStringList >
#define SBK_QTHELP_QLIST_QACTIONPTR_IDX                              9 // QList<QAction* >
#define SBK_QTHELP_QLIST_QWIDGETPTR_IDX                              10 // QList<QWidget* >
#define SBK_QTHELP_QLIST_QHELPSEARCHQUERY_IDX                        11 // QList<QHelpSearchQuery >
