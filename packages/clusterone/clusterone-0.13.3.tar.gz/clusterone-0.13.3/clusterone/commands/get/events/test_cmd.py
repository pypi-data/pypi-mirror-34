    ...
    assert cmd.extract_data_from_events([
        ...
        OrderedDict([
            ...
            ('created_by', None),
               ...
               ['17:36:33 Wednesday 14-03-2018', 'muddy-fog-901', 'af3da7db-94bf-41b9-acaa-64f175bcae2c', 'Error',
                'Terminate the job on error'],
               ['17:36:32 Wednesday 14-03-2018', 'muddy-fog-901', 'af3da7db-94bf-41b9-acaa-64f175bcae2c', 'Success',
                'Delete Job Command'],
           ]
