...
def load_data(mission, dates, probes, instruments, level, other=None, downloadonly=False, varformat=None, get_support_data=False, prefix='', suffix=''):
    ...
    if mission == 'themis':
        ...
        #probes = gmag stations
        #other = gmag group 
        stations = probes
        group = other
        from pyspedas import gmag_load
        gmag_load(dates, stations, group, downloadonly, varformat, get_support_data, prefix, suffix)
    elif mission == 'omni':
