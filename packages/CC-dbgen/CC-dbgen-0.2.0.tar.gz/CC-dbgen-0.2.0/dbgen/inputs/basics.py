...
from dbgen.support.datatypes.rule      import (Rule,SimpleUpsert,SimpleUpdate
                                              ...
                                              ,SimpleFunc,PyBlock,SqlBlock,Plan
                                              ,SimplePipe)
...
# ################################################################################
calc_blocks = [PyBlock(dftcode_dependent
              ,name = x
