/*! For license information please see 62c90cc05fba2d55c902.chunk.js.LICENSE */
(window.webpackJsonp=window.webpackJsonp||[]).push([[34],{222:function(e,t,a){"use strict";a(2),a(23),a(36);var o=a(94),i=(a(121),a(4)),r=a(0);Object(i.a)({_template:r["a"]`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[o.a]})},608:function(e,t,a){"use strict";a.r(t),a(117),a(30),a(60),a(222),a(101),a(115);var o=a(0),i=a(3),r=(a(84),a(126),a(13));customElements.define("ha-sidebar",class extends(Object(r.a)(i.a)){static get template(){return o["a"]`
...
`}static get properties(){return{hass:{type:Object},menuShown:{type:Boolean},menuSelected:{type:String},narrow:Boolean,panels:{type:Array,computed:"computePanels(hass)"},defaultPage:String,_initials:{type:String,computed:"_computeUserInitials(hass.user.name)"}}}_computeUserInitials(e){return e?e.trim().split(" ").slice(0,3).map(e=>e.substr(0,1)).join(""):"user"}_computeBadgeClass(e){return`profile-badge ${e.length>2?"long":""}`}_mqttLoaded(e){return-1!==e.config.core.components.indexOf("mqtt")}_computeUserName(e){return e&&(e.name||"Unnamed User")}_computePanelName(e,t){return e(`panel.${t.title}`)||t.title}computePanels(e){var t=e.panels,a={map:1,logbook:2,history:3},o=[];return Object.keys(t).forEach(function(e){t[e].title&&o.push(t[e])}),o.sort(function(e,t){var o=e.component_name in a,i=t.component_name in a;return o&&i?a[e.component_name]-a[t.component_name]:o?-1:i?1:e.title<t.title?-1:e.title>t.title?1:0}),o}_computeUrl(e){return`/${e}`}_handleLogOut(){this.fire("hass-logout")}})}}]);
//# sourceMappingURL=62c90cc05fba2d55c902.chunk.js.map