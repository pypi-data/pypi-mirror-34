...
class NiceCXNetwork():
    ...
    def add_edge_citations(self, edge_id, citation_id):
        edge_citation_element = {'po': [edge_id], 'citations': [citation_id]}
    ...
    def add_edge_supports(self, edge_id, support_id):
        edge_support_element = {'po': [edge_id], 'supports': [support_id]}
