...
class itkLineSpatialObjectPoint2(itkSpatialObjectPointPython.itkSpatialObjectPoint2):
    ...
    def GetNormal(self, index: 'unsigned int') -> "itkCovariantVectorD2 const &":
        """GetNormal(itkLineSpatialObjectPoint2 self, unsigned int index) -> itkCovariantVectorD2"""
        return _itkLineSpatialObjectPointPython.itkLineSpatialObjectPoint2_GetNormal(self, index)


    def SetNormal(self, normal: 'itkCovariantVectorD2', index: 'unsigned int') -> "void":
        """SetNormal(itkLineSpatialObjectPoint2 self, itkCovariantVectorD2 normal, unsigned int index)"""
        return _itkLineSpatialObjectPointPython.itkLineSpatialObjectPoint2_SetNormal(self, normal, index)
...
class itkLineSpatialObjectPoint3(itkSpatialObjectPointPython.itkSpatialObjectPoint3):
    ...
    def GetNormal(self, index: 'unsigned int') -> "itkCovariantVectorD3 const &":
        """GetNormal(itkLineSpatialObjectPoint3 self, unsigned int index) -> itkCovariantVectorD3"""
        return _itkLineSpatialObjectPointPython.itkLineSpatialObjectPoint3_GetNormal(self, index)


    def SetNormal(self, normal: 'itkCovariantVectorD3', index: 'unsigned int') -> "void":
        """SetNormal(itkLineSpatialObjectPoint3 self, itkCovariantVectorD3 normal, unsigned int index)"""
        return _itkLineSpatialObjectPointPython.itkLineSpatialObjectPoint3_SetNormal(self, normal, index)
