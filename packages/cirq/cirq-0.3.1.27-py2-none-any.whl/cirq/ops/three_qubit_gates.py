...
class _CCZGate(gate_features.ThreeQubitGate,
    ...
    def text_diagram_info(self, args
        ...
        return gate_features.TextDiagramInfo((u'@', u'@', u'@'))
...
class _CCXGate(gate_features.ThreeQubitGate,
               ...
               gate_features.InterchangeableQubitsGate,
               gate_features.QasmConvertableGate):
    u"""A doubly-controlled-NOT. The Toffoli gate."""
    ...
    def text_diagram_info(self, args
        ...
        return gate_features.TextDiagramInfo((u'@', u'@', u'X'))
...
class _CSwapGate(gate_features.ThreeQubitGate,
    ...
    def default_decompose(self, qubits):
        ...
        need_hop = hasattr(t1, u'is_adjacent') and not t1.is_adjacent(t2)
    ...
    def text_diagram_info(self, args
        ...
        if not args.use_unicode_characters:
            return gate_features.TextDiagramInfo((u'@', u'swap', u'swap'))
        return gate_features.TextDiagramInfo((u'@', u'×', u'×'))
