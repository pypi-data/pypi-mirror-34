...
class itkVolumeSplineKernelTransformD2(itkKernelTransformPython.itkKernelTransformD2):
    ...
    def GetPointer(self) -> "itkVolumeSplineKernelTransformD2 *":
        """GetPointer(itkVolumeSplineKernelTransformD2 self) -> itkVolumeSplineKernelTransformD2"""
...
class itkVolumeSplineKernelTransformD3(itkKernelTransformPython.itkKernelTransformD3):
    ...
    def GetPointer(self) -> "itkVolumeSplineKernelTransformD3 *":
        """GetPointer(itkVolumeSplineKernelTransformD3 self) -> itkVolumeSplineKernelTransformD3"""
