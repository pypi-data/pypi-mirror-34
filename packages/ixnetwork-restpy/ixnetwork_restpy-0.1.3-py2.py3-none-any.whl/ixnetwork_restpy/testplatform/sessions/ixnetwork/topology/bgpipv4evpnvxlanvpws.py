...
class BgpIPv4EvpnVXLANVpws(Base):
	...
	def BroadcastDomainV4VxlanVpws(self):
		"""Returns the one and only one BroadcastDomainV4VxlanVpws object from the server.
		...
		return self._read(BroadcastDomainV4VxlanVpws(self), None)
	...
	def remove(self):
		"""Deletes a child instance of BgpIPv4EvpnVXLANVpws on the server.
	...
	def RestartDown(self, Arg1):
		...
		Args:
			Arg1 (list(str[None|/api/v1/sessions/1/ixnetwork/topology])): This parameter requires a list of /topology/./bgpIPv4EvpnVXLANVpws object references
