...
class itkCorrelationImageToImageMetricv4IF2IF2(itkImageToImageMetricv4Python.itkImageToImageMetricv4F2F2):
    ...
    def GetPointer(self) -> "itkCorrelationImageToImageMetricv4IF2IF2 *":
        """GetPointer(itkCorrelationImageToImageMetricv4IF2IF2 self) -> itkCorrelationImageToImageMetricv4IF2IF2"""
        return _itkCorrelationImageToImageMetricv4Python.itkCorrelationImageToImageMetricv4IF2IF2_GetPointer(self)
...
itkCorrelationImageToImageMetricv4IF2IF2.GetPointer = new_instancemethod(_itkCorrelationImageToImageMetricv4Python.itkCorrelationImageToImageMetricv4IF2IF2_GetPointer, None, itkCorrelationImageToImageMetricv4IF2IF2)
...
class itkCorrelationImageToImageMetricv4IF3IF3(itkImageToImageMetricv4Python.itkImageToImageMetricv4F3F3):
    ...
    def GetPointer(self) -> "itkCorrelationImageToImageMetricv4IF3IF3 *":
        """GetPointer(itkCorrelationImageToImageMetricv4IF3IF3 self) -> itkCorrelationImageToImageMetricv4IF3IF3"""
        return _itkCorrelationImageToImageMetricv4Python.itkCorrelationImageToImageMetricv4IF3IF3_GetPointer(self)
...
itkCorrelationImageToImageMetricv4IF3IF3.GetPointer = new_instancemethod(_itkCorrelationImageToImageMetricv4Python.itkCorrelationImageToImageMetricv4IF3IF3_GetPointer, None, itkCorrelationImageToImageMetricv4IF3IF3)
