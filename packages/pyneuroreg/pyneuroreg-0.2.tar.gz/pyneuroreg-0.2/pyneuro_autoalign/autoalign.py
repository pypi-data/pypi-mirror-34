...
# Algorithm to align the coronal slices 
# Written by Peter Park: peterpark828@gmail.com
...
def getTurnings(ptAr_list, outputfile = None, core_use = 4):

	print "Starting the calculation of turning angles... "
		# print "Working on the ptAr index: #" + str(index)
	with dask.diagnostics.ProgressBar():
		findturning_process = [delayed(findTurning)(ct_gr, ptAr) for ct_gr, ptAr in ptAr_list]
		angle_cal = delayed(does_nothing)(findturning_process)
		angle_list = angle_cal.compute(num_workers = core_use, get= dask.multiprocessing.get)
