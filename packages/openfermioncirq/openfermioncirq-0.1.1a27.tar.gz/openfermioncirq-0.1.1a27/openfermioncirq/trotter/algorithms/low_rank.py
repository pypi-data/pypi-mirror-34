...
u"""A Trotter algorithm using the low rank decomposition strategy."""
...
class LowRankTrotterAlgorithm(TrotterAlgorithm):
    ...
    supported_types = set([InteractionOperator])
...
class LowRankTrotterStep(TrotterStep):
    ...
    def __init__(self,
        ...
        super(LowRankTrotterStep, self).__init__(hamiltonian)
