            ...
            with open(self._bsp_json_path) as bsp_json_file:
                ...
                for component in bsp_json["components"]:
                    ...
                    if 'class' in component:
                        if component["class"] == "Button":
                        ...
                        elif component["class"] == "Nrf52832" or component["class"] == "MCU":
                            ...
                            peripheral_obj = JemuSudo(jemu_connection, 39, "stm32f4")
                            components_list.append({"obj": peripheral_obj, "name": "SUDO"})
                            self._platform = "stm32f4"

                        elif component["class"] == "Stm32l4":
                            peripheral_obj = JemuSudo(jemu_connection, 39, "stm32l4")
                            components_list.append({"obj": peripheral_obj, "name": "SUDO"})
                            self._platform = "stm32l4"
