...
def ex_basic():
    ...
    pyspedas.load_data('themis', ['2015-12-31 00:00:00', '2016-01-01 12:00:00'], ['tha'], 'state', 'l1')
    ...
    # Plot position and velocity using the bokeh library, requires nodejs ("conda install nodejs") 
