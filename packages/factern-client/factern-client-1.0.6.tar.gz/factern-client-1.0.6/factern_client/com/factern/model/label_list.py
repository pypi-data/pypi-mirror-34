...
class LabelList(get_parent()):
    ...
    def compute_parent_updates():
        ...
        LabelList.swagger_types.update(get_parent().swagger_types)
        LabelList.attribute_map.update(get_parent().attribute_map)
    ...
    def __init__(self, **kwargs):  # noqa: E501
        ...
        for k in kwargs:
            if k not in self.swagger_types:
                raise ValueError("LabelList got unexpected argument '%s'" % k)
        ...
        if "members" not in kwargs:
            raise ValueError("LabelList missing required argument: members")
        self._members = kwargs["members"]

        if "name" not in kwargs:
            raise ValueError("LabelList missing required argument: name")
