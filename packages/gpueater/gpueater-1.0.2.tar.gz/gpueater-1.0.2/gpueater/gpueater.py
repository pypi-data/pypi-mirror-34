...
def snapshot_instance(form): raise "v1.5 API"
def delete_snapshot(form): raise "v1.5 API"
def create_image(form): raise "v1.5 API"
def register_image(form): raise "v2.0 API"
def delete_image(form): raise "v1.5 API"
def test_image():
    print(image_list())
...
def subscription_list(): raise "v2.0 API"
...
def launch_subcription_instance(form): raise "v2.0 API"
...
def create_volume(form):   raise "v2.0 API"
def delete_volume(form):   raise "v2.0 API"
def transfer_volume(form):   raise "v2.0 API"

def _________subscription__________(): pass
def subscribe_instance_list():   raise "v2.0 API"
def subscribe_storage_list():   raise "v2.0 API"
def subscribe_network_list():   raise "v2.0 API"
def subscribe_instance(form):   raise "v2.0 API"
def unsubscribe_instance(form):   raise "v2.0 API"
def subscribe_storage(form):   raise "v2.0 API"
def unsubscribe_storage(form):   raise "v2.0 API"
def subscribe_network(form):   raise "v2.0 API"
def unsubscribe_network(form):   raise "v2.0 API"


def _________special__________(): pass
def live_migration(form):   raise "v2.5 API"
def cancel_transaction(form):   raise "v1.5 API"

def _________payment__________(): pass
def invoice_list(): return func_get("/console/servers/charge_list",[],{}) #@
def subscription_invoice_list():  raise "v2.0 API"
def make_invoice(form):  raise "v1.5 API"
def test_payment():
    print(invoice_list())
    pass

def _________extensions__________(): pass
def copy_file(form):  raise "v1.0 API"
def delete_file(form):  raise "v1.0 API"
def move_file(form):  raise "v1.0 API"
def make_directory(form):  raise "v1.0 API"
def file_list(form):  raise "v1.0 API"
def synchronize_files(form):  raise "v1.0 API"
def login_instance(form):  raise "v1.0 API"
def tunnel(form):  raise "v1.0 API"
