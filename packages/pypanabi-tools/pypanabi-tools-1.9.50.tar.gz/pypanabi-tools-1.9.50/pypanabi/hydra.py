                    ...
                    if row.region == 'unknown':
                        ...
                        if result['rowcount'] > 0:
                            ...
                            for month in months:
                                ...
                                tracking_table = template_table.replace('_template', '_{month}'.format(month=month.month_nk)).replace('{brand}_hydra'.format(brand=self._brand), '{brand}_{business_region}_hydra'.format(brand=brand, business_region=row.region) )
