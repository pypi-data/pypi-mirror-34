...
sys.path.append(os.path.abspath('pycharm-debug-py3k.egg'))
...
def run(id):
    ...
    try:
        if False: #os.path.exists(fname_cluster):
            ...
            cluster = pyemma.coordinates.cluster_kmeans(data=y, k=n_micro, max_iter=100, stride=1, chunksize=20000)
            import collections
