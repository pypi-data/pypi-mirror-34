...
from ..cnn2tcnn import VAECNN2tCNN
from .test_train import TrainTestCase

ROOT_DIR = dirname(abspath(__file__))


class VAECNN2tCNNTestCase(TrainTestCase, tf.test.TestCase):

    def setUp(self):
        self.model_name = 'VAECNN2tCNN'
        self.data()
        ...
        self.params = {
            ...
            'encoder_filter_structures': [(3, 1, 128), (2, 1, 256)],
            'decoder_filter_structures': [(3, 128), (3, 200)],
        }
        self.model_class = VAECNN2tCNN
        self.model = VAECNN2tCNN(**self.params)
