...
class Server:
    addrFieldLineServer = "http://esb:8280/services/FieldLineProxy?wsdl"  # cluster alle esb
    # addrMeshServer = "http://esb.ipp-hgw.mpg.de:8280/services/MeshSrv?wsdl"
    # addrMeshServer = "http://lxpowerboz.ipp-hgw.mpg.de:88/services/cpp/MeshSrv?wsdl"
    addrMeshServer = "http://lxpowerboz:88/services/cpp/MeshSrv?wsdl"
    addrMeshServer = "http://esb.ipp-hgw.mpg.de:8280/services/MeshSrv?wsdl"
    addrVmecServer = "http://esb.ipp-hgw.mpg.de:8280/services/vmec_v8?wsdl"
    addrExtenderServer = "http://esb.ipp-hgw.mpg.de:8280/services/Extender?wsdl"
    addrCompDB = "http://esb.ipp-hgw.mpg.de:8280/services/ComponentsDBProxy?wsdl"
    addrCoilsDB = "http://esb.ipp-hgw.mpg.de:8280/services/CoilsDBProxy?wsdl"
...
class Defaults:
    ...
    class MagneticConfig:
        relativeCurrents = [1., 1., 1., 1., 1., 0., 0., 0., 0.]
        scale = 1.43e6
    ...
    class Paths:
        ...
        """
        testDatFile = os.path.join(os.path.dirname(__file__),
                                   'data/test.dat')
