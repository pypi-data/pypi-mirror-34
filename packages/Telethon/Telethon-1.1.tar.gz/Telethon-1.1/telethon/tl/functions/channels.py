...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeChannelBannedRights, TypeInputUser, TypeChannelAdminRights, TypeChannelParticipantsFilter, TypeChannelAdminLogEventsFilter, TypeInputMessage, TypeInputChatPhoto, TypeBool, TypeInputChannel
