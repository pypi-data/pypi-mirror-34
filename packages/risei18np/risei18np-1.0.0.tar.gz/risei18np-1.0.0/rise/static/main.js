...
define([
  ...
  'services/config',
  'i18n',
], function(require, $, Jupyter, utils, configmod, i18n) {
  ...
  function KeysMessager() {
    var message = $('<div/>').append(
      $("<p/></p>").addClass('dialog').html(
        "<ul>" +
          "<li><kbd>Alt</kbd>+<kbd>r</kbd>:" + i18n.msg._("Enter/Exit RISE") + "</li>" +
          "<li><kbd>w</kbd>:" + i18n.msg._("Toggle overview mode") + "</li>" +
          "<li><kbd>,</kbd>:" + i18n.msg._("Toggle help and exit buttons") + "</li>" +
          "<li><kbd>Home</kbd>:" + i18n.msg._("First slide") + "</li>" +
          "<li><kbd>End</kbd>:" + i18n.msg._("Last slide") + "</li>" +
          "<li><kbd>space</kbd>:" + i18n.msg._("Next") + "</li>" +
          "<li><kbd>Shift</kbd>+<kbd>space</kbd>:" + i18n.msg._("Previous") + "</li>" +
          "<li><kbd>PgUp</kbd>:" + i18n.msg._("Up") + "</li>" +
          "<li><kbd>PgDn</kbd>:" + i18n.msg._("Down") + "</li>" +
          "<li><kbd>left</kbd>:" + i18n.msg._("Left") + "</li>" +
          "<li><kbd>right</kbd>:" + i18n.msg._("Right") + "</li>" +
          "<li><kbd>.</kbd> or <kbd>/</kbd>:" + i18n.msg._("black screen") + "</li>" +
          "</ul>" +
          "<b>" + i18n.msg._("NOTE: You have to use these shortcuts in command mode.") + "</b>"
      )
    );

    Jupyter.dialog.modal({
      title : i18n.msg._("Reveal Shortcuts Help"),
      body : message,
      buttons : {
        [i18n.msg._("OK")] : {class: "btn-danger"}
      }
    });
  }
  ...
  function buttonHelp() {
    var help_button = $('<i/>')
        .attr('id','help_b')
        .attr('title', i18n.msg._('Reveal Shortcuts Help'))
  ...
  function buttonExit() {
    var exit_button = $('<i/>')
        .attr('id','exit_b')
        .attr('title', i18n.msg._('Exit RISE'))
  ...
  function fullscreenHelp() {
    var message = $('<div/>').append(
      $("<p/></p>").addClass('dialog').html(
        "<b>" + i18n.msg._("Entering Fullscreen mode from inside RISE is disabled.") + "</b>" +
          "<br>" +
          "<b>" + i18n.msg._("Exit RISE, make you browser Fullscreen and re-enter RISE") + "</b>" +
          "<br>" +
          i18n.msg._("That will help Reveal.js to perform the correct transformations ") +
          i18n.msg._("at the time to interact with code cells.")
      )
    );

    Jupyter.dialog.modal({
      title : i18n.msg._("Fullscreen Help"),
      body : message,
    buttons : {
      [i18n.msg._("OK")] : {class: "btn-danger"}
    }
  ...
  */
  ...
  function registerJupyterActions() {
    ...
    actions.register({ help    : i18n.msg._('Enter/Exit RISE Slideshow'),
                       handler : revealMode,
                     },
                     "slideshow", "RISE");

    actions.register({ help: i18n.msg._("execute cell, and move to the next if on the same slide"),
                       handler: smartExec,
                     },
                     "smart-exec", "RISE");
    ...
    actions.register({ help   : i18n.msg._('(un)set current cell as a Slide cell'),
                       handler: function() { toggle_slide_type('slide'); }
                     },
                     "toggle-slide", "RISE");

    actions.register({ help   : i18n.msg._('(un)set current cell as a Sub-slide cell'),
                       handler: function() { toggle_slide_type('subslide'); }
                     },
                     "toggle-subslide", "RISE");

    actions.register({ help   : i18n.msg._('(un)set current cell as a Fragment cell'),
                       handler: function() { toggle_slide_type('fragment'); }
                     },
                     "toggle-fragment", "RISE");

    actions.register({ help   : i18n.msg._('(un)set current cell as a Note cell'),
                       handler: function() { toggle_slide_type('note'); }
                     },
                     "toggle-notes", "RISE");

    actions.register({ help   : i18n.msg._('(un)set current cell as a Skip cell'),
                       handler: function() { toggle_slide_type('skip'); }
                     },
                     "toggle-skip", "RISE");


    actions.register({ help   : i18n.msg._('render all cells (all cells go to command mode)'),
                       handler: function() {
    ...
    actions.register({ help   : i18n.msg._('edit all cells (all cells go to edit mode)'),
                       handler: function() {
                         Jupyter.notebook.get_cells().forEach(function(cell){
	                   cell.unrender();
                         })
    ...
    actions.register({ help: i18n.msg._('open the nbconfigurator page for RISE'),
                       handler: nbconfigurator},
                     "rise-nbconfigurator", "RISE");

    // mostly for debug / information
    actions.register({ help   : i18n.msg._('output RISE configuration in console, for debugging mostly'),
                       handler: showConfig},
