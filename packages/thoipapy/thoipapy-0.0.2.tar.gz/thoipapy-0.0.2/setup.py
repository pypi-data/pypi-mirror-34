...
setup(
    ...
    download_url='https://github.com/bojigu/thoipapy/archive/0.0.2.tar.gz',
    license='MIT',
    classifiers=
    [
    ...
    install_requires=["pandas", "numpy", "scipy", "biopython", "matplotlib", "seaborn", "django", "pytoxr", "korbinian", "statsmodels", "scikit-learn"],
    project_urls=
    {
