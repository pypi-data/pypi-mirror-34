...
from kazoo_sasl.exceptions import KazooException, NoNodeError, NodeExistsError
from kazoo_sasl.protocol.states import EventType
...
class Barrier(object):
    ...
    .. warning::
        ...
        may raise :exc:`~kazoo_sasl.exceptions.ConnectionLossException` if
