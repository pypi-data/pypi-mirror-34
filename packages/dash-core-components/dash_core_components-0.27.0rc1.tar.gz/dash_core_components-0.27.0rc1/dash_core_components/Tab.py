...
Available events: """
    @_explicitize_args
    def __init__(self, children=None, id=None, label=None, value=None, disabled=False, disabled_style={'color': '#d6d6d6'}, disabled_className=None, className=None, selected_className=None, style=None, selected_style=None, **kwargs):
