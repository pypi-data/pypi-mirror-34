import os
from esqlask.core.management.base import BaseCommand
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        env = Environment(
            loader=PackageLoader('esqlask', 'conf/templates'),
        ...
        for file_name, evry_template in [model_template, routes_template, serializer_template, viewset_template]:
            ...
            file_instance.write(evry_template.render(name = options['name']))
            file_instance.close()
        # 5. Write __init__
