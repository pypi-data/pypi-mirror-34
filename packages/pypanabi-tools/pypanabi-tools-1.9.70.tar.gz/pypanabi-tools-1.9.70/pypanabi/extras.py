...
def get_country_information(country_iso_code):
    ...
    region_info = REGIONS[country_info['business_region']]
    aws_region_info = AWS_REGIONS[country_info['aws_region']]
    return dict(country_info.items() + region_info.items() + aws_region_info.items())
