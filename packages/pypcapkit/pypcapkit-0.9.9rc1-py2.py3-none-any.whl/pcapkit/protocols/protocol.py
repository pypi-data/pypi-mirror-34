...
class Protocol:
    ...
    def decode_bytes(byte):
        ...
        if charset:
            try:
                ...
                pass
        return ''.join(( decode(char.to_bytes(1, sys.byteorder)) for char in byte ))

    @staticmethod
    def decode_url(url):
        """Decode URLs into Unicode."""
    ...
    def __new__(cls, file=None, *args, **kwargs):
        ...
        self._seekset = file.tell() if file else 0
