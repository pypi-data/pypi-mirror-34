...
class TestWMLClientWithSpark(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.model_path = os.path.join(os.getcwd(), 'artifacts', 'spark_mllib_model.tar.gz')
    ...
    def test_2_publish_model(self):
        TestWMLClientWithSpark.logger.info("Publish model")
        ...
        model_props = {self.client.repository.ModelMetaNames.AUTHOR_NAME: "IBM",
                       ...
                       self.client.repository.ModelMetaNames.FRAMEWORK_VERSION: "2.0"
                       }
    ...
    def test_4_create_deployment(self):
        ...
        deployment = self.client.deployments.create(asset_uid=self.model_uid, name=self.deployment_name, asynchronous=False)
