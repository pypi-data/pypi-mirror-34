# -*- coding: utf-8 -*-
# __author__ = 'komazhang@foxmail.com, elkan1788@gmail.com'
...
class IP2Location(object):
    ...
    def __init__(self):
        ...
        db_file = os.path.join(work_dir, 'others/ip2location.db')
        self.initDatabase(db_file)
        self.memorySearch('127.0.0.1')
    ...
    def returnData(self, dsptr):
        ...
        result = str(data[4:].decode('UTF-8')).split('|')
