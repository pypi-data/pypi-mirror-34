# -*- coding: utf-8 -*-
#
# envjson documentation build configuration file.
#
...
project = u'envjson'
copyright = u'2018, envjson contributors'
...
latex_documents = [
  ('index', 'envjson.tex', u'envjson Documentation',
   u'envjson contributors', 'manual'),
]
...
man_pages = [
    ('index', 'envjson', u'envjson Documentation',
     [u'envjson contributors'], 1)
]
