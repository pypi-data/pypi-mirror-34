...
class itkQuaternionRigidTransformD(itkRigid3DTransformPython.itkRigid3DTransformD):
    ...
    def GetPointer(self) -> "itkQuaternionRigidTransformD *":
        """GetPointer(itkQuaternionRigidTransformD self) -> itkQuaternionRigidTransformD"""
        return _itkQuaternionRigidTransformPython.itkQuaternionRigidTransformD_GetPointer(self)
