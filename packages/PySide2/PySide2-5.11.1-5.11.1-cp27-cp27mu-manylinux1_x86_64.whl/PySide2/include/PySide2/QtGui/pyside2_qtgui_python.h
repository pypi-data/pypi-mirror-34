...
#define SBK_QTGUI_QVECTOR_UNSIGNEDLONG_IDX                           42 // QVector<unsigned long >
#define SBK_QTGUI_QVECTOR_FLOAT_IDX                                  43 // QVector<float >
#define SBK_QTGUI_QLIST_QOPENGLSHADERPTR_IDX                         44 // QList<QOpenGLShader* >
#define SBK_QTGUI_QLIST_QOPENGLDEBUGMESSAGE_IDX                      45 // QList<QOpenGLDebugMessage >
#define SBK_QTGUI_QVECTOR_INT_IDX                                    46 // const QVector<int > &
#define SBK_QTGUI_QHASH_INT_QBYTEARRAY_IDX                           47 // const QHash<int,QByteArray > &
#define SBK_QTGUI_QLIST_QPERSISTENTMODELINDEX_IDX                    48 // const QList<QPersistentModelIndex > &
